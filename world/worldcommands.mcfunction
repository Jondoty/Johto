...
#Slot 2
execute as @a[scores={MusicCooldown=0},nbt={Inventory:[{Slot:1b,id:"minecraft:carrot_on_a_stick"}]}] run function johto:world/radio

#Offhand
execute as @a[scores={MusicCooldown=0},nbt={Inventory:[{Slot:-106b,id:"minecraft:carrot_on_a_stick"}]}] run function johto:world/radio

#Radio Stations
execute as @a[scores={MusicCooldown=0},nbt={Inventory:[{Slot:3b,id:"minecraft:carrot_on_a_stick"}]}] run function johto:world/radiostations
execute as @a[scores={MusicCooldown=0},nbt={Inventory:[{Slot:4b,id:"minecraft:carrot_on_a_stick"}]}] run function johto:world/radiostations
execute as @a[scores={MusicCooldown=0},nbt={Inventory:[{Slot:5b,id:"minecraft:carrot_on_a_stick"}]}] run function johto:world/radiostations
execute as @a[scores={MusicCooldown=0},nbt={Inventory:[{Slot:6b,id:"minecraft:carrot_on_a_stick"}]}] run function johto:world/radiostations
execute as @a[scores={MusicCooldown=0},nbt={Inventory:[{Slot:7b,id:"minecraft:carrot_on_a_stick"}]}] run function johto:world/radiostations
...
#Currently can't place on ground!
give @a[scores={Flash=1..}] firework_rocket{display:{Name:'[{"text":"HM05: Flash","italic":false}]',Lore:['[{"text":"Illuminates the user\'s vision for","italic":false}]','[{"text":"fifteen minutes.","italic":false}]']},CanPlaceOn:["air","stone","grass","dirt","cobblestone","planks","sapling","bedrock","flowing_water","water","flowing_lava","lava","sand","gravel","gold_ore","iron_ore","coal_ore","log","leaves","sponge","glass","lapis_ore","lapis_block","dispenser","sandstone","noteblock","golden_rail","detector_rail","sticky_piston","web","tallgrass","deadbush","piston","piston_head","wool","piston_extension","yellow_flower","red_flower","brown_mushroom","red_mushroom","gold_block","iron_block","double_stone_slab","stone_slab","brick_block","tnt","bookshelf","mossy_cobblestone","obsidian","torch","fire","mob_spawner","oak_stairs","chest","redstone_wire","diamond_ore","diamond_block","crafting_table","farmland","furnace","lit_furnace","standing_sign","ladder","rail","stone_stairs","wall_sign","lever","stone_pressure_plate","wooden_pressure_plate","redstone_ore","lit_redstone_ore","unlit_redstone_torch","redstone_torch","stone_button","snow_layer","ice","snow","cactus","clay","jukebox","fence","pumpkin","netherrack","soul_sand","glowstone","portal","lit_pumpkin","unpowered_repeater","powered_repeater","stained_glass","trapdoor","monster_egg","stonebrick","brown_mushroom_block","red_mushroom_block","iron_bars","glass_pane","melon_block","pumpkin_stem","melon_stem","vine","fence_gate","brick_stairs","stone_brick_stairs","mycelium","waterlily","nether_brick","nether_brick_fence","nether_brick_stairs","enchanting_table","end_portal","end_portal_frame","end_stone","dragon_egg","redstone_lamp","lit_redstone_lamp","double_wooden_slab","wooden_slab","cocoa","sandstone_stairs","emerald_ore","ender_chest","tripwire_hook","tripwire","emerald_block","spruce_stairs","birch_stairs","jungle_stairs","command_block","beacon","cobblestone_wall","wooden_button","anvil","trapped_chest","light_weighted_pressure_plate","heavy_weighted_pressure_plate","unpowered_comparator","powered_comparator","daylight_detector","redstone_block","quartz_ore","hopper","quartz_block","quartz_stairs","activator_rail","dropper","stained_hardened_clay","stained_glass_pane","log2","log2","acacia_stairs","dark_oak_stairs","slime","barrier","iron_trapdoor","prismarine","sea_lantern","hay_block","carpet","hardened_clay","coal_block","packed_ice","double_plant","prismarine","barrier","red_sandstone","sea_lantern","iron_trapdoor"],HideFlags:16} 1
...
###execute at @e[nbt=!{pixelmon:bike}] run tag @a[distance=0..1,tag=!Bicycle] add Bicycle
...
execute as @a[x=-693,y=63,z=-490,dx=19,dy=5,dz=19,scores={StarterPick=1}] run effect give @e[x=-687,y=64,z=-478,dy=2,dz=2,nbt=!{pixelmon:statue}] minecraft:invisibility 10 1 true
execute as @a[x=-693,y=63,z=-490,dx=19,dy=5,dz=19,scores={StarterPick=2}] run effect give @e[x=-689,y=64,z=-478,dy=2,dz=2,nbt=!{pixelmon:statue}] minecraft:invisibility 10 1 true
execute as @a[x=-693,y=63,z=-490,dx=19,dy=5,dz=19,scores={StarterPick=3}] run effect give @e[x=-685,y=64,z=-478,dy=2,dz=2,nbt=!{pixelmon:statue}] minecraft:invisibility 10 1 true
...
execute at @p[x=-252,y=63,z=-196,distance=0..30,tag=Dialogue5] run effect give @e[x=-252,y=63,z=-196,dy=3,nbt=!{pixelmon:npc_chatting}] minecraft:invisibility 10 10 true

#---------------------

#Dialogue6 - Cherrygrove Silver before battle
scoreboard players set @a[x=-300,y=64,z=-509,distance=0..20,tag=Dialogue5,scores={TalkTime=0}] DialogueTrigger 6
...
execute as @a[x=-300,y=64,z=-509,distance=0..10,tag=Dialogue6,tag=!Dialogue7,scores={StarterPick=1}] run tp @e[x=-760,y=84,z=-242,dy=10,nbt=!{pixelmon:npc_trainer},scores={StarterPick=1}] -300 64 -509
execute as @a[x=-300,y=64,z=-509,distance=0..10,tag=Dialogue6,tag=!Dialogue7,scores={StarterPick=2}] run tp @e[x=-760,y=84,z=-242,dy=10,nbt=!{pixelmon:npc_trainer},scores={StarterPick=2}] -300 64 -509
execute as @a[x=-300,y=64,z=-509,distance=0..10,tag=Dialogue6,tag=!Dialogue7,scores={StarterPick=3}] run tp @e[x=-760,y=84,z=-242,dy=10,nbt=!{pixelmon:npc_trainer},scores={StarterPick=3}] -300 64 -509
...
execute as @a[x=-693,y=63,z=-490,dx=19,dy=5,dz=19,tag=Dialogue5,scores={StarterPick=1}] run effect give @e[x=-689,y=64,z=-478,dy=2,dz=2,nbt=!{pixelmon:statue}] minecraft:invisibility 10 1 true
execute as @a[x=-693,y=63,z=-490,dx=19,dy=5,dz=19,tag=Dialogue5,scores={StarterPick=2}] run effect give @e[x=-685,y=64,z=-478,dy=2,dz=2,nbt=!{pixelmon:statue}] minecraft:invisibility 10 1 true
execute as @a[x=-693,y=63,z=-490,dx=19,dy=5,dz=19,tag=Dialogue5,scores={StarterPick=3}] run effect give @e[x=-687,y=64,z=-478,dy=2,dz=2,nbt=!{pixelmon:statue}] minecraft:invisibility 10 1 true

#Toggles Silver outside Elm's Lab
execute as @a[x=-665,y=64,z=-493,distance=0..100,tag=Dialogue6] run tp @e[x=-665,y=63,z=-493,dy=2,nbt=!{pixelmon:npc_chatting}] -758 93 -242
execute as @a[x=-665,y=64,z=-493,distance=0..25,tag=!Dialogue6] run tp @e[x=-758,y=92,z=-242,dy=3,nbt=!{pixelmon:npc_chatting}] -665 64 -493
...
#tps Kurt in
execute at @a[x=244,y=56,z=-714,distance=0..20,tag=!Dialogue15] run tp @e[x=-728,y=90,z=-242,dy=3,nbt=!{pixelmon:npc_chatting}] 244 39 -708

#Exterior Guard in
execute at @p[x=244,y=56,z=-714,distance=0..25,tag=!Dialogue14] run tp @e[x=-750,y=90,z=-242,dy=3,nbt=!{pixelmon:npc_chatting}] 247 54 -714

#Exterior Guard out
execute at @p[x=244,y=56,z=-714,distance=0..25,tag=Dialogue14] run tp @e[x=247,y=53,z=-714,dy=3,nbt=!{pixelmon:npc_chatting}] -750 91 -242
...
#Respawn Proton
execute at @a[x=289,y=38,z=-665,distance=0..10,tag=Dialogue15,tag=!Dialogue16,scores={TalkTime=0}] run tp @e[x=-742,y=90,z=-242,dy=3,nbt=!{pixelmon:npc_trainer}] 289 39 -661

#Kurt NPC
execute at @p[x=371,y=64,z=-698,distance=0..25,tag=Dialogue16,scores={TalkTime=0}] run tp @e[x=-726,y=90,z=-242,dy=3,nbt=!{pixelmon:npc_chatting}] 371 64 -698
...
execute as @a[x=513,y=0,z=-793,dx=187,dy=240,dz=228,tag=!Bugsy] run effect give @e[nbt=!{pixelmon:statue},distance=..25] minecraft:invisibility 5 1 true

#---------------------

#Dialogue22 - Ilex Forest Farfetch'd Found
execute at @e[x=622,y=63,z=-714,dy=3,nbt=!{pixelmon:statue}] run scoreboard players set @a[distance=0..6,tag=!Dialogue22,scores={Farfetchd=1}] DialogueTrigger 22
...
#tps in Sudowoodo
execute at @a[x=332,y=64,z=-16,distance=0..30,tag=!Dialogue30,scores={TalkTime=0}] run tp @e[x=-791,y=79,z=-244,dy=3,nbt=!{pixelmon:statue}] 333 64 -17
...
execute as @a[x=343,y=64,z=216,distance=..50,tag=!Dialogue31,scores={TalkTime=0}] run tp @e[x=-758,y=84,z=-242,dy=3,nbt=!{pixelmon:npc_chatting}] 343 64 216
...
execute as @a[x=444,y=58,z=328,distance=..20,tag=!Dialogue36,scores={TalkTime=0}] run tp @e[x=-802,y=79,z=-244,dy=3,nbt=!{pixelmon:statue}] 446 59 328
execute as @a[x=444,y=58,z=328,distance=..20,tag=!Dialogue36,scores={TalkTime=0}] run tp @e[x=-807,y=79,z=-244,dy=3,nbt=!{pixelmon:statue}] 443 59 328
execute as @a[x=444,y=58,z=328,distance=..20,tag=!Dialogue36,scores={TalkTime=0}] run tp @e[x=-797,y=79,z=-244,dy=3,nbt=!{pixelmon:statue}] 439 59 328
...
execute at @a[x=809,y=63,z=14,distance=..50,tag=!Dialogue39] run tp @e[x=-772,y=92,z=-242,dy=3,nbt=!{pixelmon:npc_chatting}] 809 64 14
...
execute at @a[x=-169,y=65,z=645,distance=..100,tag=!Dialogue49,scores={TalkTime=0}] run tp @e[x=-765,y=66,z=-244,dy=3,nbt=!{pixelmon:statue}] -167 62 632
...
execute as @a[x=-159,y=64,z=590,distance=..50,tag=Dialogue49,tag=!Dialogue51] run tp @e[x=-807,y=92,z=-242,dy=3,nbt=!{pixelmon:npc_chatting}] -159 64 590

#---------------------
#Dialogue53
scoreboard players set @a[x=-164,y=63,z=196,dx=19,dy=6,dz=20,tag=Dialogue52,tag=!Dialogue53] DialogueTrigger 53
execute at @a[x=-155,y=64,z=208,distance=..30,tag=Dialogue52,scores={TalkTime=0},tag=!Dialogue53] run tp @e[x=-755,y=78,z=-244,dy=3,nbt=!{pixelmon:statue}] -156 64 200
execute at @a[x=-155,y=64,z=208,distance=..30,tag=Dialogue52,scores={TalkTime=0},tag=!Dialogue53] run tp @e[x=-805,y=92,z=-242,dy=3,nbt=!{pixelmon:npc_chatting}] -155 64 202
...
execute at @p[x=-155,y=64,z=208,distance=..30,tag=!Dialogue53,scores={TalkTime=0}] run tp @e[x=-152,y=63,z=212,dy=3,nbt=!{pixelmon:npc_shopkeeper},limit=1] -152 72 212
execute at @p[x=-155,y=64,z=208,distance=..30,tag=!Dialogue53,scores={TalkTime=0}] run tp @e[x=-157,y=63,z=193,dy=3,nbt=!{pixelmon:npc_chatting}] -159 72 196
execute at @p[x=-155,y=64,z=208,distance=..30,tag=!Dialogue53,scores={TalkTime=0}] run tp @e[x=-157,y=71,z=196,dy=3,nbt=!{pixelmon:npc_shopkeeper},limit=1] -156 64 206
execute at @p[x=-155,y=64,z=208,distance=..30,tag=!Dialogue53,scores={TalkTime=0}] run tp @e[x=-155,y=71,z=196,dy=3,nbt=!{pixelmon:npc_chatting}] -149 64 200

#Cleared of Rockets
execute at @p[x=-155,y=64,z=208,distance=..30,tag=Dialogue64,scores={TalkTime=0}] run tp @e[x=-152,y=71,z=212,dy=3,nbt=!{pixelmon:npc_shopkeeper},limit=1] -152 64 212
execute at @p[x=-155,y=64,z=208,distance=..30,tag=Dialogue64,scores={TalkTime=0}] run tp @e[x=-159,y=71,z=196,dy=3,nbt=!{pixelmon:npc_chatting}] -157 64 193
execute at @p[x=-155,y=64,z=208,distance=..30,tag=Dialogue64,scores={TalkTime=0}] run tp @e[x=-156,y=63,z=206,dy=3,nbt=!{pixelmon:npc_shopkeeper},limit=1] -157 72 196
execute at @p[x=-155,y=64,z=208,distance=..30,tag=Dialogue64,scores={TalkTime=0}] run tp @e[x=-149,y=63,z=200,dy=3,nbt=!{pixelmon:npc_chatting}] -155 72 196
...
execute at @a[x=-83,y=45,z=169,distance=..20,tag=!Dialogue54,scores={TalkTime=0}] run tp @e[x=-803,y=92,z=-242,dy=3,nbt=!{pixelmon:npc_chatting}] -83 45 169

#Dialogue55 - Lance passwords talk
scoreboard players set @a[x=-149,y=34,z=165,distance=..5,tag=!Dialogue55] DialogueTrigger 55
execute at @a[x=-149,y=34,z=165,distance=..25,tag=!Dialogue55,scores={TalkTime=0}] run tp @e[x=-801,y=92,z=-242,dy=3,nbt=!{pixelmon:npc_chatting}] -149 34 165
...
execute at @a[x=-82,y=34,z=182,distance=..20,tag=!Dialogue59,scores={TalkTime=0}] run tp @e[x=-772,y=88,z=-242,dy=3,nbt=!{pixelmon:npc_chatting}] -82 34 182
...
execute at @a[x=-99,y=34,z=205,distance=..20,scores={TalkTime=0},tag=!Dialogue61] run tp @e[x=-799,y=92,z=-242,dy=3,nbt=!{pixelmon:npc_trainer}] -99 34 205
...
execute at @a[x=-133,y=45,z=166,distance=..30,scores={TalkTime=0},tag=Dialogue58,tag=!Dialogue63] run tp @e[x=-797,y=92,z=-242,dy=3,nbt=!{pixelmon:npc_chatting}] -128 45 159
execute at @a[x=-133,y=45,z=166,distance=..30,scores={TalkTime=0},tag=Dialogue58,tag=!Dialogue63] run tp @e[x=-795,y=92,z=-242,dy=3,nbt=!{pixelmon:npc_chatting}] -128 45 171
execute at @a[x=-133,y=45,z=166,distance=..30,scores={TalkTime=0},tag=Dialogue58,tag=!Dialogue63] run tp @e[x=-793,y=92,z=-242,dy=3,nbt=!{pixelmon:npc_trainer}] -134 45 170
execute at @a[x=-133,y=45,z=166,distance=..30,scores={TalkTime=0},tag=Dialogue58,tag=!Dialogue63] run tp @e[x=-817,y=86,z=-147,dy=2,nbt=!{pixelmon:statue}] -128 45 168
execute at @a[x=-133,y=45,z=166,distance=..30,scores={TalkTime=0},tag=Dialogue58,tag=!Dialogue63] run tp @e[x=-817,y=86,z=-153,dy=2,nbt=!{pixelmon:statue}] -128 45 164
...
execute at @a[x=349,y=63,z=-461,dx=239,dy=10,dz=194,tag=Dialogue64,tag=!Dialogue72] run tp @e[x=-791,y=92,z=-242,dy=3,nbt=!{pixelmon:npc_chatting}] 546 64 -350
execute at @a[x=349,y=63,z=-461,dx=239,dy=10,dz=194,tag=Dialogue64,tag=!Dialogue72] run tp @e[x=-785,y=92,z=-242,dy=3,nbt=!{pixelmon:npc_chatting}] 495 64 -392
execute at @a[x=349,y=63,z=-461,dx=239,dy=10,dz=194,tag=Dialogue64,tag=!Dialogue72] run tp @e[x=-787,y=92,z=-242,dy=3,nbt=!{pixelmon:npc_chatting}] 425 64 -380
execute at @a[x=349,y=63,z=-461,dx=239,dy=10,dz=194,tag=Dialogue64,tag=!Dialogue72] run tp @e[x=-789,y=92,z=-242,dy=3,nbt=!{pixelmon:npc_chatting}] 420 64 -380
execute at @a[x=349,y=63,z=-461,dx=239,dy=10,dz=194,tag=Dialogue64,tag=!Dialogue72] run tp @e[x=-783,y=92,z=-242,dy=3,nbt=!{pixelmon:npc_chatting}] 560 64 -352
execute at @a[x=560,y=64,z=-352,distance=..100,tag=!Dialogue72] run tp @e[x=-783,y=92,z=-242,dy=3,nbt=!{pixelmon:npc_chatting}] 560 64 -352

#Post-takeover
execute at @a[x=349,y=63,z=-461,dx=239,dy=10,dz=194,tag=Dialogue72] run tp @e[x=546,y=63,z=-350,dy=3,nbt=!{pixelmon:npc_chatting}] -791 93 -242
execute at @a[x=349,y=63,z=-461,dx=239,dy=10,dz=194,tag=Dialogue72] run tp @e[x=495,y=63,z=-392,dy=3,nbt=!{pixelmon:npc_chatting}] -785 93 -242
execute at @a[x=349,y=63,z=-461,dx=239,dy=10,dz=194,tag=Dialogue72] run tp @e[x=425,y=63,z=-380,dy=3,nbt=!{pixelmon:npc_chatting}] -787 93 -242
execute at @a[x=349,y=63,z=-461,dx=239,dy=10,dz=194,tag=Dialogue72] run tp @e[x=420,y=63,z=-380,dy=3,nbt=!{pixelmon:npc_chatting}] -789 93 -242
execute at @a[x=349,y=63,z=-461,dx=239,dy=10,dz=194,tag=Dialogue72] run tp @e[x=560,y=63,z=-352,dy=3,nbt=!{pixelmon:npc_chatting}] -783 93 -242
...
execute at @p[x=426,y=37,z=-304,distance=..25,tag=!Dialogue72] run tp @e[x=-779,y=92,z=-242,dy=3,nbt=!{pixelmon:npc_chatting}] 426 38 -304
execute at @p[x=426,y=37,z=-304,distance=..25,tag=Dialogue72] run tp @e[x=426,y=37,z=-304,dy=3,nbt=!{pixelmon:npc_chatting}] -779 93 -242
...
execute at @a[x=-3060,y=64,z=956,distance=..50,tag=!Dialogue113,tag=Dialogue221] run tp @e[x=-815,y=84,z=-240,dy=3,nbt=!{pixelmon:npc_chatting}] -3060 64 956
...
execute at @a[x=-2697,y=65,z=-39,distance=..20,scores={TalkTime=0},tag=!Dialogue133] run tp @e[x=-738,y=74,z=-242,dy=2,nbt=!{pixelmon:statue}] -2697 65 -39
...
execute at @p[x=-2721,y=68,z=374,distance=..20,scores={TalkTime=0},tag=!Dialogue135] run tp @e[x=-2721,y=70,z=374,distance=..1,nbt=!{pixelmon:statue}] -736 75 -242
...
execute at @a[x=-2710,y=64,z=-55,distance=..40,scores={TalkTime=0},tag=Dialogue134,tag=!Dialogue136] run tp @e[x=-734,y=90,z=-242,dy=2,nbt=!{pixelmon:npc_chatting}] -2710 64 -55
...
execute at @a[x=-2763,y=63,z=329,distance=..40,tag=Dialogue136,tag=!Dialogue137,tag=Red] run tp @e[x=-736,y=90,z=-242,dy=3,nbt=!{pixelmon:npc_chatting}] -2763 64 329
execute at @a[x=-2763,y=63,z=329,distance=..40,tag=Dialogue136,tag=!Dialogue137,tag=Red] run tp @e[x=-2763,y=63,z=329,dy=3,nbt=!{pixelmon:npc_trader}] -732 91 -242
...
execute at @p[x=-2763,y=63,z=329,distance=..30,scores={TalkTime=0,StevenCD=0},tag=Dialogue138] run tp @e[x=-732,y=90,z=-242,dy=3,nbt=!{pixelmon:npc_trader}] -2763 64 329
execute at @p[x=-2763,y=63,z=329,distance=..30,scores={TalkTime=0,StevenCD=0},tag=Dialogue138] run tp @e[x=-2763,y=63,z=329,dy=3,nbt=!{pixelmon:npc_chatting}] -736 91 -242
...
execute at @a[x=1317,y=64,z=-370,distance=..30,tag=Dialogue102,tag=!Dialogue145] run tp @e[x=-718,y=90,z=-242,dy=3,nbt=!{pixelmon:npc_chatting}] 1317 64 -370
...
execute as @a[x=87,y=50,z=719,dx=44,dy=20,dz=44,scores={TalkTime=0},tag=Dialogue164,tag=!Dialogue165] run tp @e[x=-735,y=70,z=-242,dy=3,nbt=!{pixelmon:npc_trainer}] 109 54 750
...
execute at @p[x=178,y=64,z=-127,distance=..120,tag=!Red] run tp @e[x=-697,y=85,z=-242,dy=2,nbt=!{pixelmon:npc_chatting}] 178 65 -127
...
execute at @e[x=174,y=63,z=-141,distance=..20,nbt=!{pixelmon:pixelmon},name=Arceus] run scoreboard players set @p[distance=..15,scores={TalkTime=0,Arceus=1},tag=Dialogue167,tag=!Dialogue168,tag=Red] DialogueTrigger 168
...
execute at @a[x=-1081,y=62,z=-224,distance=..20,tag=!Dialogue171,scores={TalkTime=0}] run tp @e[x=-815,y=64,z=-235,dy=3,nbt=!{pixelmon:npc_chatting}] -1081 61 -224
...
execute at @a[x=-1046,y=48,z=-111,distance=..50,scores={TalkTime=0},tag=Dialogue171,tag=!Dialogue172] run tp @e[x=-815,y=64,z=-233,dy=3,nbt=!{pixelmon:npc_chatting}] -1046 48 -111
...
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=1}] run execute at @a[x=913,y=63,z=-54,distance=..50] run tp @e[x=-815,y=64,z=-228,dy=3,nbt=!{pixelmon:npc_chatting}] 913 64 -54
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=2}] run execute at @a[x=-482,y=63,z=-535,distance=..50] run tp @e[x=-815,y=64,z=-226,dy=3,nbt=!{pixelmon:npc_chatting}] -482 64 -535
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=3}] run execute at @a[x=-56,y=63,z=722,distance=..50] run tp @e[x=-815,y=64,z=-224,dy=3,nbt=!{pixelmon:npc_chatting}] -56 64 722
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=4}] run execute at @a[x=236,y=64,z=-6,distance=..50] run tp @e[x=-815,y=64,z=-222,dy=3,nbt=!{pixelmon:npc_chatting}] 236 64 -6
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=5}] run execute at @a[x=127,y=63,z=-545,distance=..50] run tp @e[x=-815,y=64,z=-220,dy=3,nbt=!{pixelmon:npc_chatting}] 127 64 -545
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=6}] run execute at @a[x=-663,y=63,z=225,distance=..50] run tp @e[x=-815,y=64,z=-218,dy=3,nbt=!{pixelmon:npc_chatting}] -663 64 225
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=7}] run execute at @a[x=335,y=64,z=113,distance=..50] run tp @e[x=-815,y=64,z=-216,dy=3,nbt=!{pixelmon:npc_chatting}] 335 64 113
...
execute at @p[x=541,y=63,z=-416,distance=..15,tag=Dialogue204,tag=!Dialogue205] run tp @e[x=-815,y=69,z=-233,dy=3,nbt=!{pixelmon:npc_chatting}] 549 64 -409
execute at @p[x=541,y=63,z=-416,distance=..15,tag=!Dialogue204,tag=!Dialogue205] run tp @e[x=549,y=63,z=-409,dy=3,nbt=!{pixelmon:npc_chatting}] -815 70 -233
...
execute as @a[x=-2748,y=66,z=870,distance=..20,tag=Dialogue217,scores={TalkTime=0},tag=!Dialogue219] run tp @e[x=-815,y=74,z=-233,dy=3,nbt=!{pixelmon:npc_trainer}] -2743 66 870
...
execute as @e[x=-270,y=63,z=-505,dy=3,nbt=!{pixelmon:npc_chatting}] run scoreboard players set @a[distance=..5,tag=!GuideTour,scores={TalkTime=0},tag=!Dialogue209] DialogueTrigger 209
execute as @e[x=-256,y=63,z=-495,dy=3,nbt=!{pixelmon:npc_chatting}] run scoreboard players set @a[distance=..5,scores={TalkTime=0},tag=!Dialogue210] DialogueTrigger 210
execute as @e[x=-217,y=64,z=-495,dy=3,nbt=!{pixelmon:npc_chatting}] run scoreboard players set @a[distance=..5,scores={TalkTime=0},tag=!Dialogue211] DialogueTrigger 211
execute as @e[x=-184,y=64,z=-495,dy=3,nbt=!{pixelmon:npc_chatting}] run scoreboard players set @a[distance=..5,scores={TalkTime=0},tag=!Dialogue212] DialogueTrigger 212
execute as @e[x=-146,y=64,z=-517,dy=3,nbt=!{pixelmon:npc_chatting}] run scoreboard players set @a[distance=..5,scores={TalkTime=0},tag=!Dialogue197] DialogueTrigger 197
execute as @e[x=-230,y=64,z=-529,dy=3,nbt=!{pixelmon:npc_chatting}] run scoreboard players set @a[distance=..5,scores={TalkTime=0},tag=!Dialogue213] DialogueTrigger 213
...
execute at @a[x=445,y=64,z=304,distance=..10,scores={DogEncounter=1..},tag=!Dialogue226] run tp @e[x=-815,y=74,z=-228,dy=3,nbt=!{pixelmon:npc_chatting}] 445 64 304
...
execute at @a[x=1256,y=64,z=-296,distance=..50,scores={TalkTime=0,DogEncounter=1..},tag=Dialogue226,tag=!Dialogue227] run tp @e[x=-817,y=80,z=-171,dy=3,nbt=!{pixelmon:statue}] 1256 64 -296

#Dialogue228 - Cianwood City Eucine post-battle
scoreboard players set @a[x=1256,y=64,z=-296,distance=..20,scores={TalkTime=0},tag=!Dialogue228,nbt=!{pixelmon:npc_trainer}] DialogueTrigger 228
execute at @a[x=1251,y=64,z=-307,distance=..20,scores={TalkTime=0},tag=Dialogue227,tag=!Dialogue228] run tp @e[x=-815,y=74,z=-226,dy=3,nbt=!{pixelmon:npc_trainer}] 1251 64 -307
...
execute at @a[x=80,y=64,z=152,distance=..50,scores={TalkTime=0},tag=Dialogue228,tag=!Dialogue229] run tp @e[x=-817,y=80,z=-165,dy=3,nbt=!{pixelmon:statue}] 80 64 152
...
execute at @a[x=-2823,y=64,z=-96,distance=..50,scores={TalkTime=0},tag=Dialogue229,tag=!Dialogue230] run tp @e[x=-817,y=80,z=-159,dy=3,nbt=!{pixelmon:statue}] -2823 64 -96
...
execute at @a[x=-2981,y=64,z=-470,distance=..50,scores={TalkTime=0},tag=Dialogue230,tag=!Dialogue231] run tp @e[x=-817,y=80,z=-153,dy=3,nbt=!{pixelmon:statue}] -2981 64 -470
...
execute at @a[x=-3094,y=64,z=989,distance=..50,scores={TalkTime=0},tag=Dialogue231,tag=!Dialogue233] run tp @e[x=-817,y=80,z=-147,dy=3,nbt=!{pixelmon:statue}] -3111 64 989
...
execute at @a[x=1229,y=108,z=184,distance=..30,tag=!Dialogue105] run execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=5}] run tp @e[x=-785,y=78,z=-244,dy=3,nbt=!{pixelmon:statue}] 1229 108.5 184
execute at @a[x=1229,y=108,z=184,distance=..30,tag=!Dialogue105] run execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=1..4}] run tp @e[x=1229,y=108,z=184,distance=..5,nbt=!{pixelmon:statue}] -785 79 -244
execute at @a[x=1229,y=108,z=184,distance=..30,tag=!Dialogue105] run execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=6..7}] run tp @e[x=1229,y=108,z=184,distance=..5,nbt=!{pixelmon:statue}] -785 79 -244
...
execute as @a[x=-2054,y=19,z=-835,distance=..50,scores={Articuno=0,ArticunoCD=0,TalkTime=0}] run tp @e[x=-767,y=79,z=-244,distance=..2,nbt=!{pixelmon:statue}] -2054 19 -835
...
execute as @a[x=-3239,y=64,z=571,distance=..50,scores={Zapdos=0,ZapdosCD=0,TalkTime=0},tag=AllGyms] run tp @e[x=-773,y=79,z=-244,distance=..2,nbt=!{pixelmon:statue}] -3239 64 571
...
execute as @a[x=-1379,y=51,z=522,distance=..50,scores={Moltres=0,MoltresCD=0,TalkTime=0}] run tp @e[x=-779,y=79,z=-244,distance=..2,nbt=!{pixelmon:statue}] -1379 51 522
...
execute as @a[x=-2894,y=64,z=-53,distance=..50,scores={TalkTime=0},tag=!Dialogue142] run tp @e[x=-761,y=79,z=-244,distance=..2,nbt=!{pixelmon:statue}] -2894 64 -53
...
tp @a[x=369,y=58,z=287,dx=6,dy=10,dz=15,tag=!Morty] ~ 64 ~-10
...
tp @a[x=-787,y=59,z=-525,dx=33,dy=10,dz=22,tag=!Dialogue33] ~10 64 ~
...
effect give @e[x=-1091,y=0,z=522,dx=63,dy=63,dz=105,nbt=!{pixelmon:pixelmon}] minecraft:levitation 1 1 true
