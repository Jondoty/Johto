...
execute as @a[scores={TriggerCommand=9}] run tp @r[x=881,y=46,z=69,dx=2,dy=2,dz=2,nbt=!{pixelmon:npc_trainer},limit=1] 910 100 67.0 90 ~
...
#Return TP Pokemon
execute as @a[scores={TriggerCommand=78}] run tp @e[x=910,y=99,z=66,dy=2,dz=1,nbt=!{pixelmon:npc_trainer},scores={Battle_Streak=1}] 882 47 70
execute as @a[scores={TriggerCommand=78}] run tp @e[x=910,y=99,z=66,dy=2,dz=1,nbt=!{pixelmon:npc_trainer},scores={Battle_Streak=2}] 887 47 70
execute as @a[scores={TriggerCommand=78}] run tp @e[x=910,y=99,z=66,dy=2,dz=1,nbt=!{pixelmon:npc_trainer},scores={Battle_Streak=3}] 892 47 70
execute as @a[scores={TriggerCommand=78}] run tp @e[x=910,y=99,z=66,dy=2,dz=1,nbt=!{pixelmon:npc_trainer},scores={Battle_Streak=4}] 897 47 70
