...
execute at @s[type=player] run tag @e[distance=..15,nbt=!{pixelmon:pixelmon},tag=!Legendary,nbt={ndex:384s,OwnerUUID:""}] add Legendary
execute at @s[type=player] run tag @e[distance=..15,nbt=!{pixelmon:pixelmon},tag=!Legendary,nbt={ndex:380s,OwnerUUID:""}] add Legendary
execute at @s[type=player] run tag @e[distance=..15,nbt=!{pixelmon:pixelmon},tag=!Legendary,nbt={ndex:243s,OwnerUUID:""}] add Legendary
execute at @s[type=player] run tag @e[distance=..15,nbt=!{pixelmon:pixelmon},tag=!Legendary,nbt={ndex:484s,OwnerUUID:""}] add Legendary
execute at @s[type=player] run tag @e[distance=..15,nbt=!{pixelmon:pixelmon},tag=!Legendary,nbt={ndex:151s,OwnerUUID:""}] add Legendary
execute at @s[type=player] run tag @e[distance=..15,nbt=!{pixelmon:pixelmon},tag=!Legendary,nbt={ndex:146s,OwnerUUID:""}] add Legendary
execute at @s[type=player] run tag @e[distance=..15,nbt=!{pixelmon:pixelmon},tag=!Legendary,nbt={ndex:150s,OwnerUUID:""}] add Legendary
execute at @s[type=player] run tag @e[distance=..15,nbt=!{pixelmon:pixelmon},tag=!Legendary,nbt={ndex:245s,OwnerUUID:""}] add Legendary
execute at @s[type=player] run tag @e[distance=..15,nbt=!{pixelmon:pixelmon},tag=!Legendary,nbt={ndex:250s,OwnerUUID:""}] add Legendary
execute at @s[type=player] run tag @e[distance=..15,nbt=!{pixelmon:pixelmon},tag=!Legendary,nbt={ndex:249s,OwnerUUID:""}] add Legendary
execute at @s[type=player] run tag @e[distance=..15,nbt=!{pixelmon:pixelmon},tag=!Legendary,nbt={ndex:144s,OwnerUUID:""}] add Legendary
execute at @s[type=player] run tag @e[distance=..15,nbt=!{pixelmon:pixelmon},tag=!Legendary,nbt={ndex:145s,OwnerUUID:""}] add Legendary
execute at @s[type=player] run tag @e[distance=..15,nbt=!{pixelmon:pixelmon},tag=!Legendary,nbt={ndex:382s,OwnerUUID:""}] add Legendary
execute at @s[type=player] run tag @e[distance=..15,nbt=!{pixelmon:pixelmon},tag=!Legendary,nbt={ndex:283s,OwnerUUID:""}] add Legendary
execute at @s[type=player] run tag @e[distance=..15,nbt=!{pixelmon:pixelmon},tag=!Legendary,nbt={ndex:281s,OwnerUUID:""}] add Legendary
execute at @s[type=player] run tag @e[distance=..15,nbt=!{pixelmon:pixelmon},tag=!Legendary,nbt={ndex:244s,OwnerUUID:""}] add Legendary
execute at @s[type=player] run tag @e[distance=..15,nbt=!{pixelmon:pixelmon},tag=!Legendary,nbt={ndex:483s,OwnerUUID:""}] add Legendary
execute at @s[type=player] run tag @e[distance=..15,nbt=!{pixelmon:pixelmon},tag=!Legendary,nbt={ndex:487s,OwnerUUID:""}] add Legendary
execute at @s[type=player] run tag @e[distance=..15,nbt=!{pixelmon:pixelmon},tag=!ArceusBattle,nbt={ndex:493s,OwnerUUID:""}] add ArceusBattle

tag @e[nbt=!{pixelmon:npc_trainer},tag=!GymLeader,name=Bugsy] add GymLeader
tag @e[nbt=!{pixelmon:npc_trainer},tag=!GymLeader,name=Whitney] add GymLeader
tag @e[nbt=!{pixelmon:npc_trainer},tag=!GymLeader,name=Jasmine] add GymLeader
tag @e[nbt=!{pixelmon:npc_trainer},tag=!GymLeader,name=Pryce] add GymLeader
tag @e[nbt=!{pixelmon:npc_trainer},tag=!GymLeader,name=Clair] add GymLeader
tag @e[nbt=!{pixelmon:npc_trainer},tag=!GymLeader,name=Chuck] add GymLeader
tag @e[nbt=!{pixelmon:npc_trainer},tag=!GymLeader,name=Falkner] add GymLeader
tag @e[nbt=!{pixelmon:npc_trainer},tag=!GymLeader,name=Morty] add GymLeader

tag @e[nbt=!{pixelmon:npc_trainer},tag=!GymLeader,name=Brock] add GymLeader
tag @e[nbt=!{pixelmon:npc_trainer},tag=!GymLeader,name=Misty] add GymLeader
tag @e[nbt=!{pixelmon:npc_trainer},tag=!GymLeader,name=Surge] add GymLeader
tag @e[nbt=!{pixelmon:npc_trainer},tag=!GymLeader,name=Erika] add GymLeader
tag @e[nbt=!{pixelmon:npc_trainer},tag=!GymLeader,name=Sabrina] add GymLeader
tag @e[nbt=!{pixelmon:npc_trainer},tag=!GymLeader,name=Janine] add GymLeader
tag @e[nbt=!{pixelmon:npc_trainer},tag=!GymLeader,name=Blaine] add GymLeader
tag @e[nbt=!{pixelmon:npc_trainer},tag=!GymLeader,name=Blue] add GymLeader
...
###execute at @e[nbt=!{pixelmon:bike}] run tag @s[distance=..2,tag=!Bicycle] add Bicycle
...
#Kanto Gym Leaders
execute at @e[x=-1220,y=60,z=633,dx=313,dy=100,dz=196,tag=GymLeader,nbt=!{pixelmon:npc_trainer}] run playsound gymbattlekanto record @a[tag=Temp,distance=..15,scores={MusicCooldown=0}] ~ ~ ~ 1 1 1
execute at @e[x=-1220,y=60,z=633,dx=313,dy=100,dz=196,tag=GymLeader,nbt=!{pixelmon:npc_trainer}] run scoreboard players set @a[tag=Temp,distance=..15,scores={MusicCooldown=0}] MusicCooldown 117



#Gym Leader radius
execute at @e[tag=GymLeader,nbt=!{pixelmon:npc_trainer}] run playsound gymbattle record @a[tag=Temp,distance=..15,scores={MusicCooldown=0}] ~ ~ ~ 1 1 1
execute at @e[tag=GymLeader,nbt=!{pixelmon:npc_trainer}] run scoreboard players set @a[tag=Temp,distance=..15,scores={MusicCooldown=0}] MusicCooldown 195



#Silver Trainer Battle
execute at @e[name=Silver,nbt=!{pixelmon:npc_trainer}] run playsound rivalbattle record @a[tag=Temp,distance=..15,scores={MusicCooldown=0}] ~ ~ ~ 1 1 1
execute at @e[name=Silver,nbt=!{pixelmon:npc_trainer}] run scoreboard players set @a[tag=Temp,distance=..15,scores={MusicCooldown=0}] MusicCooldown 178

#Silver Chatting NPC
execute at @e[name=Silver,nbt=!{pixelmon:npc_chatting}] run playsound rivaltalk record @a[tag=Temp,distance=..15,scores={MusicCooldown=0}] ~ ~ ~ 1 1 1
execute at @e[name=Silver,nbt=!{pixelmon:npc_chatting}] run scoreboard players set @a[tag=Temp,distance=..15,scores={MusicCooldown=0}] MusicCooldown 70



#Arceus legendary battle
execute at @e[tag=ArceusBattle,nbt=!{pixelmon:pixelmon}] run playsound arceusbattle record @a[tag=Temp,distance=..15,scores={MusicCooldown=0}] ~ ~ ~ 1 1 1
execute at @e[tag=ArceusBattle,nbt=!{pixelmon:pixelmon}] run scoreboard players set @a[tag=Temp,distance=..15,scores={MusicCooldown=0}] MusicCooldown 113


#General legendary battle
execute at @e[tag=Legendary,nbt=!{pixelmon:pixelmon},limit=1] run playsound legendarybattle record @a[tag=Temp,distance=..15,scores={MusicCooldown=0}] ~ ~ ~ 1 1 1
execute at @e[tag=Legendary,nbt=!{pixelmon:pixelmon},limit=1] run scoreboard players set @a[tag=Temp,distance=..15,scores={MusicCooldown=0}] MusicCooldown 286
