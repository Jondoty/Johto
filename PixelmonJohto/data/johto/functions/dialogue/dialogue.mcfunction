...
#Runs Spanish translations separately
execute as @s[tag=Spanish] run function johto:dialogue/spanish
...
tellraw @s[tag=English,scores={DialogueTrigger=1,TalkTime=1}] {"text":"<...> Hello! Sorry to keep you waiting!"}
tellraw @s[tag=English,scores={DialogueTrigger=1,TalkTime=8}] {"text":"<...> Welcome to the world of Pokémon!"}
tellraw @s[tag=English,scores={DialogueTrigger=1,TalkTime=16}] {"text":"<Professor Oak> My name is Oak. People call me the Pokémon Prof."}
...
tellraw @s[tag=English,scores={DialogueTrigger=1,TalkTime=25}] {"text":"<Professor Oak> This world is inhabited by creatures that we call Pokémon."}
tellraw @s[tag=English,scores={DialogueTrigger=1,TalkTime=33}] {"text":"<Professor Oak> People and Pokémon live together by supporting each other."}
tellraw @s[tag=English,scores={DialogueTrigger=1,TalkTime=41}] {"text":"<Professor Oak> Some people play with Pokémon, some battle with them."}
tellraw @s[tag=English,scores={DialogueTrigger=1,TalkTime=49}] {"text":"<Professor Oak> But we don't know everything about Pokémon yet."}
tellraw @s[tag=English,scores={DialogueTrigger=1,TalkTime=57}] {"text":"<Professor Oak> There are still many mysteries to solve. That's why I study Pokémon every day."}
tellraw @s[tag=English,scores={DialogueTrigger=1,TalkTime=66}] ["",{"text":"<Professor Oak> "},{"selector":"@s"},{"text":", are you ready?"}]
tellraw @s[tag=English,scores={DialogueTrigger=1,TalkTime=72}] {"text":"<Professor Oak> Your very own Pokémon story is about to unfold."}
tellraw @s[tag=English,scores={DialogueTrigger=1,TalkTime=80}] {"text":"<Professor Oak> You'll face fun times and tough challenges."}
tellraw @s[tag=English,scores={DialogueTrigger=1,TalkTime=87}] {"text":"<Professor Oak> A world of dreams and adventures with Pokémon awaits!"}
tellraw @s[tag=English,scores={DialogueTrigger=1,TalkTime=95}] {"text":"<Professor Oak> Let's go! I'll be seeing you later!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=1,TalkTime=103}] {"text":"Tip: You can return to the lobby at any time using that button in your room!","italic":true,"color":"gray"}
...
tellraw @s[tag=English,scores={DialogueTrigger=2,TalkTime=2}] ["",{"text":"<Mom> Oh, "},{"selector":"@s"},{"text":"...!"}]
tellraw @s[tag=English,scores={DialogueTrigger=2,TalkTime=8}] {"text":"<Mom> Our neighbor, Professor Elm, was looking for you."}
tellraw @s[tag=English,scores={DialogueTrigger=2,TalkTime=17}] {"text":"<Mom> He said he wanted you to do something for him."}
...
tellraw @s[tag=English,scores={DialogueTrigger=3,TalkTime=2}] ["",{"text":"<Professor Elm> "},{"selector":"@s"},{"text":"! There you are!"}]
tellraw @s[tag=English,scores={DialogueTrigger=3,TalkTime=9}] {"text":"<Professor Elm> I needed to ask you a favor."}
tellraw @s[tag=English,scores={DialogueTrigger=3,TalkTime=16}] {"text":"<Professor Elm> I have an acquaintance called Mr. Pokémon."}
tellraw @s[tag=English,scores={DialogueTrigger=3,TalkTime=24}] {"text":"<Professor Elm> He keeps finding weird things and raving about his discoveries."}
tellraw @s[tag=English,scores={DialogueTrigger=3,TalkTime=32}] {"text":"<Professor Elm> Anyway, I just got an e-mail from him saying that this time it's real."}
tellraw @s[tag=English,scores={DialogueTrigger=3,TalkTime=41}] {"text":"<Professor Elm> It is intriguing, but we're busy with our Pokémon research."}
tellraw @s[tag=English,scores={DialogueTrigger=3,TalkTime=49}] {"text":"<Professor Elm> Could you look into it for us?"}
tellraw @s[tag=English,scores={DialogueTrigger=3,TalkTime=56}] {"text":"<Professor Elm> I'll give you a Pokémon for a partner. They're all rare Pokémon that we just found."}
tellraw @s[tag=English,scores={DialogueTrigger=3,TalkTime=66}] {"text":"<Professor Elm> Go on. Pick one!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=4,TalkTime=5}] {"text":"<Professor Elm> Mr. Pokémon lives near Cherrygrove, the next city."}
tellraw @s[tag=English,scores={DialogueTrigger=4,TalkTime=14}] {"text":"<Professor Elm> It's almost a direct route to there."}
tellraw @s[tag=English,scores={DialogueTrigger=4,TalkTime=21}] {"text":"<Professor Elm> If your Pokémon is hurt, you should heal it with this machine."}
tellraw @s[tag=English,scores={DialogueTrigger=4,TalkTime=31}] ["",{"text":"<"},{"text":"Elm's Aide","color":"gray"},{"text":"> "},{"selector":"@s"},{"text":", I want you to have this for your errand."}]
...
tellraw @s[tag=English,scores={DialogueTrigger=4,TalkTime=40}] ["",{"text":"<"},{"text":"Elm's Aide","color":"gray"},{"text":"> There are only two of us, so we're always busy."}]
...
#execute @p[x=-252,y=63,z=-196,distance=..30,tag=Dialogue5] run effect give @e[x=-252,y=63,z=-196,dy=3,type=pixelmon:npc_chatting] minecraft:invisibility 10 10 true

tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=1}] ["",{"text":"<"},{"text":"Mr. Pokémon","color":"gray"},{"text":"> Hello, hello! You must be "},{"selector":"@s"},{"text":"."}]
tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=8}] ["",{"text":"<"},{"text":"Mr. Pokémon","color":"gray"},{"text":"> Professor Elm said that you would visit."}]
tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=15}] ["",{"text":"<"},{"text":"Mr. Pokémon","color":"gray"},{"text":"> This is what I want Professor Elm to examine."}]
...
tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=23}] ["",{"text":"<"},{"text":"Mr. Pokémon","color":"gray"},{"text":"> I know a couple who run a Pokémon Daycare service."}]
tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=30}] ["",{"text":"<"},{"text":"Mr. Pokémon","color":"gray"},{"text":"> They gave me that egg. I was intrigued, so I sent mail to Professor Elm."}]
tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=40}] ["",{"text":"<"},{"text":"Mr. Pokémon","color":"gray"},{"text":"> For Pokémon evolution, Professor Elm is the authority."}]
tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=47}] ["",{"text":"<"},{"text":"Mr. Pokémon","color":"gray"},{"text":"> Even Professor Oak here recognizes that."}]
tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=54}] ["",{"text":"<"},{"text":"Mr. Pokémon","color":"gray"},{"text":"> If my assumption is correct, Professor Elm will know it."}]
tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=62}] ["",{"text":"<Professor Oak> Aha! So you're "},{"selector":"@s"},{"text":"! I'm Oak!"}]
tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=69}] {"text":"<Professor Oak> A Pokémon researcher. I was just visitng my old friend Mr. Pokémon."}
tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=77}] {"text":"<Professor Oak> I heard you were running an errand for Professor Elm, so I waited here."}
tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=86}] {"text":"<Professor Oak> Oh! What's this? A rare Pokémon! Let's see... Hmm, I see!"}
tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=95}] {"text":"<Professor Oak> I understand why Professor Elm gave you a Pokémon for this errand."}
tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=104}] {"text":"<Professor Oak> To researchers like Professor Elm and I, Pokémon are our friends."}
tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=113}] {"text":"<Professor Oak> He saw that you would treat your Pokémon with love and care."}
tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=122}] {"text":"<Professor Oak> ...Ah! You seem to be dependable. How would you like to help me out?"}
tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=130}] {"text":"<Professor Oak> See? This is the latest version of Pokédex."}
tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=137}] {"text":"<Professor Oak> It automatically records data on Pokémon you've seen or caught."}
tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=146}] {"text":"<Professor Oak> It's a hi-tech encyclopedia!"}
tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=153}] {"text":"<Professor Oak> Go meet many kinds of Pokémon and complete that Pokédex!"}
tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=160}] {"text":"<Professor Oak> But I've stayed too long. I have to get to Goldenrod for my usual radio show."}
tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=169}] ["",{"text":"<Professor Oak> "},{"selector":"@s"},{"text":", I'm counting on you!"}]
tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=176}] ["",{"text":"<"},{"text":"Mr. Pokémon","color":"gray"},{"text":"> You are returning to Professor Elm?"}]
tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=183}] ["",{"text":"<"},{"text":"Mr. Pokémon","color":"gray"},{"text":"> Here. Your Pokémon should have some rest."}]
...
tellraw @s[tag=English,scores={DialogueTrigger=5,TalkTime=190}] ["",{"text":"<"},{"text":"Mr. Pokémon","color":"gray"},{"text":"> I'm depending on you!"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=6,TalkTime=4}] {"text":"< . . . > You got a Pokémon at the Lab. What a waste."}
tellraw @s[tag=English,scores={DialogueTrigger=6,TalkTime=12}] {"text":"< . . . > That's a Pokémon that's too good for a wimp like you."}
tellraw @s[tag=English,scores={DialogueTrigger=6,TalkTime=20}] {"text":"< . . . > Don't you get what I'm saying? Well, I too have a good Pokémon. I'll show you what I mean!"}
...
#execute as @s[x=-300,y=64,z=-509,distance=..10,tag=Dialogue6,score_StarterPick_min=1,score_StarterPick=1] run execute @s[tag=!Dialogue7] run tp @e[x=-760,y=84,z=-242,dy=10,type=pixelmon:npc_trainer,score_StarterPick_min=1,score_StarterPick=1] -300 64 -509
...
tellraw @s[tag=English,scores={DialogueTrigger=7,TalkTime=2}] {"text":"< . . . > \u2026Humph! That was a waste of time."}
tellraw @s[tag=English,scores={DialogueTrigger=7,TalkTime=9}] {"text":"< . . . > \u2026Do you want to know who I am? I'm going to be the world's greatest Pokémon Trainer."}

execute as @s[scores={DialogueTrigger=7,TalkTime=17}] run particle cloud -300 64 -509 1 1 1 0.15 300
execute as @s[scores={DialogueTrigger=7,TalkTime=17}] run tp @e[x=-300,y=64,z=-509,distance=..2,type=pixelmon:npc_trainer,scores={StarterPick=1}] -760 93 -242
execute as @s[scores={DialogueTrigger=7,TalkTime=17}] run tp @e[x=-300,y=64,z=-509,distance=..2,type=pixelmon:npc_trainer,scores={StarterPick=2}] -760 89 -242
execute as @s[scores={DialogueTrigger=7,TalkTime=17}] run tp @e[x=-300,y=64,z=-509,distance=..2,type=pixelmon:npc_trainer,scores={StarterPick=3}] -760 85 -242
...
#tp Officer in
execute as @s[scores={DialogueTrigger=8,TalkTime=1}] run tp @e[x=-716,y=90,z=-242,dy=3,type=pixelmon:npc_chatting] -682 64 -481
execute as @s[scores={DialogueTrigger=8,TalkTime=1}] run particle cloud -682 64 -481 1 1 1 0.15 100

tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=4}] ["",{"text":"<"},{"text":"Elm's Aide","color":"gray"},{"text":"> There was a loud noise outside... When we went to look, someone stole a Pokémon."}]
tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=14}] ["",{"text":"<"},{"text":"Elm's Aide","color":"gray"},{"text":"> It's unbelievable that anyone would do that!"}]
tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=22}] ["",{"text":"<"},{"text":"Elm's Aide","color":"gray"},{"text":"> ...sigh... That stolen Pokémon. I wonder how it's doing."}]
tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=30}] ["",{"text":"<"},{"text":"Elm's Aide","color":"gray"},{"text":"> They say a Pokémon raised by a bad person turns bad itself."}]
tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=38}] ["",{"text":"<"},{"text":"Policeman","color":"aqua"},{"text":"> I heard a Pokémon was stolen here..."}]
tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=45}] ["",{"text":"<"},{"text":"Policeman","color":"aqua"},{"text":"> I was just getting some information from Professor Elm."}]
tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=52}] ["",{"text":"<"},{"text":"Policeman","color":"aqua"},{"text":"> Apparently, it was a young male with long, red hair..."}]
tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=60}] ["",{"text":"<"},{"text":"Policeman","color":"aqua"},{"text":"> What? You battled a trainer like that? Did you happen to get his name?"}]
tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=69}] ["",{"text":"<"},{"text":"Policeman","color":"aqua"},{"text":"> ... ... ..."}]
tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=74}] ["",{"text":"<"},{"text":"Policeman","color":"aqua"},{"text":"> So Silver was his name. Thanks for helping my investigation!"}]

#tp Police officer out
execute as @s[scores={DialogueTrigger=8,TalkTime=80}] run tp @e[x=-682,y=63,z=-481,dy=3,type=pixelmon:npc_chatting] -716 91 -242
execute as @s[scores={DialogueTrigger=8,TalkTime=80}] run particle cloud -682 64 -481 1 1 1 0.15 100

tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=83}] ["",{"text":"<Professor Elm> "},{"selector":"@s"},{"text":", this is terrible..."}]
tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=90}] {"text":"<Professor Elm> Oh, yes, what was Mr. Pokémon's big discovery?"}

#Clears Mystery Egg item
execute as @s[scores={DialogueTrigger=8,TalkTime=95}] run clear @s minecraft:music_disc_wait

tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=97}] {"text":"<Professor Elm> This? But... It is a Pokémon Egg?"}
tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=104}] {"text":"<Professor Elm> If it is, it is a great discovery!"}
execute as @s[scores={DialogueTrigger=8,TalkTime=104}] run advancement grant @s only johto:mysteryegg
tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=111}] {"text":"<Professor Elm>  What?!? Professor Oak gave you a Pokédex?"}
tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=118}] ["",{"text":"<Professor Elm> "},{"selector":"@s"},{"text":", is that true? Th-that's incredible!"}]
tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=126}] {"text":"<Professor Elm> He is superb at seeing the potential of people as trainers."}
tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=134}] ["",{"text":"<Professor Elm> Wow, "},{"selector":"@s"},{"text":". You may have what it takes to become the Champion."}]
tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=142}] {"text":"<Professor Elm> You seem to be getting on great with Pokémon too."}
tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=149}] {"text":"<Professor Elm> You should take the Pokémon Gym challenge."}
tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=156}] {"text":"<Professor Elm> The closest Gym would be the one in Violet City."}
tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=163}] ["",{"text":"<Professor Elm> ..."},{"selector":"@s"},{"text":". The road to the championship will be a long one."}]
#tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=172}] {"text":"<Professor Elm> Before you leave, make sure that you talk to your mom."}


tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=172}] ["",{"text":"<"},{"text":"Elm's Aide","color":"gray"},{"text":"> "},{"selector":"@s"},{"text":"! Use these on your Pokédex quest!"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=178}] ["",{"text":"<"},{"text":"Elm's Aide","color":"gray"},{"text":"> To add to your Pokédex, you have to catch Pokémon."}]
tellraw @s[tag=English,scores={DialogueTrigger=8,TalkTime=186}] ["",{"text":"<"},{"text":"Elm's Aide","color":"gray"},{"text":"> Throw Poké Balls at wild Pokémon to get them."}]
...
tellraw @s[tag=English,scores={DialogueTrigger=9,TalkTime=3}] {"text":"<Elder Li> You are indeed skilled as a trainer. As promised, here is your HM."}
tellraw @s[tag=English,scores={DialogueTrigger=9,TalkTime=13}] {"text":"<Elder Li> But let me say this: You should treat your Pokémon better."}
tellraw @s[tag=English,scores={DialogueTrigger=9,TalkTime=22}] {"text":"<Elder Li> The way you battle is far too harsh. Pokémon are not tools of war..."}
tellraw @s[tag=English,scores={DialogueTrigger=9,TalkTime=31}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> ... ...Humph! He claims to be the Elder but he's weak. It stands to reason."}]
tellraw @s[tag=English,scores={DialogueTrigger=9,TalkTime=40}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> I'd never lose to fools who babble about being nice to Pokémon."}]
tellraw @s[tag=English,scores={DialogueTrigger=9,TalkTime=48}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> I only care about strong Pokémon that can win."}]
tellraw @s[tag=English,scores={DialogueTrigger=9,TalkTime=56}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> I really couldn't care less about weak Pokémon."}]
tellraw @s[tag=English,scores={DialogueTrigger=9,TalkTime=64}] {"text":"Silver used an Escape Rope!","italic":true,"color":"gray"}
...
execute as @s[scores={DialogueTrigger=9,TalkTime=64}] run tp @e[x=57,y=103,z=29,dy=3,type=pixelmon:npc_chatting] -758 89 -242
...
tellraw @s[tag=English,scores={DialogueTrigger=10,TalkTime=1}] {"text":"<Elder Li> You and your Pokémon should have no problem using this move."}
tellraw @s[tag=English,scores={DialogueTrigger=10,TalkTime=9}] {"text":"<Elder Li> Take this Flash HM."}
...
tellraw @s[tag=English,scores={DialogueTrigger=10,TalkTime=17}] {"text":"<Elder Li> Flash illuminates even the darkest of all places."}
tellraw @s[tag=English,scores={DialogueTrigger=10,TalkTime=25}] {"text":"<Elder Li> I hope you learn and grow from your journey."}
...
tellraw @s[tag=English,scores={DialogueTrigger=11,TalkTime=1}] {"text":"<Falkner> I'm Falker, the Violet Pokémon Gym leader!"}
tellraw @s[tag=English,scores={DialogueTrigger=11,TalkTime=9}] {"text":"<Falkner> People say you can clip flying-type Pokémon's wings with a jolt of electricity..."}
tellraw @s[tag=English,scores={DialogueTrigger=11,TalkTime=19}] {"text":"<Falkner> I won't allow such insults to bird Pokémon!"}
tellraw @s[tag=English,scores={DialogueTrigger=11,TalkTime=26}] {"text":"<Falkner> I'll show you the real power of the magnificent bird Pokémon!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=12,TalkTime=1}] {"text":"<Falkner> ...Darn! My Dad's cherished bird Pokémon..."}
tellraw @s[tag=English,scores={DialogueTrigger=12,TalkTime=8}] {"text":"<Falkner> All right. Take this."}
...
tellraw @s[tag=English,scores={DialogueTrigger=12,TalkTime=18}] {"text":"<Falkner> It's the official Pokémon League Zephyrbadge."}
tellraw @s[tag=English,scores={DialogueTrigger=12,TalkTime=26}] {"text":"<Falkner> Here--take this too."}
...
tellraw @s[tag=English,scores={DialogueTrigger=12,TalkTime=32}] {"text":"<Falkner> By using a TM, a Pokémon will instantly learn a new move."}
tellraw @s[tag=English,scores={DialogueTrigger=12,TalkTime=40}] {"text":"<Falkner> You can even use them more than once!"}
tellraw @s[tag=English,scores={DialogueTrigger=12,TalkTime=47}] {"text":"<Falkner> TM51 contains Roost. It restores half the max HP."}
tellraw @s[tag=English,scores={DialogueTrigger=12,TalkTime=55}] {"text":"<Falkner> There are Pokémon Gyms in cities and towns ahead. Make good use of them!"}
tellraw @s[tag=English,scores={DialogueTrigger=12,TalkTime=64}] {"text":"<Falkner> As for your next move... I would suggest Azalea Town."}
...
#tp Aide in
execute as @s[scores={DialogueTrigger=13,TalkTime=1}] run tp @e[x=-815,y=64,z=-240,dy=3,type=pixelmon:npc_chatting] 11 64 -100
execute as @s[scores={DialogueTrigger=13,TalkTime=1}] run particle cloud 11 64 -100 1 1 1 1 100

tellraw @s[tag=English,scores={DialogueTrigger=13,TalkTime=4}] ["",{"text":"<"},{"text":"Elm's Aide","color":"gray"},{"text":"> "},{"selector":"@s"},{"text":", long time, no see. Professor Elm asked me to find you."}]
tellraw @s[tag=English,scores={DialogueTrigger=13,TalkTime=14}] ["",{"text":"<"},{"text":"Elm's Aide","color":"gray"},{"text":"> He has another favor to ask. Would you take the Pokémon Egg?"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=13,TalkTime=25}] ["",{"text":"<"},{"text":"Elm's Aide","color":"gray"},{"text":"> We discovered that a Pokémon will not hatch until it grows in the Egg."}]
tellraw @s[tag=English,scores={DialogueTrigger=13,TalkTime=34}] ["",{"text":"<"},{"text":"Elm's Aide","color":"gray"},{"text":"> It also has to be with other active Pokémon to hatch."}]
tellraw @s[tag=English,scores={DialogueTrigger=13,TalkTime=42}] ["",{"text":"<"},{"text":"Elm's Aide","color":"gray"},{"text":"> "},{"selector":"@s"},{"text":", you're the only person we can rely on."}]

#tp Aide back
execute as @s[scores={DialogueTrigger=13,TalkTime=50}] run tp @e[x=11,y=63,z=-100,dy=3,type=pixelmon:npc_chatting] -815 65 -240
...
execute as @s[scores={DialogueTrigger=14,TalkTime=1}] run tp @e[x=371,y=63,z=-698,dy=3,type=pixelmon:npc_chatting] 371 64 -698

tellraw @s[tag=English,scores={DialogueTrigger=14,TalkTime=2}] {"text":"<Kurt> Hm? Who are you?"}
tellraw @s[tag=English,scores={DialogueTrigger=14,TalkTime=8}] ["",{"text":"<Kurt> "},{"selector":"@s"},{"text":", eh? You want me to make some Balls?"}]
tellraw @s[tag=English,scores={DialogueTrigger=14,TalkTime=16}] {"text":"<Kurt> Sorry, but that'll have to wait. Do you know Team Rocket?"}
tellraw @s[tag=English,scores={DialogueTrigger=14,TalkTime=24}] {"text":"<Kurt> Ah, don't worry. I'll tell you anyhow."}
tellraw @s[tag=English,scores={DialogueTrigger=14,TalkTime=31}] {"text":"<Kurt> Team Rocket's an evil gang that uses Pokémon for their dirty work."}
tellraw @s[tag=English,scores={DialogueTrigger=14,TalkTime=39}] {"text":"<Kurt> They're supposed to have disbanded three years ago."}
tellraw @s[tag=English,scores={DialogueTrigger=14,TalkTime=46}] {"text":"<Kurt> Anyway, they're at the Well, cutting off Slowpoketails for sale!"}
tellraw @s[tag=English,scores={DialogueTrigger=14,TalkTime=54}] {"text":"<Kurt> So I'm going to go give them a lesson in pain!"}
tellraw @s[tag=English,scores={DialogueTrigger=14,TalkTime=61}] {"text":"<Kurt> Hang on, Slowpoke! Old Kurt is on his way!"}

#Kurt TPs out
execute as @s[scores={DialogueTrigger=14,TalkTime=68}] run tp @e[x=371,y=63,z=-698,dy=3,type=pixelmon:npc_chatting] -726 91 -242
...
#execute as @s[x=244,y=56,z=-714,distance=..20,tag=!Dialogue15] run tp @e[x=-728,y=90,z=-242,dy=3,type=pixelmon:npc_chatting] 244 39 -708

#tps in Team Rocket grunts
execute as @s[scores={DialogueTrigger=15,TalkTime=3}] run tp @e[x=-748,y=90,z=-242,dy=3,type=pixelmon:npc_trainer] 251 39 -691
execute as @s[scores={DialogueTrigger=15,TalkTime=3}] run tp @e[x=-746,y=90,z=-242,dy=3,type=pixelmon:npc_trainer] 262 43 -671
execute as @s[scores={DialogueTrigger=15,TalkTime=3}] run tp @e[x=-744,y=90,z=-242,dy=3,type=pixelmon:npc_trainer] 291 39 -679
execute as @s[scores={DialogueTrigger=15,TalkTime=3}] run tp @e[x=-742,y=90,z=-242,dy=3,type=pixelmon:npc_trainer] 289 39 -661

#Kurt in the Well
tellraw @s[tag=English,scores={DialogueTrigger=15,TalkTime=2}] ["",{"text":"<Kurt> Hey there, "},{"selector":"@s"},{"text":"! The guards up top took off when I shouted at them."}]
tellraw @s[tag=English,scores={DialogueTrigger=15,TalkTime=11}] {"text":"<Kurt> But then I took a tumble down the Well."}
tellraw @s[tag=English,scores={DialogueTrigger=15,TalkTime=18}] {"text":"<Kurt> I slammed down hard on my back, so I can't move. Rats!"}
tellraw @s[tag=English,scores={DialogueTrigger=15,TalkTime=26}] {"text":"<Kurt> If I were fit, my Pokémon would've punished them..."}
tellraw @s[tag=English,scores={DialogueTrigger=15,TalkTime=34}] ["",{"text":"<Kurt> Ah, it can't be helped. "},{"selector":"@s"},{"text":", show them how gutsy you are in my place!"}]
...
#execute as @p[x=244,y=56,z=-714,distance=..25,tag=Dialogue14] run tp @e[x=247,y=53,z=-714,dy=3,type=pixelmon:npc_chatting] -750 91 -242
...
#execute as @s[x=289,y=38,z=-665,distance=..10,tag=Dialogue15,score_TalkTime=0] run execute @s[tag=!Dialogue16] run tp @e[x=-742,y=90,z=-242,dy=3,type=pixelmon:npc_trainer] 289 39 -661

execute as @s[scores={DialogueTrigger=16,TalkTime=1}] run clear @s minecraft:nether_brick
tellraw @s[tag=English,scores={DialogueTrigger=16,TalkTime=2}] ["",{"text":"<"},{"text":"Team Rocket Proton","color":"green"},{"text":"> Yeah, Team Rocket was broken up three years ago."}]
tellraw @s[tag=English,scores={DialogueTrigger=16,TalkTime=9}] ["",{"text":"<"},{"text":"Team Rocket Proton","color":"green"},{"text":"> But we continued our activities underground."}]
tellraw @s[tag=English,scores={DialogueTrigger=16,TalkTime=16}] ["",{"text":"<"},{"text":"Team Rocket Proton","color":"green"},{"text":"> Now you can have fun watching us stir up trouble!"}]

#tp Team Rocket out
execute as @s[scores={DialogueTrigger=16,TalkTime=23}] run particle cloud 289 39 -661 1 1 1 1 100
execute as @s[scores={DialogueTrigger=16,TalkTime=23}] run tp @e[x=251,y=38,z=-691,dy=3,type=pixelmon:npc_trainer] -748 91 -242
execute as @s[scores={DialogueTrigger=16,TalkTime=23}] run tp @e[x=262,y=42,z=-671,dy=3,type=pixelmon:npc_trainer] -746 91 -242
execute as @s[scores={DialogueTrigger=16,TalkTime=23}] run tp @e[x=289,y=38,z=-661,dy=3,type=pixelmon:npc_trainer] -742 91 -242
execute as @s[scores={DialogueTrigger=16,TalkTime=23}] run tp @e[x=291,y=38,z=-679,dy=3,type=pixelmon:npc_trainer] -744 91 -242
...
execute as @s[scores={DialogueTrigger=16,TalkTime=26}] run tp @e[x=-815,y=69,z=-240,dy=3,type=pixelmon:npc_chatting] 286 39 -667

#tp the Kurt standing at the entrance of the Well out
execute as @s[scores={DialogueTrigger=16,TalkTime=26}] run tp @e[x=244,y=38,z=-708,dy=3,type=pixelmon:npc_chatting] -728 91 -242

tellraw @s[tag=English,scores={DialogueTrigger=16,TalkTime=29}] ["",{"text":"<Kurt> Way to go, "},{"selector":"@s"},{"text":"!"}]
tellraw @s[tag=English,scores={DialogueTrigger=16,TalkTime=36}] {"text":"<Kurt> Team Tocket has taken off. My back's better too."}
tellraw @s[tag=English,scores={DialogueTrigger=16,TalkTime=43}] {"text":"<Kurt> Let's get out of here."}

#blinds player
#tps Kurt out
execute as @s[scores={DialogueTrigger=16,TalkTime=49}] run effect give @s minecraft:blindness 5 1 true
execute as @s[scores={DialogueTrigger=16,TalkTime=50}] run tp @e[x=286,y=38,z=-667,dy=3,type=pixelmon:npc_chatting] -815 70 -240

#tps house Kurt in
execute as @s[scores={DialogueTrigger=16,TalkTime=53}] run tp @e[x=-726,y=90,z=-242,dy=3,type=pixelmon:npc_chatting] 371 64 -698
...
tellraw @s[tag=English,scores={DialogueTrigger=16,TalkTime=55}] {"text":"<Kurt> You handled yourself like a real hero at the Well."}
tellraw @s[tag=English,scores={DialogueTrigger=16,TalkTime=62}] {"text":"<Kurt> I like your style! I would be honored to make Balls for a trainer like you."}
tellraw @s[tag=English,scores={DialogueTrigger=16,TalkTime=70}] {"text":"<Kurt> This is all I have now, but take it."}
...
tellraw @s[tag=English,scores={DialogueTrigger=16,TalkTime=78}] {"text":"<Kurt> I make Balls from Apricorns."}
tellraw @s[tag=English,scores={DialogueTrigger=16,TalkTime=83}] {"text":"<Kurt> Collect them from trees and bring em to my benches. We'll make Balls out of them."}
...
#execute as @p[x=371,y=64,z=-698,distance=..25,tag=Dialogue16,score_TalkTime=0] run tp @e[x=-726,y=90,z=-242,dy=3,type=pixelmon:npc_chatting] 371 64 -698
...
tellraw @s[tag=English,scores={DialogueTrigger=17,TalkTime=1}] {"text":"<Bugsy> I'm Bugsy! I never lose when it comes to bug Pokémon."}
tellraw @s[tag=English,scores={DialogueTrigger=17,TalkTime=10}] {"text":"<Bugsy> My research is going to make me the authority on bug Pokémon!"}
tellraw @s[tag=English,scores={DialogueTrigger=17,TalkTime=19}] {"text":"<Bugsy> Let me demonstrate what I've learned from my studies."}
...
tellraw @s[tag=English,scores={DialogueTrigger=18,TalkTime=6}] {"text":"<Bugsy> Do you know the benefits of Hivebadge?"}
tellraw @s[tag=English,scores={DialogueTrigger=18,TalkTime=14}] {"text":"<Bugsy> If you have it, you can use the HM Cut outside of battle."}
tellraw @s[tag=English,scores={DialogueTrigger=18,TalkTime=23}] {"text":"<Bugsy> Here, I also want you to have this."}
...
tellraw @s[tag=English,scores={DialogueTrigger=18,TalkTime=30}] {"text":"<Bugsy> TM89 contains U-turn."}
tellraw @s[tag=English,scores={DialogueTrigger=18,TalkTime=37}] {"text":"<Bugsy> It lets your Pokémon attack, then switch with the next Pokémon in your party."}
tellraw @s[tag=English,scores={DialogueTrigger=18,TalkTime=47}] {"text":"<Bugsy> Isn't that great?"}
...
tellraw @s[tag=English,scores={DialogueTrigger=19,TalkTime=3}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> ...Tell me something. Is it true that Team Rocket has returned?"}]
tellraw @s[tag=English,scores={DialogueTrigger=19,TalkTime=11}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> What? You beat them?"}]
tellraw @s[tag=English,scores={DialogueTrigger=19,TalkTime=17}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> Hah! Quit lying."}]
tellraw @s[tag=English,scores={DialogueTrigger=19,TalkTime=25}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> You're not joking? Then let's see how good you are."}]
...
tellraw @s[tag=English,scores={DialogueTrigger=20,TalkTime=1}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> ... Humph! Useless Pokémon!"}]
tellraw @s[tag=English,scores={DialogueTrigger=20,TalkTime=7}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> Listen, you. You only won because my Pokémon were weak."}]
tellraw @s[tag=English,scores={DialogueTrigger=20,TalkTime=15}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> I hate the weak. Pokémon, trainers. It doesn't matter who or what."}]
tellraw @s[tag=English,scores={DialogueTrigger=20,TalkTime=24}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> I'm going to be strong and wipe out the weak."}]
tellraw @s[tag=English,scores={DialogueTrigger=20,TalkTime=32}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> That goes for Team Rocket too. They act big and tough in a group."}]
tellraw @s[tag=English,scores={DialogueTrigger=20,TalkTime=41}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> But get them alone, and they're weak. I hate them all."}]
tellraw @s[tag=English,scores={DialogueTrigger=20,TalkTime=49}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> You stay out of my way. A weakling like you is only a distraction."}]

#tp Return Silver
execute as @s[scores={DialogueTrigger=20,TalkTime=57}] run particle cloud 402 64 -734 1 1 1 1 100
execute as @s[scores={DialogueTrigger=20,TalkTime=57}] run tp @e[x=402,y=64,z=-734,distance=..2,type=pixelmon:npc_trainer,scores={StarterPick=3}] -762 85 -242
execute as @s[scores={DialogueTrigger=20,TalkTime=57}] run tp @e[x=402,y=64,z=-734,distance=..2,type=pixelmon:npc_trainer,scores={StarterPick=2}] -762 89 -242
execute as @s[scores={DialogueTrigger=20,TalkTime=57}] run tp @e[x=402,y=64,z=-734,distance=..2,type=pixelmon:npc_trainer,scores={StarterPick=1}] -762 93 -242
...
tellraw @s[tag=English,scores={DialogueTrigger=21,TalkTime=1}] {"text":"<Charcoal Apprentice> The Farfetch'd that Cuts trees for charcoal took off on me."}
tellraw @s[tag=English,scores={DialogueTrigger=21,TalkTime=9}] {"text":"<Charcoal Apprentice> I can't go looking for it here in the Ilex Forest."}
tellraw @s[tag=English,scores={DialogueTrigger=21,TalkTime=17}] {"text":"<Charcoal Apprentice> It's too big, dark and scary for me..."}
...
execute as @s[scores={DialogueTrigger=22,TalkTime=1}] run tp @e[x=-815,y=74,z=-240,dy=3,type=pixelmon:npc_chatting] 625 64 -714

tellraw @s[tag=English,scores={DialogueTrigger=22,TalkTime=1}] {"text":"<Charcoal Apprentice> Wow! Thanks a whole bunch!"}
tellraw @s[tag=English,scores={DialogueTrigger=22,TalkTime=8}] {"text":"<Charcoal Apprentice> My boss's Pokémon won't obey me because I don't have a Badge."}
tellraw @s[tag=English,scores={DialogueTrigger=22,TalkTime=16}] ["",{"text":"<"},{"text":"Charcoal Master","color":"gray"},{"text":"> Ah! My Farfetch'd! You found it for us, kid?"}]
tellraw @s[tag=English,scores={DialogueTrigger=22,TalkTime=22}] ["",{"text":"<"},{"text":"Charcoal Master","color":"gray"},{"text":"> Without it, we wouldn't be able to Cut trees for charcoal."}]
tellraw @s[tag=English,scores={DialogueTrigger=22,TalkTime=30}] ["",{"text":"<"},{"text":"Charcoal Master","color":"gray"},{"text":"> Thanks, kid! Now, how can I thank you..."}]
tellraw @s[tag=English,scores={DialogueTrigger=22,TalkTime=37}] ["",{"text":"<"},{"text":"Charcoal Master","color":"gray"},{"text":"> I know! Here, take this."}]
...
tellraw @s[tag=English,scores={DialogueTrigger=22,TalkTime=47}] ["",{"text":"<"},{"text":"Charcoal Master","color":"gray"},{"text":"> That's the Cut HM. You can use that to clear small trees."}]
tellraw @s[tag=English,scores={DialogueTrigger=22,TalkTime=55}] ["",{"text":"<"},{"text":"Charcoal Master","color":"gray"},{"text":"> Thanks again for your help!"}]

#master tps away
execute as @s[scores={DialogueTrigger=22,TalkTime=60}] run particle cloud 625 64 -714 1 1 1 1 100
execute as @s[scores={DialogueTrigger=22,TalkTime=60}] run tp @e[x=625,y=63,z=-714,dy=3,type=pixelmon:npc_chatting] -815 75 -240
...
tellraw @s[tag=English,scores={DialogueTrigger=23,TalkTime=1}] {"text":"<Bicycle Clerk> ...sigh..."}
tellraw @s[tag=English,scores={DialogueTrigger=23,TalkTime=6}] {"text":"<Bicycle Clerk> I moved here, but I can't sell my Bicycles. Why is that?"}
tellraw @s[tag=English,scores={DialogueTrigger=23,TalkTime=14}] {"text":"<Bicycle Clerk> Could you ride a Bicycle and advertise for me?"}
tellraw @s[tag=English,scores={DialogueTrigger=23,TalkTime=21}] {"text":"<Bicycle Clerk> Really? Great!"}
tellraw @s[tag=English,scores={DialogueTrigger=23,TalkTime=28}] {"text":"<Bicycle Clerk> Give me your name and phone number, and I'll loan you a Bicycle."}
...
tellraw @s[tag=English,scores={DialogueTrigger=23,TalkTime=37}] {"text":"<Bicycle Clerk> My Bicycles are first-rate! You can ride them anywhere."}
...
tellraw @s[tag=English,scores={DialogueTrigger=26,TalkTime=5}] ["",{"text":"<Bicycle Clerk> Hi, "},{"selector":"@s"},{"text":"! Our Bicycle sales have gone through the roof!"}]
tellraw @s[tag=English,scores={DialogueTrigger=26,TalkTime=15}] {"text":"<Bicycle Clerk> We owe it all to your advertising by riding around on our Bicycle."}
tellraw @s[tag=English,scores={DialogueTrigger=26,TalkTime=25}] {"text":"<Bicycle Clerk> As our way of saying thanks, please keep that Bicycle. Thanks again!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=24,TalkTime=1}] {"text":"<Charcoal Apprentice> I'm sorry--I forgot to thank you."}
tellraw @s[tag=English,scores={DialogueTrigger=24,TalkTime=8}] {"text":"<Charcoal Apprentice> This is Charcoal that I made."}
...
tellraw @s[tag=English,scores={DialogueTrigger=24,TalkTime=14}] {"text":"<Charcoal Apprentice> Fire-type Pokémon would be happy to hold that."}
tellraw @s[tag=English,scores={DialogueTrigger=24,TalkTime=22}] {"text":"<Charcoal Apprentice> The Slowpoke came back, and you even found Farfetch'd"}
tellraw @s[tag=English,scores={DialogueTrigger=24,TalkTime=31}] {"text":"<Charcoal Apprentice> You're the coolest, man!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=25,TalkTime=1}] {"text":"<DJ Reed> Hi, are you here for the Lucky Number Show? Want me to check the ID numbers of your Pokémon?"}
tellraw @s[tag=English,scores={DialogueTrigger=25,TalkTime=11}] {"text":"<DJ Reed> If you get lucky, you win a prize."}
tellraw @s[tag=English,scores={DialogueTrigger=25,TalkTime=18}] {"text":"<DJ Reed> Throw out a Pokémon, and let see if you have a match."}
...
tellraw @s[tag=English,scores={DialogueTrigger=27,TalkTime=1}] {"text":"<Whitney> Hi! I'm Whitney!"}
tellraw @s[tag=English,scores={DialogueTrigger=27,TalkTime=8}] {"text":"<Whitney> Everyone was into Pokémon, so I got into it too!"}
tellraw @s[tag=English,scores={DialogueTrigger=27,TalkTime=16}] {"text":"<Whitney> Pokémon are super-cute! You want to battle?"}
tellraw @s[tag=English,scores={DialogueTrigger=27,TalkTime=24}] {"text":"<Whitney> I'm warning you--I'm good!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=28,TalkTime=5}] {"text":"<Whitney> Sob... "}
tellraw @s[tag=English,scores={DialogueTrigger=28,TalkTime=14}] {"text":"<Whitney> ...Waaaaaaah! "}
tellraw @s[tag=English,scores={DialogueTrigger=28,TalkTime=21}] {"text":"<Whitney> You're mean! You shouldn't be so serious! "}
tellraw @s[tag=English,scores={DialogueTrigger=28,TalkTime=29}] {"text":"<Whitney> You...you child, you! Waaaaah! Waaaaah! "}
tellraw @s[tag=English,scores={DialogueTrigger=28,TalkTime=37}] {"text":"<Whitney> Snivel, hic...You meanie!"}

tellraw @s[tag=English,scores={DialogueTrigger=28,TalkTime=49}] ["",{"text":"<"},{"text":"Lass Krise","color":"light_purple"},{"text":"> Oh, no. You made Whitney cry."}]
tellraw @s[tag=English,scores={DialogueTrigger=28,TalkTime=56}] ["",{"text":"<"},{"text":"Lass Krise","color":"light_purple"},{"text":"> It's OK. She'll stop soon."}]
tellraw @s[tag=English,scores={DialogueTrigger=28,TalkTime=63}] ["",{"text":"<"},{"text":"Lass Krise","color":"light_purple"},{"text":"> She always cries when she loses."}]

tellraw @s[tag=English,scores={DialogueTrigger=28,TalkTime=75}] {"text":"<Whitney> ...Sniff... What? What do you want?"}
tellraw @s[tag=English,scores={DialogueTrigger=28,TalkTime=83}] {"text":"<Whitney> A badge? Oh, right. I forgot. Here's the Plain Badge."}
...
tellraw @s[tag=English,scores={DialogueTrigger=28,TalkTime=98}] {"text":"<Whitney> Oh, you can have this, too!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=28,TalkTime=106}] {"text":"<Whitney> It's Attract! It makes full use of a Pokémon's charm."}
tellraw @s[tag=English,scores={DialogueTrigger=28,TalkTime=114}] {"text":"<Whitney> Isn't it just perfect for a cutie like me?"}
tellraw @s[tag=English,scores={DialogueTrigger=28,TalkTime=123}] {"text":"<Whitney> Ah, that was a good cry! Come for a visit again! Bye-bye!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=29,TalkTime=1}] {"text":"<Shop Clerk> Oh, you're better than Whitney. Do you now about that moving tree?"}
tellraw @s[tag=English,scores={DialogueTrigger=29,TalkTime=11}] {"text":"<Shop Clerk> If you wet it with a Squirtbottle, it attacks."}
tellraw @s[tag=English,scores={DialogueTrigger=29,TalkTime=20}] {"text":"<Shop Clerk> But since you have some Badges, you should be OK."}
...
tellraw @s[tag=English,scores={DialogueTrigger=29,TalkTime=30}] {"text":"<Shop Clerk> Lalala lalalala. Have plenty of water, my lovely!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=30,TalkTime=1}] {"text":"It's a weird tree.","italic":true,"color":"gray"}
tellraw @s[tag=English,scores={DialogueTrigger=30,TalkTime=7}] ["",{"selector":"@s","italic":true,"color":"gray"},{"text":" used the Squirtbottle.","italic":true,"color":"gray"}]
tellraw @s[tag=English,scores={DialogueTrigger=30,TalkTime=15}] {"text":"The weird tree doesn't like the Squirtbottle!","italic":true,"color":"gray"}
tellraw @s[tag=English,scores={DialogueTrigger=30,TalkTime=23}] {"text":"The weird tree attacked!","italic":true,"color":"gray"}
...
#Road Blocks
#North
#tellraw @s[tag=English,x=331,y=63,z=-23,dx=4,dy=5,dz=9,tag=!Dialogue29] {"text":"It's a weird tree. Perhaps water may cause it to move.","italic":true,"color":"gray"}
#tp @s[x=331,y=63,z=-23,dx=4,dy=5,dz=9,tag=!Dialogue29] ~ ~ ~-10

#West
#tellraw @s[tag=English,x=327,y=63,z=-19,dx=10,dy=5,dz=5,tag=!Dialogue29] {"text":"It's a weird tree. Perhaps water may cause it to move.","italic":true,"color":"gray"}
...
#execute as @s[x=343,y=64,z=216,distance=..50,tag=!Dialogue31,score_TalkTime=0] run /tp @e[x=-758,y=84,z=-242,dy=3,type=pixelmon:npc_chatting] 343 64 216

execute as @s[scores={DialogueTrigger=31,TalkTime=1}] run scoreboard players set @s click 1
tellraw @s[tag=English,scores={DialogueTrigger=31,TalkTime=1}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> How? How is this possible? How can I lose to mere Kimono Girls"}]
tellraw @s[tag=English,scores={DialogueTrigger=31,TalkTime=11}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> You were watching me, "},{"selector":"@s"},{"text":"? "}]
tellraw @s[tag=English,scores={DialogueTrigger=31,TalkTime=18}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> Yeah, that's right! I never thought defeating five Kimono Girls would be so hard!"}]
tellraw @s[tag=English,scores={DialogueTrigger=31,TalkTime=28}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> I got beaten to a pulp... Don't get cocky just because you defeated Team Rocket!"}]
tellraw @s[tag=English,scores={DialogueTrigger=31,TalkTime=38}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> Go ahead! But I'm not going back."}]
tellraw @s[tag=English,scores={DialogueTrigger=31,TalkTime=46}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> I don't want to see you win. These Kimono Girls are insanely strong."}]
...
tellraw @s[tag=English,scores={DialogueTrigger=32,TalkTime=1}] {"text":"<...> Not only are the Kimono Girls great dancers, they're also skilled at Pokémon."}
tellraw @s[tag=English,scores={DialogueTrigger=32,TalkTime=11}] {"text":"<...> I always challenge them, but I've never even left a scratch..."}
tellraw @s[tag=English,scores={DialogueTrigger=32,TalkTime=21}] {"text":"<...> Lad! If you can defeat all the Kimono Girls, I'll give you a gift."}
...
tellraw @s[tag=English,scores={DialogueTrigger=33,TalkTime=1}] {"text":"<...> The way you battled, it was like watching a dance."}
tellraw @s[tag=English,scores={DialogueTrigger=33,TalkTime=10}] {"text":"<...> It was a rare treat to see! I want you to have this."}
tellraw @s[tag=English,scores={DialogueTrigger=33,TalkTime=19}] {"text":"<...> Don't worry--take it!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=33,TalkTime=26}] {"text":"<...> That's Surf. It's a move that lets Pokémon swim across water."}
...
tellraw @s[tag=English,scores={DialogueTrigger=34,TalkTime=1}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> ...... ...... ......"}]
tellraw @s[tag=English,scores={DialogueTrigger=34,TalkTime=6}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> ...Oh, it's you."}]
tellraw @s[tag=English,scores={DialogueTrigger=34,TalkTime=12}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> You wanted to get stronger, so you came for the legendary Pokémon that's supposed to be here."}]
tellraw @s[tag=English,scores={DialogueTrigger=34,TalkTime=22}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> That's your story, right? Well, that's not going to happen."}]
tellraw @s[tag=English,scores={DialogueTrigger=34,TalkTime=31}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> Because I'm going to get it!"}]
tellraw @s[tag=English,scores={DialogueTrigger=34,TalkTime=39}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> I'm going to be the world's greatest trainer, so a legendary Pokémon would be perfect for me."}]
tellraw @s[tag=English,scores={DialogueTrigger=34,TalkTime=49}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> ...Well, anyway, I'm getting tired of having a wimp like you always showing up."}]
...
tellraw @s[tag=English,scores={DialogueTrigger=35,TalkTime=1}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> ...Humph! This why I hate battling wimps. There's no challenge in it."}]
tellraw @s[tag=English,scores={DialogueTrigger=35,TalkTime=12}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> ...Aw, whatever. You would never be able to catch a legendary Pokémon anyway."}]

#tp Silver out
execute as @s[scores={DialogueTrigger=35,TalkTime=23}] run tp @e[x=441,y=64,z=312,distance=..2,type=pixelmon:npc_trainer,scores={StarterPick=1}] -764 93 -242
execute as @s[scores={DialogueTrigger=35,TalkTime=23}] run tp @e[x=441,y=64,z=312,distance=..2,type=pixelmon:npc_trainer,scores={StarterPick=2}] -764 89 -242
execute as @s[scores={DialogueTrigger=35,TalkTime=23}] run tp @e[x=441,y=64,z=312,distance=..2,type=pixelmon:npc_trainer,scores={StarterPick=3}] -764 85 -242
...
tellraw @s[tag=English,scores={DialogueTrigger=36,TalkTime=22}] {"text":"You can now find Entei and Raikou anytime in the wild grass!","italic":true,"color":"gray"}
...
tellraw @s[tag=English,scores={DialogueTrigger=37,TalkTime=1}] {"text":"<Morty> Good of you to have come. Here, in Ecruteak, Pokémon have been revered."}
tellraw @s[tag=English,scores={DialogueTrigger=37,TalkTime=11}] {"text":"<Morty> It's said that a rainbow-colored Pokémon will come down to appear before a truly powerful trainer."}
tellraw @s[tag=English,scores={DialogueTrigger=37,TalkTime=24}] {"text":"<Morty> I believed that tale, so I have secretly trained here all my life."}
tellraw @s[tag=English,scores={DialogueTrigger=37,TalkTime=33}] {"text":"<Morty> As a result, I can now see what others cannot."}
tellraw @s[tag=English,scores={DialogueTrigger=37,TalkTime=40}] {"text":"<Morty> With a little more, I could see a future in which I meet the Pokémon of rainbow colors."}
tellraw @s[tag=English,scores={DialogueTrigger=37,TalkTime=50}] {"text":"<Morty> You're going to help me reach that level!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=38,TalkTime=1}] {"text":"<Morty> I'm not good enough yet... All right. This Badge is yours."}
...
tellraw @s[tag=English,scores={DialogueTrigger=38,TalkTime=17}] {"text":"<Morty> I want you to have this too."}
...
tellraw @s[tag=English,scores={DialogueTrigger=38,TalkTime=25}] {"text":"<Morty> It's Shadow Ball. It causes damage and may reduce Spcl. Def."}
tellraw @s[tag=English,scores={DialogueTrigger=38,TalkTime=33}] {"text":"<Morty> Use it if it appeals to you."}
tellraw @s[tag=English,scores={DialogueTrigger=38,TalkTime=40}] {"text":"<Morty> I see... Your journey has taken you to far-away places."}
tellraw @s[tag=English,scores={DialogueTrigger=38,TalkTime=49}] {"text":"<Morty> And you have witnessed much more than me. I envy you for that..."}
...
#execute as @s[x=809,y=63,z=14,distance=..50,tag=!Dialogue39] run /tp @e[x=-772,y=92,z=-242,dy=3,type=pixelmon:npc_chatting] 809 64 14

execute as @s[scores={DialogueTrigger=39,TalkTime=1}] run scoreboard players set @s click 1
tellraw @s[tag=English,scores={DialogueTrigger=39,TalkTime=1}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> You again? There's no need to be alert. I don't bother with wimps like you."}]
tellraw @s[tag=English,scores={DialogueTrigger=39,TalkTime=10}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> Speaking of weaklings, the city's Gym Leader isn't here, and is supposedly taking care of a sick Pokémon at the Lighthouse."}]
tellraw @s[tag=English,scores={DialogueTrigger=39,TalkTime=23}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> Humph! Boo-hoo! Just let sick Pokémon go!"}]
tellraw @s[tag=English,scores={DialogueTrigger=39,TalkTime=30}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> A Pokémon that can't battle is worthless!"}]
tellraw @s[tag=English,scores={DialogueTrigger=39,TalkTime=37}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> Why don't you go train at the Lighthouse?"}]
tellraw @s[tag=English,scores={DialogueTrigger=39,TalkTime=45}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> Who knows? It may make you a bit of a better Trainer!"}]

#tp Silver out
execute as @s[scores={DialogueTrigger=39,TalkTime=53}] run particle cloud 809 64 14 1 1 1 1 100
execute as @s[scores={DialogueTrigger=39,TalkTime=53}] run tp @e[x=809,y=63,z=14,dy=3,type=pixelmon:npc_chatting] -772 93 -242
...
execute as @s[scores={DialogueTrigger=40,TalkTime=1}] run data merge entity @e[limit=1,x=706,y=119,z=-38,distance=..2,type=pixelmon:statue] {statueTexture: 5s}
...
tellraw @s[tag=English,scores={DialogueTrigger=40,TalkTime=3}] {"text":"<Jasmine> This Pokémon always kept the sea lit at night. ...But it suddenly got sick... "}
tellraw @s[tag=English,scores={DialogueTrigger=40,TalkTime=13}] {"text":"<Jasmine> It's gasping for air..."}
tellraw @s[tag=English,scores={DialogueTrigger=40,TalkTime=20}] {"text":"<Jasmine> ...I understand that there is a wonderful Pharmacy in Cianwood..."}
tellraw @s[tag=English,scores={DialogueTrigger=40,TalkTime=29}] {"text":"<Jasmine> But that's across the sea... And I can't leave Amphy unattended..."}
tellraw @s[tag=English,scores={DialogueTrigger=40,TalkTime=39}] {"text":"<Jasmine> ...May I ask you to get some medicine for me? Please?"}
...
tellraw @s[tag=English,scores={DialogueTrigger=41,TalkTime=3}] {"text":"<Pharmacy Doctor> Your Pokémon appear to be fine. Is something worrying you? ..."}
tellraw @s[tag=English,scores={DialogueTrigger=41,TalkTime=13}] {"text":"<Pharmacy Doctor> The Lighthouse Pokémon is in trouble?"}
tellraw @s[tag=English,scores={DialogueTrigger=41,TalkTime=20}] {"text":"<Pharmacy Doctor> I got it! This ought to do the trick."}
...
tellraw @s[tag=English,scores={DialogueTrigger=41,TalkTime=27}] {"text":"<Pharmacy Doctor> My Secretpotion is a tad too strong. I only offer it in an emergency."}
...
execute as @s[scores={DialogueTrigger=42,TalkTime=1}] run tp @e[x=-714,y=79,z=-242,distance=..2,type=pixelmon:npc_chatting] 705 119 -40
execute as @s[scores={DialogueTrigger=42,TalkTime=1}] run data merge entity @e[limit=1,x=706,y=119,z=-38,distance=..2,type=pixelmon:statue] {statueTexture:5s}

tellraw @s[tag=English,scores={DialogueTrigger=42,TalkTime=3}] {"text":"<Jasmine> ...That medicine will cure Amphy?"}
tellraw @s[tag=English,scores={DialogueTrigger=42,TalkTime=10}] {"text":"<Jasmine> Um, please don't be offended... ...Amphy will not take anything from anyone but me..."}
...
#execute as @s[scores={DialogueTrigger=42,TalkTime=30}] run execute at @e[x=694,y=119,z=-48,dx=17,dy=10,dz=15,type=pixelmon:statue] run particle fallingdust ~ ~1 ~ 1 1 1 1 10 normal @a 201

tellraw @s[tag=English,scores={DialogueTrigger=42,TalkTime=23}] {"text":"<Jasmine> ... Amphy, how are you feeling?"}
...
tellraw @s[tag=English,scores={DialogueTrigger=42,TalkTime=36}] {"text":"<Jasmine> Oh, I'm so relieved... This is just so wonderful"}
tellraw @s[tag=English,scores={DialogueTrigger=42,TalkTime=44}] {"text":"<Jasmine> Thank you so very, very much."}
tellraw @s[tag=English,scores={DialogueTrigger=42,TalkTime=51}] {"text":"<Jasmine> I will return to the Gym"}

#tps Jasmine out
execute as @s[scores={DialogueTrigger=42,TalkTime=59}] run particle cloud 705 119 -40 1 1 1 1 100
execute as @s[scores={DialogueTrigger=42,TalkTime=59}] run tp @e[x=705,y=119,z=-40,distance=..2,type=pixelmon:npc_chatting] -714 79 -242
...
tellraw @s[tag=English,scores={DialogueTrigger=43,TalkTime=1}] {"text":"<Chuck's Wife> That's Cianwood's Gym Badge! Then you should take this HM."}
execute as @s[scores={DialogueTrigger=43,TalkTime=6}] run function johto:spawn/flyhm

tellraw @s[tag=English,scores={DialogueTrigger=43,TalkTime=12}] {"text":"<Chuck's Wife> You will be able to Fly instantly to anywhere you have visited."}
tellraw @s[tag=English,scores={DialogueTrigger=43,TalkTime=21}] {"text":"<Chuck's Wife> My husband lost to you, so he needs to train harder."}
tellraw @s[tag=English,scores={DialogueTrigger=43,TalkTime=29}] {"text":"<Chuck's Wife> That's good, since he was getting a little chubby."}
...
tellraw @s[tag=English,scores={DialogueTrigger=44,TalkTime=1}] {"text":"<Chuck> WAHAHAH! "}
tellraw @s[tag=English,scores={DialogueTrigger=44,TalkTime=6}] {"text":"<Chuck> So you've come this far! Let me tell you, I'm tough!"}
tellraw @s[tag=English,scores={DialogueTrigger=44,TalkTime=15}] {"text":"<Chuck> My Pokémon will crush stones and shatter bones! Watch this!"}
tellraw @s[tag=English,scores={DialogueTrigger=44,TalkTime=23}] {"text":"<Chuck> Urggh! "}
tellraw @s[tag=English,scores={DialogueTrigger=44,TalkTime=25}] {"text":"<Chuck> Oooarrgh! "}
...
tellraw @s[tag=English,scores={DialogueTrigger=44,TalkTime=40}] {"text":"<Chuck> There! Scared now, are you? "}

tellraw @s[tag=English,scores={DialogueTrigger=44,TalkTime=47}] {"text":"<Chuck> What? It has nothing to do with Pokémon?"}
tellraw @s[tag=English,scores={DialogueTrigger=44,TalkTime=54}] {"text":"<Chuck> That's true! Come on. We shall do battle!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=45,TalkTime=1}] {"text":"<Chuck> Wha? Huh? I lost? How about that!"}
tellraw @s[tag=English,scores={DialogueTrigger=45,TalkTime=9}] {"text":"<Chuck> You're worthy of the Storm Badge!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=45,TalkTime=21}] {"text":"<Chuck> Here, take this, too!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=45,TalkTime=27}] {"text":"<Chuck> That is Focus Punch."}
tellraw @s[tag=English,scores={DialogueTrigger=45,TalkTime=34}] {"text":"<Chuck> It doesn't land if the foe you're attacking hits you first, but it's very powerful if it manages to hit!"}
tellraw @s[tag=English,scores={DialogueTrigger=45,TalkTime=44}] {"text":"<Chuck> Wahahah! I enjoyed battling you! But a loss is a loss! "}
tellraw @s[tag=English,scores={DialogueTrigger=45,TalkTime=52}] {"text":"<Chuck> From now on, I'm going to train 24 hours a day!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=46,TalkTime=1}] {"text":"<Jasmine> Thank you for your help at the Lighthouse... But this is different."}
tellraw @s[tag=English,scores={DialogueTrigger=46,TalkTime=11}] {"text":"<Jasmine> Please allow me to introduce myself."}
tellraw @s[tag=English,scores={DialogueTrigger=46,TalkTime=18}] {"text":"<Jasmine> I'm Jasmine, a Gym Leader. I use the steel-type."}
tellraw @s[tag=English,scores={DialogueTrigger=46,TalkTime=26}] {"text":"<Jasmine> ...Do you know about the steel-type?"}
tellraw @s[tag=English,scores={DialogueTrigger=46,TalkTime=33}] {"text":"<Jasmine> It's a type that was only recently discovered. "}
tellraw @s[tag=English,scores={DialogueTrigger=46,TalkTime=41}] {"text":"<Jasmine> ...Um... May I begin?"}
...
tellraw @s[tag=English,scores={DialogueTrigger=47,TalkTime=1}] {"text":"<Jasmine> ...You are a better trainer than me, in both skill and kindness."}
tellraw @s[tag=English,scores={DialogueTrigger=47,TalkTime=11}] {"text":"<Jasmine> In accordance with League rules, I confer upon you this Badge."}
...
tellraw @s[tag=English,scores={DialogueTrigger=47,TalkTime=24}] {"text":"<Jasmine> ...Um, please take this too... "}
...
tellraw @s[tag=English,scores={DialogueTrigger=47,TalkTime=32}] {"text":"<Jasmine> You could use that TM to teach Iron Tail."}
...
tellraw @s[tag=English,scores={DialogueTrigger=48,TalkTime=5}] {"text":"<Rocket Grunt> Hold it there, kiddo!"}
tellraw @s[tag=English,scores={DialogueTrigger=48,TalkTime=12}] {"text":"<Rocket Grunt> The toll is $1000 to go through."}
...
tellraw @s[tag=English,scores={DialogueTrigger=48,TalkTime=23}] {"text":"<Rocket Grunt> Thank you very much!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=50,TalkTime=1}] {"text":"<Mr. Pokémon> Hm? That Scale! What's that?"}
tellraw @s[tag=English,scores={DialogueTrigger=50,TalkTime=9}] {"text":"<Mr. Pokémon> A red Gyarados? That's rare! I, I want it..."}
tellraw @s[tag=English,scores={DialogueTrigger=50,TalkTime=17}] ["",{"text":"<Mr. Pokémon> "},{"selector":"@s"},{"text":", would you care to trade it?"}]
tellraw @s[tag=English,scores={DialogueTrigger=50,TalkTime=25}] {"text":"<Mr. Pokémon> I can offer this Exp. Share I got from Professor Oak."}
tellraw @s[tag=English,scores={DialogueTrigger=50,TalkTime=25}] ["",{"text":"["},{"text":"Yes","color":"green","clickEvent":{"action":"run_command","value":"/trigger TriggerCommand set 47"}},{"text":"]"}]
...
#execute as @s[x=-159,y=64,z=590,distance=..50,tag=Dialogue49] run execute @s[tag=!Dialogue51] run tp @e[x=-807,y=92,z=-242,dy=3,type=pixelmon:npc_chatting] -159 64 590

tellraw @s[tag=English,scores={DialogueTrigger=51,TalkTime=1}] {"text":"<. . .> Did you come here because of the rumors?"}
tellraw @s[tag=English,scores={DialogueTrigger=51,TalkTime=9}] ["",{"text":"<Lance> You're "},{"selector":"@s"},{"text":"? I'm Lance, a trainer like you."}]
tellraw @s[tag=English,scores={DialogueTrigger=51,TalkTime=17}] {"text":"<Lance> I heard some rumors, so I came to investigate..."}
tellraw @s[tag=English,scores={DialogueTrigger=51,TalkTime=25}] ["",{"text":"<Lance> I saw the way you battled earlier, "},{"selector":"@s"},{"text":". I can tell that you're a trainer with considerable skill."}]
tellraw @s[tag=English,scores={DialogueTrigger=51,TalkTime=35}] ["",{"text":"<Lance> If you don't mind, could you help me investigate?\n["},{"text":"Yes","color":"green","clickEvent":{"action":"run_command","value":"/trigger TriggerCommand set 39"}},{"text":"]"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=52,TalkTime=1}] {"text":"<Lance> Excellent!"}
tellraw @s[tag=English,scores={DialogueTrigger=52,TalkTime=7}] {"text":"<Lance> It seems that the Lake's Magikarp are being forced to evolve."}
tellraw @s[tag=English,scores={DialogueTrigger=52,TalkTime=16}] {"text":"<Lance> A mysterious radio broadcast coming from Mahogany is the cause."}
tellraw @s[tag=English,scores={DialogueTrigger=52,TalkTime=24}] ["",{"text":"<Lance> I'll be waiting for you, "},{"selector":"@s"},{"text":"."}]
...
tellraw @s[tag=English,scores={DialogueTrigger=53,TalkTime=1}] {"text":"<Lance> Dragonite, Hyper Beam."}
tellraw @s[tag=English,scores={DialogueTrigger=53,TalkTime=8}] ["",{"text":"<Lance> What took you, "},{"selector":"@s"},{"text":"?"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=53,TalkTime=17}] {"text":"<Lance> Just as I thought, that strange radio signal is coming from here."}

#Lance walking over
#execute as @s[scores={DialogueTrigger=53,TalkTime=22..32}] run

tellraw @s[tag=English,scores={DialogueTrigger=53,TalkTime=28}] {"text":"<Lance> The stairs are right here."}
...
tellraw @s[tag=English,scores={DialogueTrigger=53,TalkTime=36}] ["",{"text":"<Lance> "},{"selector":"@s"},{"text":", we should split up to check this place. I'll go first."}]

#tp Lance out
execute as @s[scores={DialogueTrigger=53,TalkTime=44}] run execute at @e[x=-164,y=63,z=196,dx=19,dy=6,dz=20,name=Lance,type=pixelmon:npc_chatting] run particle cloud ~ ~ ~ 3 3 3 1 200
execute as @s[scores={DialogueTrigger=53,TalkTime=44}] run tp @e[x=-164,y=63,z=196,dx=19,dy=6,dz=20,name=Lance,type=pixelmon:npc_chatting] -805 93 -242
...
#execute as @p[x=-155,y=64,z=208,distance=..30,tag=!Dialogue53,score_TalkTime=0] run tp @e[x=-157,y=63,z=193,dy=3,type=pixelmon:npc_chatting] -159 72 196
...
#execute as @p[x=-155,y=64,z=208,distance=..30,tag=!Dialogue53,score_TalkTime=0] run tp @e[x=-155,y=71,z=196,dy=3,type=pixelmon:npc_chatting] -149 64 200
...
#execute as @p[x=-155,y=64,z=208,distance=..30,tag=Dialogue64,score_TalkTime=0] run tp @e[x=-159,y=71,z=196,dy=3,type=pixelmon:npc_chatting] -157 64 193
...
#execute as @p[x=-155,y=64,z=208,distance=..30,tag=Dialogue64,score_TalkTime=0] run tp @e[x=-149,y=63,z=200,dy=3,type=pixelmon:npc_chatting] -155 72 196
...
tellraw @s[tag=English,scores={DialogueTrigger=54,TalkTime=1}] {"text":"<Lance> Are you all right?"}
tellraw @s[tag=English,scores={DialogueTrigger=54,TalkTime=8}] {"text":"<Lance> Your Pokémon are hurt and tired. Here, give them some of my medicine."}
execute as @s[scores={DialogueTrigger=54,TalkTime=13}] run pokeheal @s
tellraw @s[tag=English,scores={DialogueTrigger=54,TalkTime=18}] ["",{"text":"<Lance> "},{"selector":"@s"},{"text":", let's give it our best for Pokémon."}]
...
#Lance tp in
#execute as @s[x=-149,y=34,z=165,distance=..25,tag=!Dialogue55,score_TalkTime=0] run /tp @e[x=-801,y=92,z=-242,dy=3,type=pixelmon:npc_chatting] -149 34 165

tellraw @s[tag=English,scores={DialogueTrigger=55,TalkTime=1}] {"text":"<Lance> It takes two passwords to get into the boss's quarters."}
tellraw @s[tag=English,scores={DialogueTrigger=55,TalkTime=10}] {"text":"<Lance> Those passwords are known only to a few Rockets."}
tellraw @s[tag=English,scores={DialogueTrigger=55,TalkTime=19}] {"text":"<Lance> That Rocket there very graciously told me so."}
tellraw @s[tag=English,scores={DialogueTrigger=55,TalkTime=28}] ["",{"text":"<Lance> "},{"selector":"@s"},{"text":", let's go get the passwords."}]
...
tellraw @s[tag=English,scores={DialogueTrigger=56,TalkTime=1}] ["",{"text":"<Rocket Grunt> The password to the boss's room is "},{"text":"Slowpoketail","italic":true},{"text":". But it's useless unless you have two passwords."}]
#tag @s add RocketPW1
...
tellraw @s[tag=English,scores={DialogueTrigger=57,TalkTime=1}] ["",{"text":"<Rocket Grunt> The password to the boss's room... Uh..., I think it is "},{"text":"Raticate Tail","italic":true},{"text":"."}]
#tag @s add RocketPW2
...
tellraw @s[tag=English,scores={DialogueTrigger=58,TalkTime=1}] ["",{"text":"<Murkrow> The password is... "},{"text":"Hail Giovanni","italic":true},{"text":"."}]
#tag @s add RocketPW3
...
#tp Silver in separately
#execute as @s[x=-82,y=34,z=182,distance=..20,tag=!Dialogue59,score_TalkTime=0] run tp @e[x=-772,y=88,z=-242,dy=3,type=pixelmon:npc_chatting] -82 34 182

execute as @s[scores={DialogueTrigger=59,TalkTime=1}] run scoreboard players set @s click 1
tellraw @s[tag=English,scores={DialogueTrigger=59,TalkTime=1}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> So you are messing with them again."}]
tellraw @s[tag=English,scores={DialogueTrigger=59,TalkTime=8}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> Humph, you must really like Team Rocket so much."}]
tellraw @s[tag=English,scores={DialogueTrigger=59,TalkTime=16}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> Tell me, who was the guy in the cape who used Dragon-type Pokémon?"}]
tellraw @s[tag=English,scores={DialogueTrigger=59,TalkTime=26}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> My Pokémon were no match at all."}]
tellraw @s[tag=English,scores={DialogueTrigger=59,TalkTime=33}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> I don't care that I lost. I can beat him by getting stronger Pokémon."}]
tellraw @s[tag=English,scores={DialogueTrigger=59,TalkTime=43}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> It's what he said that bothers me."}]
tellraw @s[tag=English,scores={DialogueTrigger=59,TalkTime=50}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> He told me that I don't love and trust my Pokémon enough."}]
tellraw @s[tag=English,scores={DialogueTrigger=59,TalkTime=59}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> I'm furious that I lost to a bleeding heart like him."}]
tellraw @s[tag=English,scores={DialogueTrigger=59,TalkTime=68}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> Humph! I don't have time for the likes of you!"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=60,TalkTime=1}] {"text":"<Rocket Executive> What? Who are you? This is the office of our leader, Giovanni."}
tellraw @s[tag=English,scores={DialogueTrigger=60,TalkTime=11}] {"text":"<Rocket Executive> Since disbanding Team Rocket three years ago, he has been in training."}
tellraw @s[tag=English,scores={DialogueTrigger=60,TalkTime=20}] {"text":"<Rocket Executive> But we're certain he will be back some day to assume command again. That's why we're standing guard."}
tellraw @s[tag=English,scores={DialogueTrigger=60,TalkTime=33}] {"text":"<Rocket Executive> I won't let anyone disturb this place!"}
...
#execute as @s[x=-99,y=34,z=205,distance=..20,score_TalkTime=0,tag=!Dialogue61] run tp @e[x=-799,y=92,z=-242,dy=3,type=pixelmon:npc_trainer] -99 34 205


execute as @s[scores={DialogueTrigger=61,TalkTime=1}] run clear @s minecraft:nether_brick

tellraw @s[tag=English,scores={DialogueTrigger=61,TalkTime=1}] {"text":"<Rocket Executive> I... I couldn't do a thing..."}
tellraw @s[tag=English,scores={DialogueTrigger=61,TalkTime=8}] {"text":"<Rocket Executive> Giovanni, please forgive me..."}
tellraw @s[tag=English,scores={DialogueTrigger=61,TalkTime=15}] {"text":"<Rocket Executive> No, I can't let this affect me. I have to inform the others..."}

#tp Executive out
execute as @s[scores={DialogueTrigger=61,TalkTime=24}] run particle cloud -99 34 205 1 1 1 1 100
execute as @s[scores={DialogueTrigger=61,TalkTime=24}] run tp @e[x=-99,y=33,z=205,dy=3,type=pixelmon:npc_trainer] -799 93 -242

tellraw @s[tag=English,scores={DialogueTrigger=61,TalkTime=28}] {"text":"Murkrow is looking at you...","italic":true}
...
#Sets up scene
#execute as @s[x=-133,y=45,z=166,distance=..30,score_TalkTime=0,tag=Dialogue58] run execute @s[tag=!Dialogue63] run tp @e[x=-797,y=92,z=-242,dy=3,type=pixelmon:npc_chatting] -128 45 159
#execute as @s[x=-133,y=45,z=166,distance=..30,score_TalkTime=0,tag=Dialogue58] run execute @s[tag=!Dialogue63] run tp @e[x=-795,y=92,z=-242,dy=3,type=pixelmon:npc_chatting] -128 45 171
#execute as @s[x=-133,y=45,z=166,distance=..30,score_TalkTime=0,tag=Dialogue58] run execute @s[tag=!Dialogue63] run tp @e[x=-793,y=92,z=-242,dy=3,type=pixelmon:npc_trainer] -134 45 170
#execute as @s[x=-133,y=45,z=166,distance=..30,score_TalkTime=0,tag=Dialogue58] run execute @s[tag=!Dialogue63] run tp @e[x=-817,y=86,z=-147,dy=2,type=pixelmon:statue] -128 45 168
#execute as @s[x=-133,y=45,z=166,distance=..30,score_TalkTime=0,tag=Dialogue58] run execute @s[tag=!Dialogue63] run tp @e[x=-817,y=86,z=-153,dy=2,type=pixelmon:statue] -128 45 164

tellraw @s[tag=English,scores={DialogueTrigger=62,TalkTime=1}] {"text":"<Lance> Hey! Don't be so selfish. Spread the fun around."}
tellraw @s[tag=English,scores={DialogueTrigger=62,TalkTime=10}] ["",{"text":"<"},{"text":"Ariana","color":"gray"},{"text":"> What? You had an accomplice? Where is your sense of honor?"}]
tellraw @s[tag=English,scores={DialogueTrigger=62,TalkTime=20}] ["",{"text":"<"},{"text":"Ariana","color":"gray"},{"text":"> As the interim boss in place of Giovanni, I'll show you how wrong it is to meddle with Team Rocket!"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=63,TalkTime=1}] {"text":"<Ariana> It's too bad. If you were to join Team Rocket, you could become an Executive."}
tellraw @s[tag=English,scores={DialogueTrigger=63,TalkTime=11}] {"text":"<Ariana> ...This hideout is done for... But that's fine."}
tellraw @s[tag=English,scores={DialogueTrigger=63,TalkTime=19}] {"text":"<Ariana> The broadcast experiment was a total success."}
tellraw @s[tag=English,scores={DialogueTrigger=63,TalkTime=26}] {"text":"<Ariana> It doesn't matter what happens to this hideout now."}
tellraw @s[tag=English,scores={DialogueTrigger=63,TalkTime=33}] {"text":"<Ariana> We have much bigger plans."}
tellraw @s[tag=English,scores={DialogueTrigger=63,TalkTime=40}] {"text":"<Ariana> You'll come to appreciate Team Rocket's true power soon enough."}
tellraw @s[tag=English,scores={DialogueTrigger=63,TalkTime=49}] {"text":"<Ariana> Enjoy yourself while you can..."}
...
execute as @s[scores={DialogueTrigger=63,TalkTime=55}] run tp @e[x=-134,y=44,z=170,dy=3,type=pixelmon:npc_trainer] -793 93 -242
...
execute as @s[scores={DialogueTrigger=63,TalkTime=55}] run tp @e[x=-128,y=44,z=171,dy=3,type=pixelmon:npc_chatting] -795 93 -242

tellraw @s[tag=English,scores={DialogueTrigger=63,TalkTime=58}] {"text":"<Lance> That did it. We defeated all the rockets here."}
tellraw @s[tag=English,scores={DialogueTrigger=63,TalkTime=66}] {"text":"<Lance> But I'm concerned about the young guy I battled in the process..."}
tellraw @s[tag=English,scores={DialogueTrigger=63,TalkTime=75}] ["",{"text":"<Lance> Sorry, "},{"selector":"@s"},{"text":". I saw how well you were doing, so I just hung back."}]
tellraw @s[tag=English,scores={DialogueTrigger=63,TalkTime=85}] {"text":"<Lance> Now all there is left to do is to turn off that odd radio signal."}
...
tellraw @s[tag=English,scores={DialogueTrigger=63,TalkTime=96}] ["",{"text":"<"},{"selector":"@s"},{"text":"> "},{"text":"Hail Giovanni","italic":true}]
...
execute as @s[scores={DialogueTrigger=63,TalkTime=103}] run tp @e[x=-815,y=79,z=-238,dy=3,type=pixelmon:npc_chatting] -118 45 181
execute as @s[scores={DialogueTrigger=63,TalkTime=103}] run tp @e[x=-118,y=44,z=173,dy=3,type=pixelmon:npc_chatting] -815 80 -240

tellraw @s[tag=English,scores={DialogueTrigger=63,TalkTime=106}] {"text":"<Lance> It's this machine that's causing all the problems. I don't see a switch on it..."}
tellraw @s[tag=English,scores={DialogueTrigger=63,TalkTime=118}] {"text":"<Lance> We have no choice. We have to make all the Electrode faint."}
tellraw @s[tag=English,scores={DialogueTrigger=63,TalkTime=127}] {"text":"<Lance> That should stop this machine from transmitting that strange signal."}
tellraw @s[tag=English,scores={DialogueTrigger=63,TalkTime=137}] ["",{"text":"<Lance> It's of no fault of the Pokémon, so it makes me feel guilty. "},{"selector":"@s"},{"text":", let's split the job."}]
...
execute as @s[scores={DialogueTrigger=63,TalkTime=147}] run tp @e[x=-815,y=79,z=-236,dy=3,type=pixelmon:npc_chatting] -144 45 182
...
execute as @s[scores={DialogueTrigger=63,TalkTime=148}] run execute at @e[x=-92,y=45,z=187,dy=3,type=minecraft:armor_stand] run data merge entity @e[limit=1,x=-92,y=45,z=186,dx=1,dy=2,dz=1,type=pixelmon:pixelmon] {NoAI:1,Motion:[0.0d,0.0d,0.0d]}
execute as @s[scores={DialogueTrigger=63,TalkTime=148}] run execute at @e[x=-92,y=45,z=187,dy=3,type=minecraft:armor_stand] run tp @e[x=-92,y=45,z=186,dx=1,dy=2,dz=1,type=pixelmon:pixelmon] ~ ~ ~ 180 ~
...
execute as @s[scores={DialogueTrigger=63,TalkTime=148}] run execute at @e[x=-92,y=45,z=195,dy=3,type=minecraft:armor_stand] run data merge entity @e[limit=1,x=-92,y=45,z=194,dx=1,dy=2,dz=1,type=pixelmon:pixelmon] {NoAI:1,Motion:[0.0d,0.0d,0.0d]}
execute as @s[scores={DialogueTrigger=63,TalkTime=148}] run execute at @e[x=-92,y=45,z=195,dy=3,type=minecraft:armor_stand] run tp @e[x=-92,y=45,z=194,dx=1,dy=2,dz=1,type=pixelmon:pixelmon] ~ ~ ~ 180 ~
...
execute as @s[scores={DialogueTrigger=63,TalkTime=148}] run execute at @e[x=-92,y=45,z=203,dy=3,type=minecraft:armor_stand] run data merge entity @e[limit=1,x=-92,y=45,z=202,dx=1,dy=2,dz=1,type=pixelmon:pixelmon] {NoAI:1,Motion:[0.0d,0.0d,0.0d]}
execute as @s[scores={DialogueTrigger=63,TalkTime=148}] run execute at @e[x=-92,y=45,z=203,dy=3,type=minecraft:armor_stand] run tp @e[x=-92,y=45,z=202,dx=1,dy=2,dz=1,type=pixelmon:pixelmon] ~ ~ ~ 180 ~
...
execute as @s[scores={DialogueTrigger=64,TalkTime=1}] run tp @e[x=-144,y=44,z=182,dy=3,type=pixelmon:npc_chatting] -815 80 -236
execute as @s[scores={DialogueTrigger=64,TalkTime=1}] run particle cloud -144 45 182 1 1 1 1 100

#tp center generator Lance in}
execute as @s[scores={DialogueTrigger=64,TalkTime=1}] run tp @e[x=-815,y=79,z=-238,dy=3,type=pixelmon:npc_chatting] -118 45 181
execute as @s[scores={DialogueTrigger=64,TalkTime=1}] run particle cloud -118 45 181 1 1 1 1 100

tellraw @s[tag=English,scores={DialogueTrigger=64,TalkTime=1}] {"text":"<Lance> That odd signal finally stopped."}
tellraw @s[tag=English,scores={DialogueTrigger=64,TalkTime=9}] {"text":"<Lance> The Lake should be back to normal. You're the hero!"}
tellraw @s[tag=English,scores={DialogueTrigger=64,TalkTime=17}] {"text":"<Lance> Let me thank you on behalf of all the Pokémon."}
tellraw @s[tag=English,scores={DialogueTrigger=64,TalkTime=25}] {"text":"<Lance> Oh, yes. You should take this. I found it here, but I don't have any need for it."}
...
tellraw @s[tag=English,scores={DialogueTrigger=64,TalkTime=36}] {"text":"<Lance> That's Whirlpool. Have it with you to get across wild water."}
tellraw @s[tag=English,scores={DialogueTrigger=64,TalkTime=45}] ["",{"text":"<Lance> "},{"selector":"@s"},{"text":"..."}]
tellraw @s[tag=English,scores={DialogueTrigger=64,TalkTime=50}] {"text":"<Lance> The journey to becoming the Pokémon Master is long and difficult."}
tellraw @s[tag=English,scores={DialogueTrigger=64,TalkTime=59}] {"text":"<Lance> Knowing that, will you keep going?"}
tellraw @s[tag=English,scores={DialogueTrigger=64,TalkTime=66}] {"text":"<Lance> ... I see. No you're right. If you would give up that easily, you would have never chased that dream in the first place."}
tellraw @s[tag=English,scores={DialogueTrigger=64,TalkTime=79}] {"text":"<Lance> I look forward to seeing you again!"}

execute as @s[scores={DialogueTrigger=64,TalkTime=86}] run particle cloud -118 45 181 1 1 1 1 100
execute as @s[scores={DialogueTrigger=64,TalkTime=86}] run tp @e[x=-118,y=45,z=181,dy=3,type=pixelmon:npc_chatting] -815 80 -238
...
#execute @a[x=349,y=63,z=-461,dx=239,dy=10,dz=194,tag=Dialogue64] run execute @s[tag=!Dialogue72] run tp @e[x=-791,y=92,z=-242,dy=3,type=pixelmon:npc_chatting] 546 64 -350
#execute @a[x=349,y=63,z=-461,dx=239,dy=10,dz=194,tag=Dialogue64] run execute @s[tag=!Dialogue72] run tp @e[x=-785,y=92,z=-242,dy=3,type=pixelmon:npc_chatting] 495 64 -392
#execute @a[x=349,y=63,z=-461,dx=239,dy=10,dz=194,tag=Dialogue64] run execute @s[tag=!Dialogue72] run tp @e[x=-787,y=92,z=-242,dy=3,type=pixelmon:npc_chatting] 425 64 -380
#execute @a[x=349,y=63,z=-461,dx=239,dy=10,dz=194,tag=Dialogue64] run execute @s[tag=!Dialogue72] run tp @e[x=-789,y=92,z=-242,dy=3,type=pixelmon:npc_chatting] 420 64 -380
#execute @a[x=349,y=63,z=-461,dx=239,dy=10,dz=194,tag=Dialogue64] run execute @s[tag=!Dialogue72] run tp @e[x=-783,y=92,z=-242,dy=3,type=pixelmon:npc_chatting] 560 64 -352

#Lone guy outside Radio Tower all story
#execute @a[x=560,y=64,z=-352,distance=..100,tag=!Dialogue72] run tp @e[x=-783,y=92,z=-242,dy=3,type=pixelmon:npc_chatting] 560 64 -352


#Tps NPCs out after Takeover
#execute @a[x=349,y=63,z=-461,dx=239,dy=10,dz=194,tag=Dialogue72] run tp @e[x=546,y=63,z=-350,dy=3,type=pixelmon:npc_chatting] -791 93 -242
#execute @a[x=349,y=63,z=-461,dx=239,dy=10,dz=194,tag=Dialogue72] run tp @e[x=495,y=63,z=-392,dy=3,type=pixelmon:npc_chatting] -785 93 -242
#execute @a[x=349,y=63,z=-461,dx=239,dy=10,dz=194,tag=Dialogue72] run tp @e[x=425,y=63,z=-380,dy=3,type=pixelmon:npc_chatting] -787 93 -242
#execute @a[x=349,y=63,z=-461,dx=239,dy=10,dz=194,tag=Dialogue72] run tp @e[x=420,y=63,z=-380,dy=3,type=pixelmon:npc_chatting] -789 93 -242
#execute @a[x=349,y=63,z=-461,dx=239,dy=10,dz=194,tag=Dialogue72] run tp @e[x=560,y=63,z=-352,dy=3,type=pixelmon:npc_chatting] -783 93 -242
...
tellraw @s[tag=English,scores={DialogueTrigger=65,TalkTime=1}] {"text":"<. . .> Y-you! You came to rescue me?"}
tellraw @s[tag=English,scores={DialogueTrigger=65,TalkTime=9}] {"text":"<. . .> Is this what you were expecting? Wrong! I'm an imposter!"}
tellraw @s[tag=English,scores={DialogueTrigger=65,TalkTime=18}] {"text":"<Rocket Executive> I pretended to be the real thing to prepare for our takeover."}
tellraw @s[tag=English,scores={DialogueTrigger=65,TalkTime=27}] {"text":"<Rocket Executive> Do you want to know where we hid the real Director?"}
tellraw @s[tag=English,scores={DialogueTrigger=65,TalkTime=36}] {"text":"<Rocket Executive> Sure, I'll tell you. But only if you can beat me!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=66,TalkTime=1}] {"text":"<Rocket Executive> OK, OK. I'll tell you where he is."}
tellraw @s[tag=English,scores={DialogueTrigger=66,TalkTime=8}] {"text":"<Rocket Executive> We stashed the real Director in the Underground Warehouse"}
tellraw @s[tag=English,scores={DialogueTrigger=66,TalkTime=17}] {"text":"<Rocket Executive> It's at the far end of the Underground. But I'll doubt you'll get that far."}
...
tellraw @s[tag=English,scores={DialogueTrigger=67,TalkTime=1}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> Hold it! What I told you before was to deceive you."}]
tellraw @s[tag=English,scores={DialogueTrigger=67,TalkTime=10}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> I thought it would let me tail you, and it would lead me to Lance."}]
tellraw @s[tag=English,scores={DialogueTrigger=67,TalkTime=20}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> Well, he never showed up."}]
tellraw @s[tag=English,scores={DialogueTrigger=67,TalkTime=27}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> ...No matter. I was planning to beat you after Lance, but since you are here, I will repay my debts!"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=68,TalkTime=1}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> ...Why... Why do I lose? I've assembled the toughest Pokémon."}]
tellraw @s[tag=English,scores={DialogueTrigger=68,TalkTime=10}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> I haven't eased up on the gas. So why do I lose?"}]
tellraw @s[tag=English,scores={DialogueTrigger=68,TalkTime=18}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> ...I don't understand. Is what that Lance guy said true? That I don't treat Pokémon properly?"}]
tellraw @s[tag=English,scores={DialogueTrigger=68,TalkTime=28}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> Love.... Trust... Are they really what I lack? Are they keeping me from winning?"}]
tellraw @s[tag=English,scores={DialogueTrigger=68,TalkTime=38}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> I... I just don't understand. But it's not going to end here. Not now. Not because of this."}]

#tp Silver out
execute as @s[scores={DialogueTrigger=68,TalkTime=48}] run particle cloud 481 47 -305 1 1 1 1 100
execute as @s[scores={DialogueTrigger=68,TalkTime=48}] run tp @e[x=481,y=47,z=-305,distance=..2,type=pixelmon:npc_trainer,scores={StarterPick=1}] -766 93 -242
execute as @s[scores={DialogueTrigger=68,TalkTime=48}] run tp @e[x=481,y=47,z=-305,distance=..2,type=pixelmon:npc_trainer,scores={StarterPick=2}] -766 89 -242
execute as @s[scores={DialogueTrigger=68,TalkTime=48}] run tp @e[x=481,y=47,z=-305,distance=..2,type=pixelmon:npc_trainer,scores={StarterPick=3}] -766 85 -242
...
#tps Director in
#execute as @p[x=426,y=37,z=-304,distance=..25,tag=!Dialogue72] run tp @e[x=-779,y=92,z=-242,dy=3,type=pixelmon:npc_chatting] 426 38 -304

#tps Director out
#execute as @p[x=426,y=37,z=-304,distance=..25,tag=Dialogue72] run tp @e[x=426,y=37,z=-304,dy=3,type=pixelmon:npc_chatting] -779 93 -242

tellraw @s[tag=English,scores={DialogueTrigger=69,TalkTime=1}] {"text":"<Director> Who? What? You came to rescue me?"}
tellraw @s[tag=English,scores={DialogueTrigger=69,TalkTime=9}] {"text":"<Director> Thank you!"}
tellraw @s[tag=English,scores={DialogueTrigger=69,TalkTime=14}] {"text":"<Director> The Radio Tower! What's happening there?"}
tellraw @s[tag=English,scores={DialogueTrigger=69,TalkTime=22}] {"text":"<Director> Taken over by Team Rocket?"}
tellraw @s[tag=English,scores={DialogueTrigger=69,TalkTime=29}] {"text":"<Director> Here. Take this Card Key."}
...
tellraw @s[tag=English,scores={DialogueTrigger=69,TalkTime=37}] {"text":"<Director> Use that to open the shutters on 3F"}
tellraw @s[tag=English,scores={DialogueTrigger=69,TalkTime=44}] {"text":"<Director> I'm beging you to help."}
tellraw @s[tag=English,scores={DialogueTrigger=69,TalkTime=50}] {"text":"<Director> There's no telling what they'll do if they control the transmitter."}
tellraw @s[tag=English,scores={DialogueTrigger=69,TalkTime=59}] {"text":"<Director> They may even be able to control Pokémon using a special signal!"}
tellraw @s[tag=English,scores={DialogueTrigger=69,TalkTime=68}] {"text":"<Director> You're the only one I can call on."}
tellraw @s[tag=English,scores={DialogueTrigger=69,TalkTime=75}] {"text":"<Director> Please save the Radio Tower... And all the Pokémon nationwide!"}
#tag @s add CardKey
...
tellraw @s[tag=English,scores={DialogueTrigger=70,TalkTime=1}] ["",{"text":"<Ariana> "},{"selector":"@s"},{"text":", isn't it?"}]
tellraw @s[tag=English,scores={DialogueTrigger=70,TalkTime=8}] {"text":"<Ariana> A brat like you won't appreciate the magnificence of Team Rocket."}
tellraw @s[tag=English,scores={DialogueTrigger=70,TalkTime=17}] {"text":"<Ariana> That's too bad. I really admire your power."}
...
tellraw @s[tag=English,scores={DialogueTrigger=71,TalkTime=1}] {"text":"<Archer> Oh, you managed to get this far?"}
tellraw @s[tag=English,scores={DialogueTrigger=71,TalkTime=8}] {"text":"<Archer> You must be quite the trainer."}
tellraw @s[tag=English,scores={DialogueTrigger=71,TalkTime=15}] {"text":"<Archer> We intend to take over this Radio Station and announce our comeback."}
tellraw @s[tag=English,scores={DialogueTrigger=71,TalkTime=24}] {"text":"<Archer> That should bring our boss Giovanni back from his solo training."}
tellraw @s[tag=English,scores={DialogueTrigger=71,TalkTime=32}] {"text":"<Archer> We are going to regain our former glory."}
tellraw @s[tag=English,scores={DialogueTrigger=71,TalkTime=40}] {"text":"<Archer> I won't allow you to interfere with our plans."}
...
tellraw @s[tag=English,scores={DialogueTrigger=72,TalkTime=1}] {"text":"<Archer> How could this be?"}
tellraw @s[tag=English,scores={DialogueTrigger=72,TalkTime=8}] {"text":"<Archer> Our dreams have come to naught. I wasn't up to the task after all."}
tellraw @s[tag=English,scores={DialogueTrigger=72,TalkTime=18}] {"text":"<Archer> Like Giovanni did before me, I will disband Team Rocket here today. Farewell."}
...
tellraw @s[tag=English,scores={DialogueTrigger=72,TalkTime=35}] ["",{"text":"<Director> "},{"selector":"@s"},{"text":", thank you!"}]
tellraw @s[tag=English,scores={DialogueTrigger=72,TalkTime=41}] {"text":"<Director> Your courageous actions have saved Pokémon nationwide."}
tellraw @s[tag=English,scores={DialogueTrigger=72,TalkTime=49}] {"text":"<Director> I know it's not much, but please take this."}
...
tellraw @s[tag=English,scores={DialogueTrigger=72,TalkTime=57}] {"text":"<Director> There used to be a tower right here in Goldenrod City."}
tellraw @s[tag=English,scores={DialogueTrigger=72,TalkTime=65}] {"text":"<Director> But it was old and creaky. So we replaced it with our Radio Tower."}
tellraw @s[tag=English,scores={DialogueTrigger=72,TalkTime=74}] {"text":"<Director> We dug up that feather during construction."}
tellraw @s[tag=English,scores={DialogueTrigger=72,TalkTime=81}] {"text":"<Director> I heard that all sorts of Pokémon lived in Goldenrod in the past."}
tellraw @s[tag=English,scores={DialogueTrigger=72,TalkTime=90}] {"text":"<Director> Perhaps... That feather has some connection to the Tin Tower in Ecruteak City..."}
tellraw @s[tag=English,scores={DialogueTrigger=72,TalkTime=100}] {"text":"<Director> OK, I better go to my Office."}

#tp Director out
execute as @s[scores={DialogueTrigger=72,TalkTime=107}] run particle cloud 503 55 -271 1 1 1 1 100
execute as @s[scores={DialogueTrigger=72,TalkTime=107}] run tp @e[x=503,y=54,z=-271,dy=3,type=pixelmon:npc_chatting] -781 93 -242
...
tellraw @s[tag=English,scores={DialogueTrigger=73,TalkTime=1}] {"text":"<Pryce> Pokémon have many experiences in their lives, just like we do. "}
tellraw @s[tag=English,scores={DialogueTrigger=73,TalkTime=11}] {"text":"<Pryce> I, too, have seen and suffered much in my life."}
tellraw @s[tag=English,scores={DialogueTrigger=73,TalkTime=19}] {"text":"<Pryce> Since I am your elder, let me show you what I mean."}
tellraw @s[tag=English,scores={DialogueTrigger=73,TalkTime=27}] {"text":"<Pryce> I have been training Pokémon since before you were born. I do not lose easily."}
tellraw @s[tag=English,scores={DialogueTrigger=73,TalkTime=37}] {"text":"<Pryce> I, Pryce - the Winter Trainer - shall demonstrate my power!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=74,TalkTime=1}] {"text":"<Pryce> I am impressed by your prowess."}
tellraw @s[tag=English,scores={DialogueTrigger=74,TalkTime=8}] {"text":"<Pryce> With your strong will, I know you will overcome all life's obstacles."}
tellraw @s[tag=English,scores={DialogueTrigger=74,TalkTime=18}] {"text":"<Pryce> You are worthy of this Badge!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=74,TalkTime=31}] {"text":"<Pryce> And this... This is a gift from me! "}
...
tellraw @s[tag=English,scores={DialogueTrigger=74,TalkTime=38}] {"text":"<Pryce> That TM contains Hail."}
tellraw @s[tag=English,scores={DialogueTrigger=74,TalkTime=45}] {"text":"<Pryce> It summons a hailstorm that lasts for five turns."}
tellraw @s[tag=English,scores={DialogueTrigger=74,TalkTime=53}] {"text":"<Pryce> The hailstorm damages all types except Ice."}
tellraw @s[tag=English,scores={DialogueTrigger=74,TalkTime=60}] {"text":"<Pryce> When the ice and snow melt, spring arrives. "}
tellraw @s[tag=English,scores={DialogueTrigger=74,TalkTime=68}] {"text":"<Pryce> You and your Pokémon will be together for many years to come. Cherish your time together!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=75,TalkTime=1}] {"text":"<Radio Worker> Thank you! You're my hero! This is a token of my appreciation."}
...
tellraw @s[tag=English,scores={DialogueTrigger=76,TalkTime=1}] {"text":"<Officer Jenny> I got chased from my post by these thugs in black."}
tellraw @s[tag=English,scores={DialogueTrigger=76,TalkTime=10}] {"text":"<Officer Jenny> They left this behind. It makes me uncomfortable."}
tellraw @s[tag=English,scores={DialogueTrigger=76,TalkTime=19}] {"text":"<Officer Jenny> Could you take it away?"}
...
tellraw @s[tag=English,scores={DialogueTrigger=77,TalkTime=1}] {"text":"<Clair> I am Clair. The world's best dragon master."}
tellraw @s[tag=English,scores={DialogueTrigger=77,TalkTime=9}] {"text":"<Clair> I can hold my own against even the Pokémon League's Elite Four. Do you still want to take me on?"}
tellraw @s[tag=English,scores={DialogueTrigger=77,TalkTime=20}] {"text":"<Clair> ...Fine. Let's do it! As a trainer, I will use my full power against any opponent!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=78,TalkTime=1}] {"text":"<Clair> I won't admit this."}
tellraw @s[tag=English,scores={DialogueTrigger=78,TalkTime=8}] {"text":"<Clair> I may have lost, but you're still not ready for the Pokémon League."}
tellraw @s[tag=English,scores={DialogueTrigger=78,TalkTime=16}] {"text":"<Clair> I know. You should take the dragon user challenge."}
tellraw @s[tag=English,scores={DialogueTrigger=78,TalkTime=24}] {"text":"<Clair> Behind this Gym is a place called Dragon's Den."}
tellraw @s[tag=English,scores={DialogueTrigger=78,TalkTime=32}] {"text":"<Clair> Go and bring me the Dragon Fang from deep inside the Den."}
tellraw @s[tag=English,scores={DialogueTrigger=78,TalkTime=41}] {"text":"<Clair> That is the test to be accepted as a true dragon user."}
tellraw @s[tag=English,scores={DialogueTrigger=78,TalkTime=50}] {"text":"<Clair> If you can do that, I will accept you as a worthy trainer."}
tellraw @s[tag=English,scores={DialogueTrigger=78,TalkTime=58}] {"text":"<Clair> Until then, I won't give you a Badge."}
...
execute as @s[scores={DialogueTrigger=79,TalkTime=1}] run tp @e[x=-703,y=78,z=-242,dy=3,type=pixelmon:npc_chatting] -688 74 540

tellraw @s[tag=English,scores={DialogueTrigger=79,TalkTime=4}] {"text":"<Clair> All right. I recognize your true power. This Badge is yours."}
...
tellraw @s[tag=English,scores={DialogueTrigger=79,TalkTime=20}] {"text":"<Clair> I also want you to have this TM."}
...
tellraw @s[tag=English,scores={DialogueTrigger=79,TalkTime=27}] {"text":"<Clair> That contains Dragon Pulse."}
tellraw @s[tag=English,scores={DialogueTrigger=79,TalkTime=34}] {"text":"<Clair> If you don't want it, you don't have to take it."}
tellraw @s[tag=English,scores={DialogueTrigger=79,TalkTime=42}] {"text":"<Clair> So, you've collected all the Badges."}
tellraw @s[tag=English,scores={DialogueTrigger=79,TalkTime=50}] {"text":"<Clair> Your destination is the Pokémon League in Indigo Plateau. "}
tellraw @s[tag=English,scores={DialogueTrigger=79,TalkTime=58}] {"text":"<Clair> Do you know how to get there?"}
tellraw @s[tag=English,scores={DialogueTrigger=79,TalkTime=65}] {"text":"<Clair> From here, go to New Bark Town. Then surf east."}
tellraw @s[tag=English,scores={DialogueTrigger=79,TalkTime=73}] {"text":"<Clair> The route there is very tough."}
tellraw @s[tag=English,scores={DialogueTrigger=79,TalkTime=80}] {"text":"<Clair> Don't you dare lose at the Pokémon League!"}
tellraw @s[tag=English,scores={DialogueTrigger=79,TalkTime=87}] {"text":"<Clair> If you do, I'll feel even worse about having lost to you!"}

#tp Clair out}
execute as @s[scores={DialogueTrigger=79,TalkTime=96}] run tp @e[x=-688,y=73,z=540,dy=3,type=pixelmon:npc_chatting] -703 80 -242
...
tellraw @s[tag=English,scores={DialogueTrigger=80,TalkTime=4}] ["",{"text":"<Professor Elm> Hello, "},{"selector":"@s"},{"text":"?"}]
tellraw @s[tag=English,scores={DialogueTrigger=80,TalkTime=10}] {"text":"<Professor Elm> I have something here for you. Could you swing by my Lab?"}
tellraw @s[tag=English,scores={DialogueTrigger=80,TalkTime=20}] {"text":"<Professor Elm> See you later!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=81,TalkTime=1}] ["",{"text":"<Professor Elm> Hi, "},{"selector":"@s"},{"text":"!"}]
tellraw @s[tag=English,scores={DialogueTrigger=81,TalkTime=7}] {"text":"<Professor Elm> Thanks to you, my research is going great!"}
tellraw @s[tag=English,scores={DialogueTrigger=81,TalkTime=15}] {"text":"<Professor Elm> Take this as a token of my appreciation."}
...
tellraw @s[tag=English,scores={DialogueTrigger=81,TalkTime=23}] {"text":"<Professor Elm> The Master Ball is the best! It's the ultimate Ball!"}
tellraw @s[tag=English,scores={DialogueTrigger=81,TalkTime=31}] {"text":"<Professor Elm> It'll catch any Pokémon without fail."}
tellraw @s[tag=English,scores={DialogueTrigger=81,TalkTime=38}] {"text":"<Professor Elm> It's given only to recognized Pokémon researchers."}
tellraw @s[tag=English,scores={DialogueTrigger=81,TalkTime=46}] ["",{"text":"<Professor Elm> I think you can make better use of it than I can, "},{"selector":"@s"},{"text":"!"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=82,TalkTime=4}] ["",{"text":"<Professor Elm> Hello, "},{"selector":"@s"},{"text":"? We discovered something about the Egg!"}]
tellraw @s[tag=English,scores={DialogueTrigger=82,TalkTime=13}] {"text":"<Professor Elm> My assistant is at the Pokémon Center in Violet City. Could you talk to him?"}
...
tellraw @s[tag=English,scores={DialogueTrigger=83,TalkTime=1}] {"text":"<Hiker> Hey! Do you know what you just did?"}
tellraw @s[tag=English,scores={DialogueTrigger=83,TalkTime=9}] {"text":"<Hiker> You've taken your first step into Kanto."}
tellraw @s[tag=English,scores={DialogueTrigger=83,TalkTime=16}] {"text":"<Hiker> Check your Town Map and see."}
...
tellraw @s[tag=English,scores={DialogueTrigger=84,TalkTime=1}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> Hold it. ...Are you going to take the Pokémon League challenge?"}]
tellraw @s[tag=English,scores={DialogueTrigger=84,TalkTime=10}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> ...Don't make me laugh. You're so much weaker than I am."}]
tellraw @s[tag=English,scores={DialogueTrigger=84,TalkTime=19}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> I'm not like I was before."}]
tellraw @s[tag=English,scores={DialogueTrigger=84,TalkTime=26}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> I now have the best and strongest Pokémon with me."}]
tellraw @s[tag=English,scores={DialogueTrigger=84,TalkTime=35}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> I'm invincible! "},{"selector":"@s"},{"text":"! I challenge you!"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=85,TalkTime=1}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> ...I couldn't win..."}]
tellraw @s[tag=English,scores={DialogueTrigger=85,TalkTime=8}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> I gave it everything I had..."}]
tellraw @s[tag=English,scores={DialogueTrigger=85,TalkTime=16}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> What you possess, and what I lack..."}]
tellraw @s[tag=English,scores={DialogueTrigger=85,TalkTime=25}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> I'm beginning to understand what that dragon master said to me..."}]
tellraw @s[tag=English,scores={DialogueTrigger=85,TalkTime=35}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> ...I haven't given up on becoming the greatest trainer..."}]
tellraw @s[tag=English,scores={DialogueTrigger=85,TalkTime=44}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> I'm going to find out why I can't win and become stronger..."}]
tellraw @s[tag=English,scores={DialogueTrigger=85,TalkTime=53}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> When I do, I will challenge you. And I'll beat you down with all my power."}]
tellraw @s[tag=English,scores={DialogueTrigger=85,TalkTime=63}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> ...Humph! You keep at it until then."}]

#tp Silver out
execute as @s[scores={DialogueTrigger=85,TalkTime=70}] run particle cloud -1449 51 528 1 1 1 1 100
execute as @s[scores={DialogueTrigger=85,TalkTime=70}] run tp @e[x=-1449,y=51,z=528,distance=..2,type=pixelmon:npc_trainer,scores={StarterPick=1}] -768 93 -242
execute as @s[scores={DialogueTrigger=85,TalkTime=70}] run tp @e[x=-1449,y=51,z=528,distance=..2,type=pixelmon:npc_trainer,scores={StarterPick=2}] -768 89 -242
execute as @s[scores={DialogueTrigger=85,TalkTime=70}] run tp @e[x=-1449,y=51,z=528,distance=..2,type=pixelmon:npc_trainer,scores={StarterPick=3}] -768 85 -242
...
tellraw @s[tag=English,scores={DialogueTrigger=86,TalkTime=1}] {"text":"<Will> Welcome to Pokémon League! Allow me to introduce myself."}
tellraw @s[tag=English,scores={DialogueTrigger=86,TalkTime=11}] {"text":"<Will> I am Will. I have trained all around the world, making my psychic Pokémon powerful."}
tellraw @s[tag=English,scores={DialogueTrigger=86,TalkTime=23}] {"text":"<Will> And, at last, I've been accepted into the Elite Four. I can only keep getting better! "}
tellraw @s[tag=English,scores={DialogueTrigger=86,TalkTime=35}] {"text":"<Will> Losing is not an option!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=87,TalkTime=1}] {"text":"<Will> Even though I was defeated, I won't change my course."}
tellraw @s[tag=English,scores={DialogueTrigger=87,TalkTime=10}] {"text":"<Will> I will continue battling until I stand above all Trainers!"}
tellraw @s[tag=English,scores={DialogueTrigger=87,TalkTime=20}] {"text":"<Will> Now, move on and experience the true ferocity of the Elite Four."}
...
tellraw @s[tag=English,scores={DialogueTrigger=88,TalkTime=1}] {"text":"<Koga> Fwahahahaha! I am Koga of the Elite Four. I live in shadows--a ninja!"}
tellraw @s[tag=English,scores={DialogueTrigger=88,TalkTime=12}] {"text":"<Koga> My intricate style will confound and destroy you!"}
tellraw @s[tag=English,scores={DialogueTrigger=88,TalkTime=20}] {"text":"<Koga> Confusion, sleep, poison..."}
tellraw @s[tag=English,scores={DialogueTrigger=88,TalkTime=27}] {"text":"<Koga> Prepare to be the victim of my sinister techniques! Fwahahahaha!"}
tellraw @s[tag=English,scores={DialogueTrigger=88,TalkTime=37}]  {"text":"<Koga> Pokémon are not merely about brute force--you shall see soon enough!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=89,TalkTime=1}] {"text":"<Koga> I subjected you to everything I could muster. But my efforts failed."}
tellraw @s[tag=English,scores={DialogueTrigger=89,TalkTime=13}] {"text":"<Koga> I must hone my skills. Go on to the next room, and put your abilities to the test!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=90,TalkTime=1}] {"text":"<Bruno> I am Bruno of the Elite Four."}
tellraw @s[tag=English,scores={DialogueTrigger=90,TalkTime=8}] {"text":"<Bruno> I always train to the extreme because I believe in our potential."}
tellraw @s[tag=English,scores={DialogueTrigger=90,TalkTime=17}] {"text":"<Bruno> That is how we became strong. Can you withstand our power?"}
tellraw @s[tag=English,scores={DialogueTrigger=90,TalkTime=26}] {"text":"<Bruno> Hm? I see no fear in you. You look determined. Perfect for battle! "}
tellraw @s[tag=English,scores={DialogueTrigger=90,TalkTime=36}] {"text":"<Bruno> Ready? You will bow down to our overwhelming power! Hoo hah!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=91,TalkTime=1}] {"text":"<Bruno> Having lost, I have no right to say anything… "}
tellraw @s[tag=English,scores={DialogueTrigger=91,TalkTime=10}] {"text":"<Bruno> Go face your next challenge!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=92,TalkTime=1}] {"text":"<Karen> I am Karen of the Elite Four. I love Dark-type Pokémon."}
tellraw @s[tag=English,scores={DialogueTrigger=92,TalkTime=12}] {"text":"<Karen> I'm known for my overpowering tactics. Think you can take them?"}
tellraw @s[tag=English,scores={DialogueTrigger=92,TalkTime=23}] {"text":"<Karen> Just try to entertain me. Let's go."}
...
tellraw @s[tag=English,scores={DialogueTrigger=93,TalkTime=1}] {"text":"<Karen> Strong Pokémon. Weak Pokémon. That is only the selfish perception of people."}
tellraw @s[tag=English,scores={DialogueTrigger=93,TalkTime=13}] {"text":"<Karen> Truly skilled Trainers should try to win with the Pokémon they love best."}
tellraw @s[tag=English,scores={DialogueTrigger=93,TalkTime=25}] {"text":"<Karen> I like your style. You understand what's important."}
tellraw @s[tag=English,scores={DialogueTrigger=93,TalkTime=33}] {"text":"<Karen> Go on -- the Champion is waiting."}
...
tellraw @s[tag=English,scores={DialogueTrigger=94,TalkTime=1}] {"text":"<Lance> I’ve been waiting for you."}
tellraw @s[tag=English,scores={DialogueTrigger=94,TalkTime=8}] {"text":"<Lance> I knew that you, with your skills, would eventually reach me here."}
tellraw @s[tag=English,scores={DialogueTrigger=94,TalkTime=18}] {"text":"<Lance> There’s no need for words now."}
tellraw @s[tag=English,scores={DialogueTrigger=94,TalkTime=25}] {"text":"<Lance> We will battle to determine who is the stronger of the two of us."}
tellraw @s[tag=English,scores={DialogueTrigger=94,TalkTime=35}] {"text":"<Lance> As the most powerful Trainer and as the Pokémon League Champion…"}
tellraw @s[tag=English,scores={DialogueTrigger=94,TalkTime=45}] {"text":"<Lance> I, Lance the dragon master, accept your challenge!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=95,TalkTime=1}] {"text":"<Lance> …Whew. You have become truly powerful."}
tellraw @s[tag=English,scores={DialogueTrigger=95,TalkTime=10}] {"text":"<Lance> Your Pokémon have responded to your strong and upstanding nature."}
tellraw @s[tag=English,scores={DialogueTrigger=95,TalkTime=20}] {"text":"<Lance> As a Trainer, you will continue to grow strong with your Pokémon."}
tellraw @s[tag=English,scores={DialogueTrigger=95,TalkTime=30}] {"text":"<Lance> You have earned it. Walk through the door behind me to the Hall of Fame."}
...
tellraw @s[tag=English,scores={DialogueTrigger=96,TalkTime=1}] {"text":"<Lance> This is where we honor the League Champions for all eternity."}
tellraw @s[tag=English,scores={DialogueTrigger=96,TalkTime=10}] {"text":"<Lance> Their courageous Pokémon are also inducted."}
tellraw @s[tag=English,scores={DialogueTrigger=96,TalkTime=18}] {"text":"<Lance> Do you want to register you and your partners in the Hall of Fame?"}
tellraw @s[tag=English,scores={DialogueTrigger=96,TalkTime=18}] ["",{"text":"["},{"text":"Yes","color":"green","clickEvent":{"action":"run_command","value":"/trigger TriggerCommand set 43"}},{"text":"] \u0020 \u0020 ["},{"text":"No","color":"red","clickEvent":{"action":"run_command","value":"/trigger TriggerCommand set 44"}},{"text":"]"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=97,TalkTime=1}] {"text":"<Lance> Excellent! To generate a statue of your Pokémon, simply throw them out of their Poke Ball!"}
tellraw @s[tag=English,scores={DialogueTrigger=97,TalkTime=12}] {"text":"<Lance> If your team is less than six, press the button near the healer when you are done!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=98,TalkTime=5}] {"text":"Congratulations, you have completed the Indigo League!"}
tellraw @s[tag=English,scores={DialogueTrigger=98,TalkTime=15}] {"text":"You can now access the Kanto region!"}
tellraw @s[tag=English,scores={DialogueTrigger=98,TalkTime=23}] {"text":"Map Creator: Jond."}
tellraw @s[tag=English,scores={DialogueTrigger=98,TalkTime=28}] {"text":"Builders: Jond, MystcraftMC, PixelmonChampion, 123abc, Giggs_, gmng24, Mackwiggs."}
tellraw @s[tag=English,scores={DialogueTrigger=98,TalkTime=38}] {"text":"Map is based off of: Pokémon Crystal, Heartgold, Soulsilver and a splash of Let's Go."}
tellraw @s[tag=English,scores={DialogueTrigger=98,TalkTime=48}] ["",{"text":"Check out my other projects if you enjoyed!\nPixelmon Kalos: "},{"text":"curseforge.com/minecraft/worlds/pixelmon-kalos","color":"aqua","clickEvent":{"action":"run_command","value":"https://www.curseforge.com/minecraft/worlds/pixelmon-kalos"}}]
...
tellraw @s[tag=English,scores={DialogueTrigger=98,TalkTime=66},tag=Dialogue97] ["",{"text":"Your Party has been inducted into the Hall of Fame! Take a look at them at the Indigo Plateau!","color":"gray","italic":true}]
...
tellraw @s[tag=English,scores={DialogueTrigger=100,TalkTime=4}] ["",{"text":"<Professor Elm> Hello, "},{"selector":"@s"},{"text":"? I have something here for you."}]
tellraw @s[tag=English,scores={DialogueTrigger=100,TalkTime=13}] {"text":"<Professor Elm> Could you swing by my Lab? See you later!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=101,TalkTime=1}] ["",{"text":"<Professor Elm> "},{"selector":"@s"},{"text":"! There you are!"}]
tellraw @s[tag=English,scores={DialogueTrigger=101,TalkTime=8}] {"text":"<Professor Elm> I called because I have something for you."}
...
tellraw @s[tag=English,scores={DialogueTrigger=101,TalkTime=16}] {"text":"<Professor Elm> See? It's an S.S. Ticket. Now you can catch Pokémon in Kanto."}
tellraw @s[tag=English,scores={DialogueTrigger=101,TalkTime=26}] ["",{"text":"<Professor Elm> The ship departs from Olivine City. But you knew that already, "},{"selector":"@s"},{"text":"."}]
tellraw @s[tag=English,scores={DialogueTrigger=101,TalkTime=37}] {"text":"<Professor Elm> After all, you've traveled all over with your Pokémon."}
tellraw @s[tag=English,scores={DialogueTrigger=101,TalkTime=47}] {"text":"<Professor Elm> Give my regards to Professor Oak in Kanto!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=102,TalkTime=1}] ["",{"text":"<Mr. Pokémon> Hi, "},{"selector":"@s"},{"text":"! I have something I want you to have and was just about to send an email to Professor Oak."}]
tellraw @s[tag=English,scores={DialogueTrigger=102,TalkTime=13}] {"text":"<Mr. Pokémon> The thing is..."}
tellraw @s[tag=English,scores={DialogueTrigger=102,TalkTime=18}] {"text":"<Mr. Pokémon> A friend of mine from Hoenn came over to give this to me."}
...
tellraw @s[tag=English,scores={DialogueTrigger=102,TalkTime=26}] {"text":"<Mr. Pokémon> That Orb has something to do with the ancient ruins located past Cianwood City, called the Embedded Tower."}
tellraw @s[tag=English,scores={DialogueTrigger=102,TalkTime=37}] {"text":"<Mr. Pokémon> But only a handful of Trainers can reach there... That's where you come in."}
tellraw @s[tag=English,scores={DialogueTrigger=102,TalkTime=47}] {"text":"<Mr. Pokémon> Professor Oak thinks highly of you, and you are the proud Champion after all."}
tellraw @s[tag=English,scores={DialogueTrigger=102,TalkTime=57}] {"text":"<Mr. Pokémon> I'm sure you can solve the mystery of the Orb and the secret of the ruins."}
...
tellraw @s[tag=English,scores={DialogueTrigger=103,TalkTime=1}] {"text":"Your Silver Wing grew brighter!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=104,TalkTime=1}] {"text":"Your Rainbow Wing grew brighter!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=106,TalkTime=1}] ["",{"text":"<Nurse Joy> "},{"selector":"@s"},{"text":", isn't it?"}]
tellraw @s[tag=English,scores={DialogueTrigger=106,TalkTime=8}] {"text":"<Nurse Joy> Congratulations!"}
tellraw @s[tag=English,scores={DialogueTrigger=106,TalkTime=13}] {"text":"<Nurse Joy> As a special deal, a GS Ball has been sent just for you!"}
tellraw @s[tag=English,scores={DialogueTrigger=106,TalkTime=21}] {"text":"<Nurse Joy> Please accept it!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=106,TalkTime=29}] {"text":"<Nurse Joy> Please do come again!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=107,TalkTime=1}] {"text":"<Kurt> Wh-what is that? I've never seen one before."}
tellraw @s[tag=English,scores={DialogueTrigger=107,TalkTime=10}] {"text":"<Kurt> It looks a lot like a Poke Ball, but it appears to be something else."}
tellraw @s[tag=English,scores={DialogueTrigger=107,TalkTime=21}] {"text":"<Kurt> Let me check it for you. "}
...
tellraw @s[tag=English,scores={DialogueTrigger=108,TalkTime=1}] ["",{"text":"<Kurt> "},{"selector":"@s"},{"text":"!"}]
tellraw @s[tag=English,scores={DialogueTrigger=108,TalkTime=6}] {"text":"<Kurt> This Ball started to shake while I was checking it."}
tellraw @s[tag=English,scores={DialogueTrigger=108,TalkTime=13}] {"text":"<Kurt> There must be something to this! "}
tellraw @s[tag=English,scores={DialogueTrigger=108,TalkTime=20}] {"text":"<Kurt> ...???"}
tellraw @s[tag=English,scores={DialogueTrigger=108,TalkTime=27}] {"text":"<Kurt> Ilex Forest is restless!"}
tellraw @s[tag=English,scores={DialogueTrigger=108,TalkTime=34}] {"text":"<Kurt> What is going on? ..."}
tellraw @s[tag=English,scores={DialogueTrigger=108,TalkTime=42}] ["",{"text":"<Kurt> "},{"selector":"@s"},{"text":", here's your GS Ball back!"}]
tellraw @s[tag=English,scores={DialogueTrigger=108,TalkTime=50}] {"text":"<Kurt> Could you go see why Ilex Forest is so restless? "}
...
tellraw @s[tag=English,scores={DialogueTrigger=109,TalkTime=1}] {"text":"Ilex Forest Shrine.","italic":true}
tellraw @s[tag=English,scores={DialogueTrigger=109,TalkTime=8}] {"text":"It's in honor of the forest's protector.","italic":true}
tellraw @s[tag=English,scores={DialogueTrigger=109,TalkTime=16}] {"text":"Oh? What is this? It's a hole.","italic":true}
tellraw @s[tag=English,scores={DialogueTrigger=109,TalkTime=24}] {"text":"It looks like the GS Ball would fit inside it.","italic":true}
...
tellraw @s[tag=English,scores={DialogueTrigger=111,TalkTime=1}] {"text":"<Brock> Wow, it's not often that we get a challenger from Johto. I'm Brock, the Pewter Gym Leader."}
tellraw @s[tag=English,scores={DialogueTrigger=111,TalkTime=13}] {"text":"<Brock> I'm an expert on Rock-type Pokémon. My Pokémon are impervious to most physical attacks."}
tellraw @s[tag=English,scores={DialogueTrigger=111,TalkTime=26}] {"text":"<Brock> You'll have a hard time inflicting any damage. Come on!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=112,TalkTime=1}] {"text":"<Brock> Your Pokémon's powerful attacks overcame my rock-hard defense..."}
tellraw @s[tag=English,scores={DialogueTrigger=112,TalkTime=11}] {"text":"<Brock> You're stronger than I expected... "}
tellraw @s[tag=English,scores={DialogueTrigger=112,TalkTime=19}] {"text":"<Brock> Go ahead--take this Badge."}
...
tellraw @s[tag=English,scores={DialogueTrigger=112,TalkTime=29}] {"text":"<Brock> I enjoyed battling you, even though I am a bit upset."}
tellraw @s[tag=English,scores={DialogueTrigger=112,TalkTime=38}] {"text":"<Brock> That BoulderBadge will make your Pokémon even more powerful."}
tellraw @s[tag=English,scores={DialogueTrigger=112,TalkTime=47}] {"text":"<Brock> The world is huge. There are still many strong trainers like you."}
tellraw @s[tag=English,scores={DialogueTrigger=112,TalkTime=56}] {"text":"<Brock> Just wait and see. I'm going to become a lot stronger too."}
...
#execute as @s[x=-3060,y=64,z=956,distance=..50,tag=!Dialogue113] run execute @s[tag=Dialogue221] run tp @e[x=-815,y=84,z=-240,dy=3,type=pixelmon:npc_chatting] -3060 64 956

tellraw @s[tag=English,scores={DialogueTrigger=113,TalkTime=1}] {"text":"<Misty> Aww! Why did you have to show up and bug us now?"}
tellraw @s[tag=English,scores={DialogueTrigger=113,TalkTime=8}] {"text":"<Misty> Do you know what they call people like you?"}
tellraw @s[tag=English,scores={DialogueTrigger=113,TalkTime=15}] {"text":"<Misty> Pests! You heard me right, pest! ..."}
tellraw @s[tag=English,scores={DialogueTrigger=113,TalkTime=23}] {"text":"<Misty> ...Oh! Those Badges you have... Are they Johto Gym Badges?"}
tellraw @s[tag=English,scores={DialogueTrigger=113,TalkTime=31}] {"text":"<Misty> If you have eight, you must be good."}
tellraw @s[tag=English,scores={DialogueTrigger=113,TalkTime=38}] {"text":"<Misty> OK, then. Come to Cerulean Gym."}
tellraw @s[tag=English,scores={DialogueTrigger=113,TalkTime=45}] {"text":"<Misty> I'll be happy to take you on."}
tellraw @s[tag=English,scores={DialogueTrigger=113,TalkTime=52}] {"text":"<Misty> I'm Misty, the Gym Leader in Cerulean. I will meet you there."}
...
tellraw @s[tag=English,scores={DialogueTrigger=114,TalkTime=1}] {"text":"<Misty> I was expecting you, you pest!"}
tellraw @s[tag=English,scores={DialogueTrigger=114,TalkTime=8}] {"text":"<Misty> You may have a lot of Johto Gym Badges, but you'd better not take me too lightly."}
tellraw @s[tag=English,scores={DialogueTrigger=114,TalkTime=20}] {"text":"<Misty> My Water-type Pokémon are tough!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=115,TalkTime=1}] {"text":"<Misty> You really are good... I'll admit that you are skilled... "}
tellraw @s[tag=English,scores={DialogueTrigger=115,TalkTime=12}] {"text":"<Misty> Here you go. It's the Cascade Badge."}
...
tellraw @s[tag=English,scores={DialogueTrigger=115,TalkTime=25}] {"text":"<Misty> Here is another memento from this battle. Take it!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=115,TalkTime=33}] {"text":"<Misty> It contains the move Water Pulse. It can sometimes confuse your foe."}
tellraw @s[tag=English,scores={DialogueTrigger=115,TalkTime=43}] {"text":"<Misty> You've managed to defeat Trainers all the way from Johto."}
tellraw @s[tag=English,scores={DialogueTrigger=115,TalkTime=51}] {"text":"<Misty> I'm sure you have a good use for it."}
...
tellraw @s[tag=English,scores={DialogueTrigger=116,TalkTime=1}] {"text":"<Surge> Hey, you little tyke! It may not be very smart to challenge me, but it takes guts!"}
tellraw @s[tag=English,scores={DialogueTrigger=116,TalkTime=14}] {"text":"<Surge> When it comes to Electric-type Pokémon, I'm number one! "}
tellraw @s[tag=English,scores={DialogueTrigger=116,TalkTime=22}] {"text":"<Surge> I've never lost on the battlefield. "}
tellraw @s[tag=English,scores={DialogueTrigger=116,TalkTime=30}] {"text":"<Surge> I'll zap you just like I do all my enemies in battle!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=117,TalkTime=1}] {"text":"<Surge> Aaargh! You are strong! OK, kid. You get the Thunder Badge!"}
tellraw @s[tag=English,scores={DialogueTrigger=117,TalkTime=11}] {"text":"<Surge> That Thunder Badge suits those who've defeated me! Take good care of it, OK?"}
...
tellraw @s[tag=English,scores={DialogueTrigger=117,TalkTime=27}] {"text":"<Surge> There is something else. Here is a great TM for you!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=117,TalkTime=35}] {"text":"<Surge> That TM contains Shock Wave... Zzzap! Use it to go like lightning!"}
tellraw @s[tag=English,scores={DialogueTrigger=117,TalkTime=44}] {"text":"<Surge> When you go north, you will see a big city called Saffron!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=118,TalkTime=1}] {"text":"<Erika> Hello... Lovely weather, isn't it? It's so pleasant..."}
tellraw @s[tag=English,scores={DialogueTrigger=118,TalkTime=10}] {"text":"<Erika> I'm afraid I might doze off..."}
tellraw @s[tag=English,scores={DialogueTrigger=118,TalkTime=17}] {"text":"<Erika> My name is Erika. I am the Leader of Celadon Gym."}
tellraw @s[tag=English,scores={DialogueTrigger=118,TalkTime=25}] {"text":"<Erika> ...Oh? You are from Johto, you say? How nice..."}
tellraw @s[tag=English,scores={DialogueTrigger=118,TalkTime=33}] {"text":"<Erika> Oh. I'm sorry, I didn't realize that you wished to challenge me. I know."}
tellraw @s[tag=English,scores={DialogueTrigger=118,TalkTime=44}] {"text":"<Erika> I have been training myself on not only flower arrangement but also Pokémon battle. I shall not lose."}
...
tellraw @s[tag=English,scores={DialogueTrigger=119,TalkTime=1}] {"text":"<Erika> Oh! I concede defeat... You are remarkably strong..."}
tellraw @s[tag=English,scores={DialogueTrigger=119,TalkTime=10}] {"text":"<Erika> I shall give you the Rainbow Badge..."}
...
tellraw @s[tag=English,scores={DialogueTrigger=119,TalkTime=23}] {"text":"<Erika> That was a delightful match. I felt inspired."}
tellraw @s[tag=English,scores={DialogueTrigger=119,TalkTime=31}] {"text":"<Erika> Please, I wish you to have this TM134 as a special token."}
...
tellraw @s[tag=English,scores={DialogueTrigger=119,TalkTime=40}] {"text":"<Erika> It is Giga Drain. It is a wonderful move that drains half the damage it inflicts to heal your Pokémon."}
tellraw @s[tag=English,scores={DialogueTrigger=119,TalkTime=52}] {"text":"<Erika> It is indeed a horrifying move."}
tellraw @s[tag=English,scores={DialogueTrigger=119,TalkTime=59}] {"text":"<Erika> Losing leaves a bitter aftertaste..."}
tellraw @s[tag=English,scores={DialogueTrigger=119,TalkTime=66}] {"text":"<Erika> But knowing that there are strong Trainers spurs me to do better..."}
...
tellraw @s[tag=English,scores={DialogueTrigger=120,TalkTime=1}] {"text":"<...> Fufufufu... I'm sorry to disappoint you..."}
tellraw @s[tag=English,scores={DialogueTrigger=120,TalkTime=8}] {"text":"<Janine> I'm only joking! I'm the real deal!"}
tellraw @s[tag=English,scores={DialogueTrigger=120,TalkTime=16}] {"text":"<Janine> Janine of Fuchsia Gym, that's me!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=121,TalkTime=1}] {"text":"<Janine> I see... You have defeated Koga, my father and a member of the Elite Four, to come here."}
tellraw @s[tag=English,scores={DialogueTrigger=121,TalkTime=14}] {"text":"<Janine> No wonder you are strong! You’ve definitely won... Here's the Soul Badge."}
...
tellraw @s[tag=English,scores={DialogueTrigger=121,TalkTime=27}] {"text":"<Janine> You're so tough! I have a special gift!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=121,TalkTime=35}] {"text":"<Janine> It's Poison Jab, a powerful Poison-type move that may poison its victim."}
tellraw @s[tag=English,scores={DialogueTrigger=121,TalkTime=44}] {"text":"<Janine> I'm going to really apply myself and improve my skills."}
tellraw @s[tag=English,scores={DialogueTrigger=121,TalkTime=52}] {"text":"<Janine> I want to become much better than both my father and you!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=122,TalkTime=1}] {"text":"<Sabrina> I knew you were coming..."}
tellraw @s[tag=English,scores={DialogueTrigger=122,TalkTime=8}] {"text":"<Sabrina> Three years ago I had a vision of your arrival."}
tellraw @s[tag=English,scores={DialogueTrigger=122,TalkTime=16}] {"text":"<Sabrina> You’re after my Badge."}
tellraw @s[tag=English,scores={DialogueTrigger=122,TalkTime=23}] {"text":"<Sabrina> I don’t enjoy battling, but it’s my duty as a Gym Leader to confer Badges on anyone who has proven him- or herself worthy."}
tellraw @s[tag=English,scores={DialogueTrigger=122,TalkTime=36}] {"text":"<Sabrina> Since you wish it, I will show you my psychic powers!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=123,TalkTime=1}] {"text":"<Sabrina> Your power... It far exceeds what I foresaw..."}
tellraw @s[tag=English,scores={DialogueTrigger=123,TalkTime=10}] {"text":"<Sabrina> Maybe it isn’t possible to fully predict what the future holds..."}
tellraw @s[tag=English,scores={DialogueTrigger=123,TalkTime=19}] {"text":"<Sabrina> OK, you win. You earned yourself the Marsh Badge."}
...
tellraw @s[tag=English,scores={DialogueTrigger=123,TalkTime=33}] {"text":"<Sabrina> I failed to accurately predict your power."}
tellraw @s[tag=English,scores={DialogueTrigger=123,TalkTime=40}] {"text":"<Sabrina> That means that your power is beyond my psychic ability."}
tellraw @s[tag=English,scores={DialogueTrigger=123,TalkTime=48}] {"text":"<Sabrina> You deserve this. Please take this TM, too! It contains Skill Swap!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=123,TalkTime=56}] {"text":"<Sabrina> It swaps Abilities between the user and the target."}
tellraw @s[tag=English,scores={DialogueTrigger=123,TalkTime=66}] {"text":"<Sabrina> You will become a celebrated and beloved Champion!"}
tellraw @s[tag=English,scores={DialogueTrigger=123,TalkTime=73}] {"text":"<Sabrina> Your love for your Pokémon smashed my psychic abilities..."}
tellraw @s[tag=English,scores={DialogueTrigger=123,TalkTime=81}] {"text":"<Sabrina> The ability to love, I think, is some kind of psychic ability..."}
...
tellraw @s[tag=English,scores={DialogueTrigger=124,TalkTime=1}] {"text":"<Blaine> Hah! I'm Blaine! I am the Leader of Cinnabar Gym!"}
tellraw @s[tag=English,scores={DialogueTrigger=124,TalkTime=11}] {"text":"<Blaine> My fiery Pokémon will incinerate all challengers! Hah!"}
tellraw @s[tag=English,scores={DialogueTrigger=124,TalkTime=21}] {"text":"<Blaine> You better have Burn Heal!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=125,TalkTime=1}] {"text":"<Blaine> Awesome. I have burned out... Take this Volcano Badge!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=125,TalkTime=17}] {"text":"<Blaine> Here, I will give you this, too. It's called Overheat!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=125,TalkTime=25}] {"text":"<Blaine> It has a slight drawback, but it's powerful and well worth it!"}
tellraw @s[tag=English,scores={DialogueTrigger=125,TalkTime=34}] {"text":"<Blaine> I did lose this time, but I'm going to win next time."}
tellraw @s[tag=English,scores={DialogueTrigger=125,TalkTime=42}] {"text":"<Blaine> My Fire-type Pokémon will be even stronger! Just you watch!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=126,TalkTime=1}] {"text":"<Blue> You're telling me you conquered all the Gyms in Johto? Hahaha! "}
tellraw @s[tag=English,scores={DialogueTrigger=126,TalkTime=11}] {"text":"<Blue> Heh! Johto's Gyms are that pathetic?"}
tellraw @s[tag=English,scores={DialogueTrigger=126,TalkTime=18}] {"text":"<Blue> Hey, don't worry about it."}
tellraw @s[tag=English,scores={DialogueTrigger=126,TalkTime=25}] {"text":"<Blue> I'll know if you are good or not by battling you right now."}
...
tellraw @s[tag=English,scores={DialogueTrigger=127,TalkTime=1}] {"text":"<Blue> No way! How the heck did I lose to you? … Tch, all right."}
tellraw @s[tag=English,scores={DialogueTrigger=127,TalkTime=11}] {"text":"<Blue> ... Here, take this. It's the Earth Badge."}
...
tellraw @s[tag=English,scores={DialogueTrigger=127,TalkTime=23}] {"text":"<Blue> Here! Take this as well!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=127,TalkTime=30}] {"text":"<Blue> It contains Trick Room! It allows slower Pokémon to move before faster Pokémon for a while."}
tellraw @s[tag=English,scores={DialogueTrigger=127,TalkTime=41}] {"text":"<Blue> It's a very tricky move, isn't it? Hence the name!"}
tellraw @s[tag=English,scores={DialogueTrigger=127,TalkTime=49}] {"text":"<Blue> ... All right, I was wrong. You're the real deal. "}
tellraw @s[tag=English,scores={DialogueTrigger=127,TalkTime=57}] {"text":"<Blue> You are a good trainer. But I'm going to beat you someday. Don't you forget it!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=128,TalkTime=1}] {"text":"<Red> .................. .................."}
...
tellraw @s[tag=English,scores={DialogueTrigger=129,TalkTime=1}] {"text":"<Red> ...!"}

execute as @s[scores={DialogueTrigger=129,TalkTime=6}] run playsound minecraft:entity.ender_dragon.death ambient @s ~ ~ ~ 1 1 1
tellraw @s[tag=English,scores={DialogueTrigger=129,TalkTime=8}] {"text":"<Red> .................. .................."}
...
tellraw @s[tag=English,scores={DialogueTrigger=130,TalkTime=1}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> Hey, "},{"selector":"@s"},{"text":"! You're here in Kanto, too?"}]
tellraw @s[tag=English,scores={DialogueTrigger=130,TalkTime=9}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> Some of the Trainers here are tough, which makes it easy to train my Pokémon!"}]
tellraw @s[tag=English,scores={DialogueTrigger=130,TalkTime=20}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> "},{"selector":"@s"},{"text":"! I know you are strong... But... I can't help but challenge you!"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=131,TalkTime=1}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> Humph! I guess it can't be helped..."}]
tellraw @s[tag=English,scores={DialogueTrigger=131,TalkTime=8}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> My training's still not good enough...?"}]
tellraw @s[tag=English,scores={DialogueTrigger=131,TalkTime=15}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> My Pokémon are so weak, it makes me frustrated..."}]
tellraw @s[tag=English,scores={DialogueTrigger=131,TalkTime=24}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> But I can feel that they are getting better after each battle..."}]
tellraw @s[tag=English,scores={DialogueTrigger=131,TalkTime=34}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> ... ... ... Tch! They're still too weak!"}]
tellraw @s[tag=English,scores={DialogueTrigger=131,TalkTime=42}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> I need to give them more training..."}]
tellraw @s[tag=English,scores={DialogueTrigger=131,TalkTime=50}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> See ya, "},{"selector":"@s"},{"text":"!"}]

#tp Silver out
execute as @s[scores={DialogueTrigger=131,TalkTime=57}] run particle cloud -2200 64 800 1 1 1 1 100
execute as @s[scores={DialogueTrigger=131,TalkTime=57}] run tp @e[x=-2200,y=64,z=800,distance=..2,type=pixelmon:npc_trainer,scores={StarterPick=3}] -770 85 -242
execute as @s[scores={DialogueTrigger=131,TalkTime=57}] run tp @e[x=-2200,y=64,z=800,distance=..2,type=pixelmon:npc_trainer,scores={StarterPick=2}] -770 89 -242
...
tellraw @s[tag=English,scores={DialogueTrigger=132,TalkTime=1}] {"text":"<Shopkeeper> Good morning. I've received a gift for you!"}
...
execute as @s[scores={DialogueTrigger=133,TalkTime=1}] run data merge entity @e[limit=1,x=-2722,y=69,z=372,distance=..1,type=pixelmon:npc_chatting] {CustomSteveTexture:"red.png"}
tellraw @s[tag=English,scores={DialogueTrigger=133,TalkTime=3}] ["",{"text":"<"},{"selector":"@s"},{"text":"> Hi! I heard you lost your cherished Poké Doll."}]
tellraw @s[tag=English,scores={DialogueTrigger=133,TalkTime=10}] ["",{"text":"<"},{"selector":"@s"},{"text":"> If I find it, you'll give me a rail Pass?"}]
tellraw @s[tag=English,scores={DialogueTrigger=133,TalkTime=18}] ["",{"text":"<"},{"selector":"@s"},{"text":"> I'll go find it for you. You think you lost it when you went to Vermilion City?"}]

#Rerolls Copycat skin
execute as @s[scores={DialogueTrigger=133,TalkTime=25}] run setblock -860 64 -335 minecraft:redstone_block

tellraw @s[tag=English,scores={DialogueTrigger=133,TalkTime=29}] {"text":"<Copycat> Pardon? I shouldn't decide what you should do?"}
tellraw @s[tag=English,scores={DialogueTrigger=133,TalkTime=37}] {"text":"<Copycat> But I'm really worried... What if someone finds it?"}
...
#tps in Clefary Doll
#execute as @s[x=-2697,y=65,z=-39,distance=..20,score_TalkTime=0,tag=!Dialogue133] run /tp @e[x=-738,y=75,z=-242,distance=..1,type=pixelmon:statue] -2697 65 -39

tellraw @s[tag=English,scores={DialogueTrigger=134,TalkTime=1}] {"text":"<Poke Fan> I love Clefairy, but I could never catch one."}
tellraw @s[tag=English,scores={DialogueTrigger=134,TalkTime=9}] {"text":"<Poke Fan> So I'm making due with a Poke Doll that I found."}
tellraw @s[tag=English,scores={DialogueTrigger=134,TalkTime=18}] {"text":"<Poke Fan> Oh, I see now. The girl who lost this Poke Doll is sad..."}
tellraw @s[tag=English,scores={DialogueTrigger=134,TalkTime=27}] {"text":"<Poke Fan> OK. Could you take this Poke Doll back to that poor little girl?"}
...
tellraw @s[tag=English,scores={DialogueTrigger=134,TalkTime=36}] {"text":"<Poke Fan> I'll befriend a real Clefairy on my own one day. No worries!"}
...
#execute as @p[x=-2721,y=68,z=374,distance=..20,score_TalkTime=0,tag=!Dialogue135] run /tp @e[x=-2721,y=70,z=374,distance=..1,type=pixelmon:statue] -736 75 -242

execute as @s[scores={DialogueTrigger=135,TalkTime=1}] run clear @s minecraft:music_disc_13
tellraw @s[tag=English,scores={DialogueTrigger=135,TalkTime=1}] {"text":"<Copycat> Yay! That's my Clefairy Poké Doll!"}
tellraw @s[tag=English,scores={DialogueTrigger=135,TalkTime=8}] {"text":"<Copycat> See the tear where the right arm is sewn on? That's proof!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=135,TalkTime=18}] {"text":"<Copycat> OK. Here's the Magnet Train Pass like I promised!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=135,TalkTime=27}] {"text":"<Copycat> That's the Pass for the Magnet Train."}
tellraw @s[tag=English,scores={DialogueTrigger=135,TalkTime=34}] {"text":"<Copycat> The rail company man gave me that when they tore down our old house for the Station."}
...
#execute as @s[x=-2710,y=64,z=-55,distance=..40,score_TalkTime=0,tag=Dialogue134] run execute @s[tag=!Dialogue136] run /tp @e[x=-734,y=90,z=-242,dy=2,type=pixelmon:npc_chatting] -2710 64 -55

tellraw @s[tag=English,scores={DialogueTrigger=136,TalkTime=1}] ["",{"text":"<Steven> Hi! My name is Steven. The Champion from the Hoenn region.","color":"white"}]
tellraw @s[tag=English,scores={DialogueTrigger=136,TalkTime=11}] ["",{"text":"<Steven> Have we met...before?","color":"white"}]
tellraw @s[tag=English,scores={DialogueTrigger=136,TalkTime=18}] ["",{"text":"<Steven> That's not possible. All the Trainers I have battled seem to have the same look, anyway.","color":"white"}]
tellraw @s[tag=English,scores={DialogueTrigger=136,TalkTime=28}] ["",{"text":"<Steven> Especially the ones who gave me tough battles...","color":"white"}]
tellraw @s[tag=English,scores={DialogueTrigger=136,TalkTime=35}] ["",{"text":"<Steven> By the way, have you heard of Pokémon called Latias and Latios?","color":"white"}]

tellraw @s[tag=English,scores={DialogueTrigger=136,TalkTime=44}] ["",{"text":"<Steven> I am investigating why Latias and Latios, Pokémon from Hoenn, decided to leave Hoenn to come here.","color":"white"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=136,TalkTime=55}] ["",{"text":"<Steven> Latias and Latios are Pokémon that has a lot to do with Soul Dew, a gemlike Orb.","color":"white"}]
tellraw @s[tag=English,scores={DialogueTrigger=136,TalkTime=65}] ["",{"text":"<Steven> Considering the fact that Latias and Latios are now in Kanto, it is possible to assume that this has to do with Soul Dew.","color":"white"}]
tellraw @s[tag=English,scores={DialogueTrigger=136,TalkTime=76}] ["",{"text":"<Steven> Latias and Latios are Pokémon that travel a great distance.","color":"white"}]

execute as @s[scores={DialogueTrigger=136,TalkTime=80}] run kill @e[x=-2710,y=64,z=-55,distance=..3,type=item]

tellraw @s[tag=English,scores={DialogueTrigger=136,TalkTime=85}] ["",{"text":"<Steven> But any Trainer will be drawn to them, won't they?","color":"white"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=136,TalkTime=95}] ["",{"text":"<Steven> I must go. May our journeys cross again.","color":"white"}]

#tp Steven out
execute as @s[scores={DialogueTrigger=136,TalkTime=103}] run tp @e[x=-2710,y=63,z=-55,dy=3,type=pixelmon:npc_chatting] -734 91 -242
...
tellraw @s[tag=English,scores={DialogueTrigger=136,TalkTime=106}] {"text":"You can now find Latios and Latias anytime in the wild grass!","italic":true}
...
#tp in separately
#execute as @s[x=-2763,y=63,z=329,distance=..40,tag=Dialogue136] run execute @s[tag=!Dialogue137] run execute @s[tag=Red] run tp @e[x=-736,y=90,z=-242,dy=3,type=pixelmon:npc_chatting] -2763 64 329
#execute as @s[x=-2763,y=63,z=329,distance=..40,tag=Dialogue136] run execute @s[tag=!Dialogue137] run execute @s[tag=Red] run tp @e[x=-2763,y=63,z=329,dy=3,type=pixelmon:npc_trader] -732 91 -242

tellraw @s[tag=English,scores={DialogueTrigger=137,TalkTime=1}] {"text":"<Steven> Hello... You're breaking up... I think it depends on how my dad feels..."}
tellraw @s[tag=English,scores={DialogueTrigger=137,TalkTime=11}] {"text":"<Steven> I see... I'll be on my way. See you soon."}
...
tellraw @s[tag=English,scores={DialogueTrigger=137,TalkTime=20}] {"text":"<Steven> You are... I remember your eyes."}
...
tellraw @s[tag=English,scores={DialogueTrigger=137,TalkTime=27}] {"text":"<Steven> When I see a Trainer whose eyes twinkle, I always remember."}
tellraw @s[tag=English,scores={DialogueTrigger=137,TalkTime=36}] {"text":"<Steven> You have a Pokédex! So you are also in search of Pokémon. Let me see..."}
tellraw @s[tag=English,scores={DialogueTrigger=137,TalkTime=46}] {"text":"<Steven> I think I can help you with that. Let's say that you have stones in front of you."}
tellraw @s[tag=English,scores={DialogueTrigger=137,TalkTime=56}] ["",{"text":"<Steven> Which color would you pick?\n\n["},{"text":"Green Stone","color":"dark_green","clickEvent":{"action":"run_command","value":"/trigger TriggerCommand set 29"}},{"text":"]\n\n["},{"text":"Red Stone","color":"red","clickEvent":{"action":"run_command","value":"/trigger TriggerCommand set 30"}},{"text":"]\n\n["},{"text":"Blue Stone","color":"blue","clickEvent":{"action":"run_command","value":"/trigger TriggerCommand set 31"}},{"text":"]"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=138,TalkTime=8}] {"text":"<Steven> Take good care of it. Your caring for it will make me very happy."}
tellraw @s[tag=English,scores={DialogueTrigger=138,TalkTime=17}] {"text":"<Steven> Oh, look at the time. I really must go. I'll be back soon though!"}
...
#tp in Trader
#execute as @p[x=-2763,y=63,z=329,distance=..30,score_TalkTime=0,score_StevenCD=0,tag=Dialogue138] run /tp @e[x=-732,y=90,z=-242,dy=3,type=pixelmon:npc_trader] -2763 64 329
#execute as @p[x=-2763,y=63,z=329,distance=..30,score_TalkTime=0,score_StevenCD=0,tag=Dialogue138] run /tp @e[x=-2763,y=63,z=329,dy=3,type=pixelmon:npc_chatting] -736 91 -242

tellraw @s[tag=English,scores={DialogueTrigger=139,TalkTime=1}] {"text":"<Steven> We meet again! Have you been to Hoenn before?"}
tellraw @s[tag=English,scores={DialogueTrigger=139,TalkTime=9}] {"text":"<Steven> It's such a beautiful place, with the clearest ocean you can imagine. You should visit sometime."}
tellraw @s[tag=English,scores={DialogueTrigger=139,TalkTime=19}] {"text":"<Steven> Hey! Why don't we trade Pokémon?"}
tellraw @s[tag=English,scores={DialogueTrigger=139,TalkTime=26}] {"text":"<Steven> I've been looking for Forretress. I can trade my Beldum for it."}
...
tellraw @s[tag=English,scores={DialogueTrigger=140,TalkTime=1}] {"text":"<Sailor> The ocean is so beautiful, isn't it?"}
tellraw @s[tag=English,scores={DialogueTrigger=140,TalkTime=8}] {"text":"<Sailor> You look like you have proven yourself as a trainer."}
tellraw @s[tag=English,scores={DialogueTrigger=140,TalkTime=26}] {"text":"<Sailor> Please take this, and help preserve the beauty of the seas!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=141,TalkTime=1}] ["",{"text":"<Professor Elm> Hi "},{"selector":"@s"},{"text":"! How is your Pokédex coming along?"}]
tellraw @s[tag=English,scores={DialogueTrigger=141,TalkTime=9}] {"text":"<Professor Elm> You've been meeting new Pokémon at a great pace, haven't you?"}
tellraw @s[tag=English,scores={DialogueTrigger=141,TalkTime=17}] {"text":"<Professor Elm> Here, take this as a little reward for all your hard work!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=141,TalkTime=32}] {"text":"<Professor Elm> Having a Shiny Charm will improve your chances of finding a Shiny Pokémon!"}
...
#tps Snorlax in
#execute as @s[x=-2894,y=64,z=-53,distance=..50,score_TalkTime=0,tag=!Dialogue142] run /tp @e[x=-761,y=79,z=-244,distance=..2,type=pixelmon:statue] -2894 64 -53

tellraw @s[tag=English,scores={DialogueTrigger=142,TalkTime=10}] {"text":"<Snorlax> ..."}
tellraw @s[tag=English,scores={DialogueTrigger=142,TalkTime=30}] {"text":"<Snorlax> ... ... ..."}
execute as @s[scores={DialogueTrigger=142,TalkTime=43}] run playsound snorlax hostile @s ~ ~ ~ 10 1 1
tellraw @s[tag=English,scores={DialogueTrigger=142,TalkTime=43}]  {"text":"Snorlax woke up!"}
...
#Give Kyogre Orb
tellraw @s[tag=English,scores={DialogueTrigger=143,TalkTime=1,Groudon=1..}] {"text":"<Mr. Pokémon> Wow! That Red Orb summoned Groudon? Incredible!"}
tellraw @s[tag=English,scores={DialogueTrigger=143,TalkTime=11,Groudon=1..}] {"text":"<Mr. Pokémon> So I suppose this Blue Orb summons Kyogre?"}
...
#Give Groudon Orb
tellraw @s[tag=English,scores={DialogueTrigger=143,TalkTime=1,Kyogre=1..}] {"text":"<Mr. Pokémon> Wow! That Blue Orb summoned Kyogre? Incredible!"}
tellraw @s[tag=English,scores={DialogueTrigger=143,TalkTime=11,Kyogre=1..}] {"text":"<Mr. Pokémon> So I suppose this Red Orb summons Groudon?"}
...
tellraw @s[tag=English,scores={DialogueTrigger=144,TalkTime=1}] {"text":"<Mr. Pokémon> I am amazed!"}
tellraw @s[tag=English,scores={DialogueTrigger=144,TalkTime=7}] {"text":"<Mr. Pokémon> So if each color is to a legendary Pokémon, this Green Orb would be to Rayquaza, right?"}
...
tellraw @s[tag=English,scores={DialogueTrigger=144,TalkTime=19}] {"text":"<Mr. Pokémon> Fascinating! Thank you for doing all this."}
...
#tp Chuck in
#execute as @s[x=1317,y=64,z=-370,distance=..30,tag=Dialogue102] run execute @s[tag=!Dialogue145] run /tp @e[x=-718,y=90,z=-242,dy=3,type=pixelmon:npc_chatting] 1317 64 -370

tellraw @s[tag=English,scores={DialogueTrigger=145,TalkTime=1}] ["",{"text":"<Chuck> Hey, "},{"selector":"@s"},{"text":"! Good to see you again!"}]
tellraw @s[tag=English,scores={DialogueTrigger=145,TalkTime=8}] {"text":"<Chuck> But I never expected to see you around here."}
tellraw @s[tag=English,scores={DialogueTrigger=145,TalkTime=15}] {"text":"<Chuck> Could it be... that you are on the way to the Embedded Tower?"}
tellraw @s[tag=English,scores={DialogueTrigger=145,TalkTime=23}] {"text":"<Chuck> The Embedded Tower was a huge tower piercing the sky."}
tellraw @s[tag=English,scores={DialogueTrigger=145,TalkTime=32}] {"text":"<Chuck> It is said to have something to do with the mythical Pokémon that stretched the seas and that Pokémon that widened the lands."}
tellraw @s[tag=English,scores={DialogueTrigger=145,TalkTime=44}] {"text":"<Chuck> But the tower no longer is standing."}
tellraw @s[tag=English,scores={DialogueTrigger=145,TalkTime=51}] {"text":"<Chuck> The way to the Embedded Tower is harder than you can imagine."}
tellraw @s[tag=English,scores={DialogueTrigger=145,TalkTime=60}] {"text":"<Chuck> I see! So you've defeated all the Gym Leaders in Johto! Then there's nothing to worry about."}
tellraw @s[tag=English,scores={DialogueTrigger=145,TalkTime=70}] {"text":"<Chuck> Believe in yourself and walk your path. Yahaha!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=146,TalkTime=1}] {"text":"<Randy> Excuse me, guy! Can you do a guy a favor?"}
tellraw @s[tag=English,scores={DialogueTrigger=146,TalkTime=10}] {"text":"<Randy> Can you take this Pokémon with a message to my friend? He's on Route 31."}
tellraw @s[tag=English,scores={DialogueTrigger=146,TalkTime=10}] ["",{"text":"["},{"text":"Yes","color":"green","clickEvent":{"action":"run_command","value":"/trigger TriggerCommand set 48"}},{"text":"] \u0020 \u0020["},{"text":"No","color":"red","clickEvent":{"action":"run_command","value":"/trigger TriggerCommand set 49"}},{"text":"]"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=147,TalkTime=1}] {"text":"<Randy> You will? Perfect! Thanks, guy!"}
tellraw @s[tag=English,scores={DialogueTrigger=147,TalkTime=8}] {"text":"<Randy> My pal's a chubby guy who snoozes all the time."}
tellraw @s[tag=English,scores={DialogueTrigger=147,TalkTime=17}] {"text":"<Randy> You'll recognize him right away!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=147,TalkTime=24}] {"text":"<Randy> You can read it, but don't lose it!"}
tellraw @s[tag=English,scores={DialogueTrigger=147,TalkTime=32}] {"text":"<Randy> Route 31! Oh, yeah. There was a weird tree blocking the road."}
tellraw @s[tag=English,scores={DialogueTrigger=147,TalkTime=41}] {"text":"<Randy> I wonder if it's been cleared?"}
...
tellraw @s[tag=English,scores={DialogueTrigger=148,TalkTime=1}] {"text":"<Randy's Friend> ...Zzzz... Huh? What's that? You have Mail for me?"}
tellraw @s[tag=English,scores={DialogueTrigger=148,TalkTime=10}] ["",{"selector":"@s","italic":true,"color":"gray"},{"text":" handed over the Pokémon holding the Mail.","italic":true,"color":"gray"}]
tellraw @s[tag=English,scores={DialogueTrigger=148,TalkTime=18}] {"text":"<Randy's Friend> Let's see..."}
tellraw @s[tag=English,scores={DialogueTrigger=148,TalkTime=23}] ["",{"text":"<Randy's Friend> \u201c"},{"text":"Thank you for your Mail. It was such an exciting adventure. I did not like Zubat, though...","italic":true},{"text":"\u201d"}]
tellraw @s[tag=English,scores={DialogueTrigger=148,TalkTime=34}] {"text":"<Randy's Friend> That's what it says. I went to a dark cave the other day with a friend."}
tellraw @s[tag=English,scores={DialogueTrigger=148,TalkTime=44}] {"text":"<Randy's Friend> That cave leads to another route."}
tellraw @s[tag=English,scores={DialogueTrigger=148,TalkTime=51}] {"text":"<Randy's Friend> By the way, I must thank you for being so kind."}
tellraw @s[tag=English,scores={DialogueTrigger=148,TalkTime=59}] {"text":"<Randy's Friend> I'd like to do something good in return."}
...
tellraw @s[tag=English,scores={DialogueTrigger=148,TalkTime=65}] {"text":"<Randy's Friend> TM44 is..."}
tellraw @s[tag=English,scores={DialogueTrigger=148,TalkTime=70}] {"text":"<Randy's Friend> ...Zzz... ..."}
tellraw @s[tag=English,scores={DialogueTrigger=148,TalkTime=75}] {"text":"<Randy's Friend> ...Umm... Rest!"}
tellraw @s[tag=English,scores={DialogueTrigger=148,TalkTime=81}] {"text":"<Randy's Friend> The phrase \u201crecover fast\u201d became shortened to \u201cRest,\u201d you see?"}
tellraw @s[tag=English,scores={DialogueTrigger=148,TalkTime=90}] {"text":"<Randy's Friend> This is a move to sleep and recover HP."}
...
tellraw @s[tag=English,scores={DialogueTrigger=149,TalkTime=1}] {"text":"<Randy> Thank you for making the delivery!"}
tellraw @s[tag=English,scores={DialogueTrigger=149,TalkTime=10}] {"text":"<Randy> ...What about a cave exploration?"}
tellraw @s[tag=English,scores={DialogueTrigger=149,TalkTime=17}] {"text":"<Randy> Ah, you can go right through here."}
tellraw @s[tag=English,scores={DialogueTrigger=149,TalkTime=25}] {"text":"<Randy> I want you to have this for your kindness!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=149,TalkTime=34}] {"text":"<Randy> My pal was snoozing, right? Heh, he's always sleeping."}
...
tellraw @s[tag=English,scores={DialogueTrigger=153,TalkTime=1}] ["",{"text":"<Professor Oak> Hello, "},{"selector":"@s"},{"text":". Good to see you."}]
tellraw @s[tag=English,scores={DialogueTrigger=153,TalkTime=8}] {"text":"<Professor Oak> I heard a lot about you. Your Pokédex must be close to complete?"}
tellraw @s[tag=English,scores={DialogueTrigger=153,TalkTime=17}] {"text":"<Professor Oak> For all your hard work, I would like to give you something."}
tellraw @s[tag=English,scores={DialogueTrigger=153,TalkTime=26}] {"text":"<Professor Oak> Haha! What's next to me..."}
tellraw @s[tag=English,scores={DialogueTrigger=153,TalkTime=33}] {"text":"<Professor Oak> You must have figured it out right away. Yes, it is a Pokémon!"}
tellraw @s[tag=English,scores={DialogueTrigger=153,TalkTime=42}] {"text":"<Professor Oak> You don't see them very often in Kanto."}
tellraw @s[tag=English,scores={DialogueTrigger=153,TalkTime=50}] {"text":"<Professor Oak> Choose one and it'll be yours! ...Go ahead!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=154,TalkTime=6}] {"text":"<Professor Oak> There was another thing I wanted to give you!"}
tellraw @s[tag=English,scores={DialogueTrigger=154,TalkTime=14,KantoStarters=3}] {"text":"<Professor Oak> I came across these stones that seem to increase its power in battle."}
tellraw @s[tag=English,scores={DialogueTrigger=154,TalkTime=14,KantoStarters=1..2}] {"text":"<Professor Oak> I came this stone that seem to increase its power in battle."}
...
tellraw @s[tag=English,scores={DialogueTrigger=154,TalkTime=24}] {"text":"<Professor Oak> After speaking with Professor Sycamore of the Kalos region, I think I might know what they are."}
tellraw @s[tag=English,scores={DialogueTrigger=154,TalkTime=35}] {"text":"<Professor Oak> He provided me with this bracelet to study the stones, but I think you can make better use of it."}
...
tellraw @s[tag=English,scores={DialogueTrigger=154,TalkTime=54}] {"text":"<Professor Oak> You might be able to find more stones across Kanto and Johto."}
tellraw @s[tag=English,scores={DialogueTrigger=154,TalkTime=63}] {"text":"<Professor Oak> I found them while gathering data."}
tellraw @s[tag=English,scores={DialogueTrigger=154,TalkTime=70}] {"text":"<Professor Oak> They appeared around sunset, and made a beautiful rainbow cloud around them! That's how I spotted them."}
tellraw @s[tag=English,scores={DialogueTrigger=154,TalkTime=83}] {"text":"<Professor Oak> Keep your eyes out for them!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=154,TalkTime=93}] {"text":"You can now find wild mega stones, scattered around Johto and Kanto!","italic":true,"color":"gray"}
...
tellraw @s[tag=English,scores={DialogueTrigger=155,TalkTime=1}] {"text":"<Black Belt> Are you the one who took care of the odd tree in the way?"}
tellraw @s[tag=English,scores={DialogueTrigger=155,TalkTime=10}] {"text":"<Black Belt> You're quite the Trainer! Take this!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=155,TalkTime=18}] {"text":"<Black Belt> It contains make-'em-faint Rock Smash. Use it well!"}
...
#Tp return statue
#execute as @s[x=-2054,y=19,z=-835,distance=..50,score_Articuno=0,score_ArticunoCD=0] run /tp @e[x=-767,y=79,z=-244,distance=..1,type=pixelmon:statue] -2054 19 -835
...
tellraw @s[tag=English,scores={DialogueTrigger=161,TalkTime=1}] ["",{"text":"Celebi is reacting to the energy of the shrine. Do you want to investigate?\n["},{"text":"Yes","color":"green","clickEvent":{"action":"run_command","value":"/trigger TriggerCommand set 41"}},{"text":"]"}]
...
#tellraw @s[tag=English,x=617,y=64,z=-699,distance=..15,score_Celebi_min=1,tag=!Dialogue161]  {"text":"Celebi seems interested to see the shrine.","italic":true}
...
execute as @s[scores={DialogueTrigger=162,TalkTime=1}] run tp @e[x=-725,y=70,z=-242,dy=3,type=pixelmon:npc_chatting] 621 64 -701
execute as @s[scores={DialogueTrigger=162,TalkTime=1}] run particle cloud 621 64 -701 1 1 1 1 100


tellraw @s[tag=English,scores={DialogueTrigger=162,TalkTime=3}] ["",{"text":"<Lyra> Hi, "},{"selector":"@s"},{"text":". Have you heard the legend of the shrine?"}]
tellraw @s[tag=English,scores={DialogueTrigger=162,TalkTime=13}] {"text":"<Lyra> They say people disappear when they tamper with it."}
...
#tp Lyra out
execute as @s[scores={DialogueTrigger=162,TalkTime=25}] run tp @e[x=621,y=63,z=-701,dy=3,type=pixelmon:npc_chatting] -725 71 -242
...
tellraw @s[tag=English,scores={DialogueTrigger=162,TalkTime=30}] {"text":"<Lyra> Where are we...?"}
tellraw @s[tag=English,scores={DialogueTrigger=162,TalkTime=37}] {"text":"<Lyra> Ilex Forest has disappeared!"}
tellraw @s[tag=English,scores={DialogueTrigger=162,TalkTime=44}] {"text":"<Lyra> ...That's not it. It's more like we have been transported somewhere else...?"}
...
tellraw @s[tag=English,scores={DialogueTrigger=162,TalkTime=54}] {"text":"<Lyra> ... ... ..."}
tellraw @s[tag=English,scores={DialogueTrigger=162,TalkTime=59}] ["",{"text":"<Lyra> "},{"selector":"@s"},{"text":", something is strange! I heard the radio mentioning the date from 3 years ago!"}]
tellraw @s[tag=English,scores={DialogueTrigger=162,TalkTime=69}] {"text":"<Lyra> Is that... What I am looking at..."}
execute as @s[scores={DialogueTrigger=162,TalkTime=74}] run playsound celebi ambient @s ~ ~ ~ 100 1 1
tellraw @s[tag=English,scores={DialogueTrigger=162,TalkTime=79}] {"text":"<Lyra> Celebi? That explains it! Celebi must have caused all this!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=162,TalkTime=87}] {"text":"<Lyra> Celebi must have taken us back in time! Literally!"}
tellraw @s[tag=English,scores={DialogueTrigger=162,TalkTime=95}] ["",{"text":"<Lyra> "},{"selector":"@s"},{"text":", there is someone else here besides us! Let's go find out who!"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=163,TalkTime=1}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> You told me... you were the number one in the world!"}]
tellraw @s[tag=English,scores={DialogueTrigger=163,TalkTime=10}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> Are you gonna quit? What are you going to do now?"}]
tellraw @s[tag=English,scores={DialogueTrigger=163,TalkTime=19}] ["",{"text":"<"},{"text":"Giovanni","color":"gray"},{"text":"> ... ... ... .....One must acknowledge one's defeat before he can move on..."}]
tellraw @s[tag=English,scores={DialogueTrigger=163,TalkTime=31}] ["",{"text":"<"},{"text":"Giovanni","color":"gray"},{"text":"> I will go solo...for now..."}]
tellraw @s[tag=English,scores={DialogueTrigger=163,TalkTime=38}] ["",{"text":"<"},{"text":"Giovanni","color":"gray"},{"text":"> So that one day I will form a stronger organization!"}]
tellraw @s[tag=English,scores={DialogueTrigger=163,TalkTime=46}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> What aspect of you was number one?"}]
tellraw @s[tag=English,scores={DialogueTrigger=163,TalkTime=53}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> Gathering so many only to be defeated by a mere child!"}]
tellraw @s[tag=English,scores={DialogueTrigger=163,TalkTime=61}] ["",{"text":"<"},{"text":"Giovanni","color":"gray"},{"text":"> Putting together the potential of many is how you produce a huge power..."}]
tellraw @s[tag=English,scores={DialogueTrigger=163,TalkTime=71}] ["",{"text":"<"},{"text":"Giovanni","color":"gray"},{"text":"> That's what an organization is... That's the strength of an organization!"}]
tellraw @s[tag=English,scores={DialogueTrigger=163,TalkTime=81}] ["",{"text":"<"},{"text":"Giovanni","color":"gray"},{"text":"> I failed... to make the best use of my subordinates potential...!"}]
tellraw @s[tag=English,scores={DialogueTrigger=163,TalkTime=91}] ["",{"text":"<"},{"text":"Giovanni","color":"gray"},{"text":"> But you shall witness one day the revival of me and my Team Rocket!"}]
tellraw @s[tag=English,scores={DialogueTrigger=163,TalkTime=101}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> I don't understand you! You don't make any sense!"}]
tellraw @s[tag=English,scores={DialogueTrigger=163,TalkTime=109}] ["",{"text":"<"},{"text":"Giovanni","color":"gray"},{"text":"> ... ... ..."}]
tellraw @s[tag=English,scores={DialogueTrigger=163,TalkTime=114}] ["",{"text":"<"},{"text":"Giovanni","color":"gray"},{"text":"> ... ... ... ... ..One day, you will understand."}]
...
tellraw @s[tag=English,scores={DialogueTrigger=163,TalkTime=125}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> I don't want to understand you! I will never become someone like you."}]
tellraw @s[tag=English,scores={DialogueTrigger=163,TalkTime=135}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> A coward when you're alone and acting like a tyrant when you're in front of other cowards!"}]
tellraw @s[tag=English,scores={DialogueTrigger=163,TalkTime=147}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> I will become strong! I will become a stronger man all by myself!"}]
tellraw @s[tag=English,scores={DialogueTrigger=163,TalkTime=156}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> "},{"text":"All by myself!","bold":true}]
...
tellraw @s[tag=English,scores={DialogueTrigger=163,TalkTime=164}] ["",{"text":"<"},{"text":"Silver","color":"red"},{"text":"> \u0020...What are you staring at?"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=164,TalkTime=1}] {"text":"<Lyra> Who does he think he is? That was unnecessary!"}
tellraw @s[tag=English,scores={DialogueTrigger=164,TalkTime=9}] {"text":"<Lyra> But what were they talking about? The revival of Team Rocket...?"}
tellraw @s[tag=English,scores={DialogueTrigger=164,TalkTime=18}] {"text":"<Lyra> They say Team Rocket was removed from the Kanto region by a child three years ago."}
tellraw @s[tag=English,scores={DialogueTrigger=164,TalkTime=30}] {"text":"<Lyra> So this really is three years ago!"}

execute as @s[scores={DialogueTrigger=164,TalkTime=37}] run playsound celebi ambient @s ~ ~ ~ 100 1 1
tellraw @s[tag=English,scores={DialogueTrigger=164,TalkTime=41}] {"text":"<Lyra> Oh no! It's happening again...! It's Celebi's Time Travel!"}
...
#tp Giovanni in
execute as @s[scores={DialogueTrigger=164,TalkTime=48}] run tp @e[x=-735,y=70,z=-242,dy=3,type=pixelmon:npc_trainer] 109 54 750

#tp Lyra in
execute as @s[scores={DialogueTrigger=164,TalkTime=48}] run tp @e[x=-729,y=70,z=-242,dy=3,type=pixelmon:npc_chatting] 112 54 735


#Turns off particles #2

tellraw @s[tag=English,scores={DialogueTrigger=164,TalkTime=53}] ["",{"text":"<"},{"text":"Giovanni","color":"gray"},{"text":"> ...I don't know why you have come here."}]
tellraw @s[tag=English,scores={DialogueTrigger=164,TalkTime=60}] ["",{"text":"<"},{"text":"Giovanni","color":"gray"},{"text":"> Anyway, I have to warn you that this is not a place for kids like you."}]
tellraw @s[tag=English,scores={DialogueTrigger=164,TalkTime=69}] {"text":"<Lyra> Huh? That's the guy we just saw arguing with that boy!"}
tellraw @s[tag=English,scores={DialogueTrigger=164,TalkTime=78}] ["",{"text":"<"},{"text":"Giovanni","color":"gray"},{"text":"> You have a certain look..."}]
tellraw @s[tag=English,scores={DialogueTrigger=164,TalkTime=85}] ["",{"text":"<"},{"text":"Giovanni","color":"gray"},{"text":"> It reminds me of the kid who stood in front of me three years ago..."}]
tellraw @s[tag=English,scores={DialogueTrigger=164,TalkTime=95}] ["",{"text":"<"},{"text":"Giovanni","color":"gray"},{"text":"> You have the same eyes..."}]
tellraw @s[tag=English,scores={DialogueTrigger=164,TalkTime=102}] ["",{"text":"<"},{"text":"Giovanni","color":"gray"},{"text":"> .... I'm on my way to Goldenrod City to answer the call and join my team."}]
tellraw @s[tag=English,scores={DialogueTrigger=164,TalkTime=111}] ["",{"text":"<"},{"text":"Giovanni","color":"gray"},{"text":"> Are you going to get in my way?"}]
tellraw @s[tag=English,scores={DialogueTrigger=164,TalkTime=118}] {"text":"<Lyra> Three years ago...? Goldenrod City...?"}
tellraw @s[tag=English,scores={DialogueTrigger=164,TalkTime=125}] {"text":"<Lyra> Could this be the one that the radio was trying to reach?"}
tellraw @s[tag=English,scores={DialogueTrigger=164,TalkTime=134}] ["",{"text":"<Lyra> Giovanni, their boss? Do you hear it, "},{"selector":"@s"},{"text":"?"}]
tellraw @s[tag=English,scores={DialogueTrigger=164,TalkTime=142}] {"text":"<Lyra> The radio is saying something strange!"}
tellraw @s[tag=English,scores={DialogueTrigger=164,TalkTime=150}] {"text":"<Lyra> Team Rocket has occupied the Radio Tower at Goldenrod City!"}
tellraw @s[tag=English,scores={DialogueTrigger=164,TalkTime=160}] ["",{"text":"<Lyra> It can't be! "},{"selector":"@s"},{"text":", you solved this case already!"}]

#Plays Team Rocket music
execute as @s[scores={DialogueTrigger=164,TalkTime=166}] run scoreboard players set @s click 1

tellraw @s[tag=English,scores={DialogueTrigger=164,TalkTime=169}] ["",{"text":"\u266a\u266b\u266c "},{"text":"[Radio: Pokémon Music] ","color":"aqua"},{"text":"<Team Rocket> ...This is the Radio Tower. This is the Radio Tower. We are pleased to declare Team Rocket's revival.","italic":true},{"text":"\u266a\u266b\u266c"}]
tellraw @s[tag=English,scores={DialogueTrigger=164,TalkTime=182}] ["",{"text":"\u266a\u266b\u266c "},{"text":"[Radio: Pokémon Music] ","color":"aqua"},{"text":"<Team Rocket> ...Giovanni? ...Can you hear us? We have finally made it!...","italic":true},{"text":"\u266a\u266b\u266c"}]
tellraw @s[tag=English,scores={DialogueTrigger=164,TalkTime=192}] ["",{"text":"<"},{"text":"Giovanni","color":"gray"},{"text":"> My old associates need me..."}]
tellraw @s[tag=English,scores={DialogueTrigger=164,TalkTime=200}] ["",{"text":"<"},{"text":"Giovanni","color":"gray"},{"text":"> We will not repeat the failure of three years ago!"}]
tellraw @s[tag=English,scores={DialogueTrigger=164,TalkTime=208}] ["",{"text":"<"},{"text":"Giovanni","color":"gray"},{"text":"> Team Rocket will be born again, and I will rule the world!"}]
...
#Giovanni respawn
#execute as @s[x=87,y=50,z=719,dx=44,dy=20,dz=44.score_TalkTime=0,tag=Dialogue164] run execute @s[tag=!Dialogue165] run tp @e[x=-735,y=70,z=-242,dy=3,type=pixelmon:npc_trainer] 109 54 750
...
tellraw @s[tag=English,scores={DialogueTrigger=165,TalkTime=1}] ["",{"text":"<"},{"text":"Giovanni","color":"gray"},{"text":"> How is this possible...?"}]
tellraw @s[tag=English,scores={DialogueTrigger=165,TalkTime=8}] ["",{"text":"<"},{"text":"Giovanni","color":"gray"},{"text":"> The past three years have been a waste...?"}]
tellraw @s[tag=English,scores={DialogueTrigger=165,TalkTime=16}] ["",{"text":"<"},{"text":"Giovanni","color":"gray"},{"text":"> How can a kid like you manage to destroy my team again?"}]
tellraw @s[tag=English,scores={DialogueTrigger=165,TalkTime=25}] ["",{"text":"<"},{"text":"Giovanni","color":"gray"},{"text":"> The precious dream of Team Rocket has become little more than an illusion..."}]

#tp Giovanni Out
execute as @s[scores={DialogueTrigger=165,TalkTime=33}] run particle cloud 109 54 750 1 1 1 0.15 100
execute as @s[scores={DialogueTrigger=165,TalkTime=33}] run tp @e[x=109,y=53,z=750,dy=3,type=pixelmon:npc_trainer] -735 71 -242

tellraw @s[tag=English,scores={DialogueTrigger=165,TalkTime=34}] ["",{"text":"\u266a\u266b\u266c "},{"text":"[Radio: Pokémon Music] ","color":"aqua"},{"text":"<Team Rocket> ...Hey! Where has Giovanni gone? I wonder if he is listening to our broadcast... ...","italic":true},{"text":"\u266a\u266b\u266c"}]
tellraw @s[tag=English,scores={DialogueTrigger=165,TalkTime=43}] {"text":"<Lyra> They keep calling for their boss. I feel sorry they don't know he's not coming."}
tellraw @s[tag=English,scores={DialogueTrigger=165,TalkTime=53}] ["",{"text":"<Lyra> After this, "},{"selector":"@s"},{"text":", you will defeat them!"}]
tellraw @s[tag=English,scores={DialogueTrigger=165,TalkTime=60}] ["",{"text":"<Lyra> ...Wait a second! "},{"selector":"@s"},{"text":", you're still here. Then, who will defeat Team Rocket...?"}]

execute as @s[scores={DialogueTrigger=165,TalkTime=70}] run playsound celebi ambient @s ~ ~ ~ 100 1 1

tellraw @s[tag=English,scores={DialogueTrigger=165,TalkTime=73}] {"text":"<Lyra> Not again...! I've had enough!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=165,TalkTime=84}] {"text":"<Lyra> Traveling through time sure doesn't feel good."}
tellraw @s[tag=English,scores={DialogueTrigger=165,TalkTime=92}] {"text":"<Lyra> Hey, my Marill!"}
tellraw @s[tag=English,scores={DialogueTrigger=165,TalkTime=99}] {"text":"<Lyra> I missed you so much! Wait a sec... So we must be back to our own time!"}
tellraw @s[tag=English,scores={DialogueTrigger=165,TalkTime=109}] {"text":"<Lyra> It was all so bizarre."}
tellraw @s[tag=English,scores={DialogueTrigger=165,TalkTime=116}] {"text":"<Lyra> But now that we are safely back to our time and Team Rocket's terrible design fell through, we can say..."}
tellraw @s[tag=English,scores={DialogueTrigger=165,TalkTime=128}] {"text":"<Lyra> All's well that ends well, right?"}
tellraw @s[tag=English,scores={DialogueTrigger=165,TalkTime=135}] ["",{"text":"<Lyra> "},{"selector":"@s"},{"text":", you never cease to to inspire great adventures."}]
tellraw @s[tag=English,scores={DialogueTrigger=165,TalkTime=143}] {"text":"<Lyra> It sure was an exhausting day, though. I better get going."}
tellraw @s[tag=English,scores={DialogueTrigger=165,TalkTime=143}] {"text":"<Lyra> See you!"}
...
execute as @s[scores={DialogueTrigger=165,TalkTime=158}] run tp @e[x=621,y=63,z=-701,dy=3,type=pixelmon:npc_chatting] -725 71 -242
...
tellraw @s[tag=English,scores={DialogueTrigger=167,TalkTime=1}] {"text":"<Archaeologist> Is that... the Azure Flute?"}
tellraw @s[tag=English,scores={DialogueTrigger=167,TalkTime=9}] {"text":"<Archaeologist> I've heard legends of in Sinnoh, but.. what is it doing in Johto?"}
tellraw @s[tag=English,scores={DialogueTrigger=167,TalkTime=19}] {"text":"<Archaeologist> You, Champion! Could you help me investigate this?"}
...
tellraw @s[tag=English,scores={DialogueTrigger=167,TalkTime=27}] {"text":"<Archaeologist> The Flute is said to call upon the mythical Pokemon Arceus atop Mt. Coronet, but that is unreachable to us..."}
tellraw @s[tag=English,scores={DialogueTrigger=167,TalkTime=38}] {"text":"<Archaeologist> Is there a mountain in this region that may have a similar connection?"}

tag @s[scores={DialogueTrigger=167,TalkTime=38..}] add Dialogue167

#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#Post-catching Arceus
#execute as @e[x=174,y=63,z=-141,distance=..20,type=pixelmon:pixelmon,name=Arceus] run execute @p[r=15,score_TalkTime=0,tag=Dialogue167,score_Arceus_min=1] run execute @s[tag=Red] run scoreboard players set @s[tag=!Dialogue168] DialogueTrigger 168

tellraw @s[tag=English,scores={DialogueTrigger=168,TalkTime=1}] {"text":"<Archaeologist> No way! Could it be a Pokémon from Sinnoh... The one they call Arceus?"}
tellraw @s[tag=English,scores={DialogueTrigger=168,TalkTime=10}] {"text":"<Archaeologist> Oh, could it be...? Arceus causing all this...? I cannot explain it any other way..."}
tellraw @s[tag=English,scores={DialogueTrigger=168,TalkTime=21}] {"text":"<Archaeologist> Arceus may be the key to solving the mystery of the Unown and the Ruins of Alph...?"}
tellraw @s[tag=English,scores={DialogueTrigger=168,TalkTime=31}] {"text":"<Archaeologist> Can you come to the Ruins of Alph with me?"}
tellraw @s[tag=English,scores={DialogueTrigger=168,TalkTime=39}] {"text":"<Archaeologist> Please! You must! I am trembling with excitement."}
tellraw @s[tag=English,scores={DialogueTrigger=168,TalkTime=48}] {"text":"<Archaeologist> I think something is about to happen!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=169,TalkTime=1}] {"text":"<Archaeologist> Hmm. I have been studying the ruins for many years, but something feels...different."}

#Enables Particles 1
#execute as @s[scores={DialogueTrigger=169,TalkTime=1}] run setblock -691 91 -242 minecraft:redstone_block

tellraw @s[tag=English,scores={DialogueTrigger=169,TalkTime=13}] {"text":"<Archaeologist> Wow! The Unown pictures on the wall... It feels like they're staring at me!"}

#Enables Particles 2
#execute as @s[scores={DialogueTrigger=169,TalkTime=13}] run setblock -692 91 -242 minecraft:redstone_block

tellraw @s[tag=English,scores={DialogueTrigger=169,TalkTime=27}] {"text":"<Archaeologist> What is this? There is something eerie that is making my legs shiver. I can't stop them!"}
...
#tp Hiker in
execute as @s[scores={DialogueTrigger=169,TalkTime=40}] run tp @e[x=-701,y=86,z=-242,distance=..1,limit=1,type=pixelmon:npc_chatting] -1044 61 -181

tellraw @s[tag=English,scores={DialogueTrigger=169,TalkTime=42}] {"text":"<Hiker> Well, hello! It's so freezing, isn't it? For a youngster like you to be interested in the Sinjoh Ruins is not something we see every day."}
execute as @s[scores={DialogueTrigger=169,TalkTime=42}] run scoreboard players set @s click 1
tellraw @s[tag=English,scores={DialogueTrigger=169,TalkTime=54}] {"text":"<Hiker> Take a look at them. From the design of the pillars at the Sinjoh Ruins, you can see that the cultures of Sinnoh and Johto have blended."}
tellraw @s[tag=English,scores={DialogueTrigger=169,TalkTime=66}] {"text":"<Hiker> Oh, right! We don't need to be standing here."}
tellraw @s[tag=English,scores={DialogueTrigger=169,TalkTime=74}] {"text":"<Hiker> Why don't you come to the cabin around the corner for more discussion?"}
tellraw @s[tag=English,scores={DialogueTrigger=169,TalkTime=83}] {"text":"<Hiker> By the way, we happen to have a person at the cabin."}
tellraw @s[tag=English,scores={DialogueTrigger=169,TalkTime=91}] {"text":"<Hiker> Any Trainer should know who she is."}
tellraw @s[tag=English,scores={DialogueTrigger=169,TalkTime=98}] {"text":"<Hiker> The famous Trainer from Sinnoh!"}
tellraw @s[tag=English,scores={DialogueTrigger=169,TalkTime=105}] {"text":"<Hiker> She is traveling around to study myths and ancient ruins. Isn't that something?"}

#tps Hiker out
execute as @s[scores={DialogueTrigger=169,TalkTime=115}] run tp @e[type=pixelmon:npc_chatting,x=-1044,y=61,z=-181,distance=..1,limit=1] -701 86 -242
...
tellraw @s[tag=English,scores={DialogueTrigger=170,TalkTime=1}] {"text":"<Hiker> A long time ago, people used to draw life from Pokémon and also give their lives to those Pokémon..."}
tellraw @s[tag=English,scores={DialogueTrigger=170,TalkTime=12}] {"text":"<Hiker> That shows that people and Pokémon used to be more closely bonded with each other."}
tellraw @s[tag=English,scores={DialogueTrigger=170,TalkTime=22}] {"text":"<Hiker> When people moved from place to place, the myths and legends of Pokémon and their power would also be carried with those people. "}
tellraw @s[tag=English,scores={DialogueTrigger=170,TalkTime=35}] {"text":"<Hiker> That's how myths and legends from each region are blended with each other."}
tellraw @s[tag=English,scores={DialogueTrigger=170,TalkTime=45}] {"text":"<Hiker> The ancient ruins here have inherited the legends from both the Ruins of Alph in Johto and the Spear Pillar in Sinnoh. "}
tellraw @s[tag=English,scores={DialogueTrigger=170,TalkTime=58}] {"text":"<Hiker> That is proof that people from Johto and Sinnoh blended together as a group."}
...
#execute as @s[x=-1081,y=62,z=-224,distance=..20,tag=!Dialogue171,score_TalkTime=0] run tp @e[x=-815,y=64,z=-235,dy=3,type=pixelmon:npc_chatting] -1081 61 -224

tellraw @s[tag=English,scores={DialogueTrigger=171,TalkTime=1}] {"text":"<Cynthia> My name is Cynthia. I am a Pokémon Trainer."}
tellraw @s[tag=English,scores={DialogueTrigger=171,TalkTime=9}] {"text":"<Cynthia> The Sinjoh Ruins remind me of Sinnoh, where I come from."}
tellraw @s[tag=English,scores={DialogueTrigger=171,TalkTime=17}] {"text":"<Cynthia> Initially, I thought it was because it snows a lot here as well. But that was not it."}
tellraw @s[tag=English,scores={DialogueTrigger=171,TalkTime=27}] {"text":"<Cynthia> A long time ago...people came from Sinnoh to live here."}
tellraw @s[tag=English,scores={DialogueTrigger=171,TalkTime=36}] {"text":"<Cynthia> They must have built a temple here while longing for home."}
tellraw @s[tag=English,scores={DialogueTrigger=171,TalkTime=44}] {"text":"<Cynthia> That's why we call these the Sinjoh Ruins..."}
tellraw @s[tag=English,scores={DialogueTrigger=171,TalkTime=52}] {"text":"<Cynthia> You are...a Pokémon Trainer?"}
tellraw @s[tag=English,scores={DialogueTrigger=171,TalkTime=59}] {"text":"<Cynthia> I can sense strong power coming from your Poké Ball..."}
tellraw @s[tag=English,scores={DialogueTrigger=171,TalkTime=67}] {"text":"<Cynthia> I feel a familiar presence..."}
tellraw @s[tag=English,scores={DialogueTrigger=171,TalkTime=74}] {"text":"<Cynthia> The power of Dialga... Palkia... or could it be Giratina?"}
tellraw @s[tag=English,scores={DialogueTrigger=171,TalkTime=84}] {"text":"<Cynthia> It's similar, but not quite the same..."}
tellraw @s[tag=English,scores={DialogueTrigger=171,TalkTime=91}] {"text":"<Cynthia> Have you got time? Can you come to the Sinjoh Ruins with me?"}
tellraw @s[tag=English,scores={DialogueTrigger=171,TalkTime=100}] {"text":"<Cynthia> Call it a Trainer's intuition. When you and your Pokémon step onto that stage, something will happen."}
...
#tp Cynthia in
#execute as @s[x=-1046,y=48,z=-111,distance=..50,tag=Dialogue171] run execute @s[tag=!Dialogue172] run tp @e[x=-815,y=64,z=-233,dy=3,type=pixelmon:npc_chatting] -1046 48 -111

tellraw @s[tag=English,scores={DialogueTrigger=172,TalkTime=1}] {"text":"<Cynthia> This is the Mystri Stage."}
tellraw @s[tag=English,scores={DialogueTrigger=172,TalkTime=8}] {"text":"<Cynthia> The mythical stage built to show respect for Arceus."}
tellraw @s[tag=English,scores={DialogueTrigger=172,TalkTime=15}] {"text":"<Cynthia> It is said that people used to celebrate its magnificent might with music and dance."}
tellraw @s[tag=English,scores={DialogueTrigger=172,TalkTime=25}] {"text":"<Cynthia> Some people in Johto still pass down this tradition."}
tellraw @s[tag=English,scores={DialogueTrigger=172,TalkTime=33}] {"text":"<Cynthia> According to an ancient document, time, space, and antimatter, or what combined we call the world,"}
tellraw @s[tag=English,scores={DialogueTrigger=172,TalkTime=44}] {"text":"<Cynthia> shall be born when Arceus stands on the Mystri Stage."}
tellraw @s[tag=English,scores={DialogueTrigger=172,TalkTime=52}] {"text":"<Cynthia> This is where one might say, 'The lead enters the Mystri Stage at last.'"}
tellraw @s[tag=English,scores={DialogueTrigger=172,TalkTime=62}] {"text":"<Cynthia> All my study of ruins and Pokémon mythology in Sinnoh may have been to bring you up on this stage today..."}

execute as @s[scores={DialogueTrigger=172,TalkTime=72}] run tp @e[x=-1046,y=48,z=-111,distance=..1,type=pixelmon:npc_chatting,limit=1] -1044 51 -93 180 ~0
execute as @s[scores={DialogueTrigger=172,TalkTime=72}] run particle cloud -1046 48 -111 1 1 1 1 100

tellraw @s[tag=English,scores={DialogueTrigger=172,TalkTime=74}] {"text":"<Cynthia> Depicted on that Mystri Stage are the Pokémon that shaped this world."}
tellraw @s[tag=English,scores={DialogueTrigger=172,TalkTime=83}] {"text":"<Cynthia> The circle in the middle is Arceus, the origin of it all..."}
tellraw @s[tag=English,scores={DialogueTrigger=172,TalkTime=92}] {"text":"<Cynthia> The purple pattern represents Palkia, the master of space and dimensions..."}
tellraw @s[tag=English,scores={DialogueTrigger=172,TalkTime=102}] {"text":"<Cynthia> The blue pattern represents Dialga, the guardian of time..."}
tellraw @s[tag=English,scores={DialogueTrigger=172,TalkTime=111}] {"text":"<Cynthia> The red pattern represents Giratina, the ruler of the world that is on the opposite side of ours, the world of antimatter..."}

execute as @s[scores={DialogueTrigger=172,TalkTime=122}] run tp @e[x=-1044,y=51,z=-93,distance=..1,type=pixelmon:npc_chatting,limit=1] -1046 48 -111
execute as @s[scores={DialogueTrigger=172,TalkTime=122}] run particle cloud -1044 51 -93 1 1 1 1 100

tellraw @s[tag=English,scores={DialogueTrigger=172,TalkTime=124}] {"text":"<Cynthia> Arceus has accepted you as a Trainer."}
tellraw @s[tag=English,scores={DialogueTrigger=172,TalkTime=131}] {"text":"<Cynthia> Arceus, having shaped the world, is said to show you a glimpse of its true power."}
tellraw @s[tag=English,scores={DialogueTrigger=172,TalkTime=142}] {"text":"<Cynthia> The power of possibly making life appear out of nothing..."}
tellraw @s[tag=English,scores={DialogueTrigger=172,TalkTime=151}] {"text":"<Cynthia> It seems that something will happen when you choose one of the circles with Arceus on the stage..."}
tellraw @s[tag=English,scores={DialogueTrigger=172,TalkTime=163}] {"text":"<Cynthia> You'll want to be well prepared."}
...
tellraw @s[tag=English,scores={DialogueTrigger=176,TalkTime=1}] {"text":"<Cynthia> That shining sphere..."}
tellraw @s[tag=English,scores={DialogueTrigger=176,TalkTime=8}] {"text":"<Cynthia> Could it be... an Egg?"}
tellraw @s[tag=English,scores={DialogueTrigger=176,TalkTime=15}] {"text":"<Cynthia> Did we just witness the very moment an Egg was brought into this world?"}
tellraw @s[tag=English,scores={DialogueTrigger=176,TalkTime=25}] {"text":"<Cynthia> A moment no-one has ever seen?"}
tellraw @s[tag=English,scores={DialogueTrigger=176,TalkTime=32}] {"text":"<Cynthia> An Egg is the cradle of every being."}
tellraw @s[tag=English,scores={DialogueTrigger=176,TalkTime=39}] {"text":"<Cynthia> This planet itself is an Egg in a sense..."}
tellraw @s[tag=English,scores={DialogueTrigger=176,TalkTime=46}] {"text":"<Cynthia> Life that comes from an Egg will come to an end in due course... to begin anew..."}
tellraw @s[tag=English,scores={DialogueTrigger=176,TalkTime=56}] {"text":"<Cynthia> That may be what Arceus wanted to show us."}
tellraw @s[tag=English,scores={DialogueTrigger=176,TalkTime=64}] {"text":"<Cynthia> That was... We seem to be surrounded by that strong power again...!"}
tellraw @s[tag=English,scores={DialogueTrigger=176,TalkTime=73}] {"text":"<Cynthia> I must investigate this further!"}
tellraw @s[tag=English,scores={DialogueTrigger=176,TalkTime=80}] {"text":"<Cynthia> Thank you! This would have been impossible without you!"}

#tp Cynthia out
execute as @s[scores={DialogueTrigger=176,TalkTime=88}] run tp @e[x=-1046,y=48,z=-111,distance=..1,type=pixelmon:npc_chatting,limit=1] -815 65 -233
...
#tp Archeologist in
execute as @s[scores={DialogueTrigger=177,TalkTime=5}] run tp @e[x=-699,y=86,z=-242,distance=..1,type=pixelmon:npc_chatting] 201 38 -118

tellraw @s[tag=English,scores={DialogueTrigger=177,TalkTime=5}] {"text":"<Archaeologist> Oh, are you all right?"}
tellraw @s[tag=English,scores={DialogueTrigger=177,TalkTime=13}] {"text":"<Archaeologist> You disappeared right in front of me. I was so surprised!"}
tellraw @s[tag=English,scores={DialogueTrigger=177,TalkTime=21}] {"text":"<Archaeologist> I see. The power of Arceus and Unown affected each other to create a huge energy, which sent you to the Sinjoh Ruins...?"}
tellraw @s[tag=English,scores={DialogueTrigger=177,TalkTime=36}] {"text":"<Archaeologist> Unown, the Ruins of Alph, and Arceus... The mystery deepens... "}
tellraw @s[tag=English,scores={DialogueTrigger=177,TalkTime=43}] {"text":"<Archaeologist> It has made me even more inquisitive!"}
tellraw @s[tag=English,scores={DialogueTrigger=177,TalkTime=50}] {"text":"<Archaeologist> I will one day solve all the mysteries!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=178,TalkTime=1}] {"text":"Oh, dear. Sorry, but you got it wrong. Please try again!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=179,TalkTime=1}] {"text":"<Radio Tower Clerk> First question!"}

tellraw @s[tag=English,scores={DialogueTrigger=179,TalkTime=7}] {"text":"<Radio Tower Clerk> Can a player can pick up a Town Map in Cherrygrove City?"}
execute as @s[scores={DialogueTrigger=179,TalkTime=7}] run scoreboard players enable @s TriggerCommand
tellraw @s[tag=English,scores={DialogueTrigger=179,TalkTime=7}] ["",{"text":"["},{"text":"Yes","color":"green","clickEvent":{"action":"run_command","value":"/trigger TriggerCommand set 16"}},{"text":"] \u0020 \u0020 ["},{"text":"No","color":"red","clickEvent":{"action":"run_command","value":"/trigger TriggerCommand set 15"}},{"text":"]"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=180,TalkTime=1}] {"text":"<Radio Tower Clerk> Correct! Second question!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=180,TalkTime=7}] {"text":"<Radio Tower Clerk> Nidorina can only be female. True?"}
execute as @s[scores={DialogueTrigger=180,TalkTime=7}] run scoreboard players enable @s TriggerCommand
tellraw @s[tag=English,scores={DialogueTrigger=180,TalkTime=7}] ["",{"text":"["},{"text":"Yes","color":"green","clickEvent":{"action":"run_command","value":"/trigger TriggerCommand set 17"}},{"text":"] \u0020 \u0020 ["},{"text":"No","color":"red","clickEvent":{"action":"run_command","value":"/trigger TriggerCommand set 15"}},{"text":"]"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=181,TalkTime=1}] {"text":"<Radio Tower Clerk> Correct! Third question!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=181,TalkTime=7}] {"text":"<Radio Tower Clerk> Kurt, the Poke Ball creator, uses apricots as ingredients?"}
execute as @s[scores={DialogueTrigger=181,TalkTime=7}] run scoreboard players enable @s TriggerCommand
tellraw @s[tag=English,scores={DialogueTrigger=181,TalkTime=7}] ["",{"text":"["},{"text":"Yes","color":"green","clickEvent":{"action":"run_command","value":"/trigger TriggerCommand set 15"}},{"text":"] \u0020 \u0020 ["},{"text":"No","color":"red","clickEvent":{"action":"run_command","value":"/trigger TriggerCommand set 18"}},{"text":"]"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=182,TalkTime=1}] {"text":"<Radio Tower Clerk> Correct! Fourth question!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=182,TalkTime=7}] {"text":"<Radio Tower Clerk> It’s impossible to use a TM on Magikarp. True?"}
execute as @s[scores={DialogueTrigger=182,TalkTime=7}] run scoreboard players enable @s TriggerCommand
tellraw @s[tag=English,scores={DialogueTrigger=182,TalkTime=7}] ["",{"text":"["},{"text":"Yes","color":"green","clickEvent":{"action":"run_command","value":"/trigger TriggerCommand set 19"}},{"text":"] \u0020 \u0020 ["},{"text":"No","color":"red","clickEvent":{"action":"run_command","value":"/trigger TriggerCommand set 15"}},{"text":"]"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=183,TalkTime=1}] {"text":"<Radio Tower Clerk> Correct! Final question!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=183,TalkTime=7}] {"text":"<Radio Tower Clerk> In our radio programs, do we have a host by the name of Whitney?"}
execute as @s[scores={DialogueTrigger=183,TalkTime=7}] run scoreboard players enable @s TriggerCommand
tellraw @s[tag=English,scores={DialogueTrigger=183,TalkTime=7}] ["",{"text":"["},{"text":"Yes","color":"green","clickEvent":{"action":"run_command","value":"/trigger TriggerCommand set 15"}},{"text":"] \u0020 \u0020 ["},{"text":"No","color":"red","clickEvent":{"action":"run_command","value":"/trigger TriggerCommand set 20"}},{"text":"]"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=184,TalkTime=1}] {"text":"<Radio Tower Clerk> Bingo! You got it! Congratulations! Here's your prize, a Radio Card!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=184,TalkTime=10}] {"text":"<Radio Tower Clerk> Please tune in to our radio shows!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=185,TalkTime=1}] {"text":"<DJ Reed> I need to run a check on this number to see if it matches any of your Pokémon's ID numbers. Please wait."}
...
#Nothing
tellraw @s[tag=English,scores={DialogueTrigger=185,TalkTime=14,rng=0..63}] {"text":"<DJ Reed> Nope, none of your ID numbers match. Try again tomorrow!"}
...
#PP Up
tellraw @s[tag=English,scores={DialogueTrigger=185,TalkTime=14,rng=65..108}] {"text":"<DJ Reed> Ooh, you've matched the last two numbers. You've won third prize, a PP Up."}
...
#XP Share
tellraw @s[tag=English,scores={DialogueTrigger=185,TalkTime=14,rng=111..127}] {"text":"<DJ Reed> Hey! You've matched the last three numbers! You've won second prize, an Exp.Share!"}
...
#Master Ball
tellraw @s[tag=English,scores={DialogueTrigger=185,TalkTime=14,rng=64}] {"text":"<DJ Reed> Wow! You have a perfect match of all five numbers! We have a grand prize winner! You have won a Master Ball!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=185,TalkTime=14,rng=109..110}] {"text":"<DJ Reed> Wow! You have a perfect match of all five numbers! We have a grand prize winner! You have won a Master Ball!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=185,TalkTime=24}] {"text":"<DJ Reed> Tune in again tomorrow and see me for another chance at a prize!"}

tag @s[scores={DialogueTrigger=185,TalkTime=24..}] add Dialogue185

#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#Beauty Salon Pamper
#execute as @e[x=511,y=54,z=-344,dx=15,dy=6,dz=19,type=pixelmon:pixelmon] run scoreboard players set @p[r=15,tag=BeautySalon] DialogueTrigger 186

tellraw @s[tag=English,scores={DialogueTrigger=186,TalkTime=1}] ["",{"text":"<Beauty Salon Clerk> Alright! Let's see what we can do for "},{"selector":"@e[x=511,y=54,z=-344,dx=15,dy=6,dz=19,type=pixelmon:pixelmon]"},{"text":"!"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=186,TalkTime=15}] ["",{"text":"<Beauty Salon Clerk> Your "},{"selector":"@e[x=511,y=54,z=-344,dx=15,dy=6,dz=19,type=pixelmon:pixelmon]"},{"text":" looks delighted! Please come again!"}]
...
#tellraw @s[tag=English,x=513,y=54,z=-335,distance=..4,tag=!BeautyCD,score_TalkTime=0] ["",{"text":"<Beauty Salon Clerk> Welcome! Would you like me to give your Pokemon a makeover?\n["},{"text":"Yes","color":"green","clickEvent":{"action":"run_command","value":"/trigger TriggerCommand set 40"}},{"text":"]"}]
...
#tp in
#execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,score_WeekdayTrack_min=1,score_WeekdayTrack=1] run execute @a[x=913,y=63,z=-54,distance=..50] run tp @e[x=-815,y=64,z=-228,dy=3,type=pixelmon:npc_chatting] 913 64 -54

#tp out
#execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,score_WeekdayTrack_min=2,score_WeekdayTrack=7] run tp @e[x=913,y=63,z=-54,dy=3,type=pixelmon:npc_chatting] -815 65 -228

tellraw @s[tag=English,scores={DialogueTrigger=187,TalkTime=1}] {"text":"<Monika> Glad to meet you. I'm Monica of Monday."}
tellraw @s[tag=English,scores={DialogueTrigger=187,TalkTime=10}] {"text":"<Monika> As a token of our friendship, I have a gift for you!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=187,TalkTime=20}] {"text":"<Monika> It's an item that raises the power of Flying-type moves."}
tellraw @s[tag=English,scores={DialogueTrigger=187,TalkTime=28}] {"text":"<Monika> You should equip a bird Pokémon with that item."}
tellraw @s[tag=English,scores={DialogueTrigger=187,TalkTime=35}] {"text":"<Monika> My brothers and sisters are all over the place. See if you could find them all!"}
...
#tp in
#execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,score_WeekdayTrack_min=2,score_WeekdayTrack=2] run execute @a[x=-482,y=63,z=-535,distance=..50] run tp @e[x=-815,y=64,z=-226,dy=3,type=pixelmon:npc_chatting] -482 64 -535

#tp out
#execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,score_WeekdayTrack_min=1,score_WeekdayTrack=1] run tp @e[x=-482,y=63,z=-535,dy=3,type=pixelmon:npc_chatting] -815 65 -226
#execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,score_WeekdayTrack_min=3,score_WeekdayTrack=7] run tp @e[x=-482,y=63,z=-535,dy=3,type=pixelmon:npc_chatting] -815 65 -226

tellraw @s[tag=English,scores={DialogueTrigger=188,TalkTime=1}] {"text":"<Tuscany> Please allow me to introduce myself. I am Tuscany of Tuesday."}
tellraw @s[tag=English,scores={DialogueTrigger=188,TalkTime=10}] {"text":"<Tuscany> By way of introduction please accept this gift, a TwistedSpoon."}
...
tellraw @s[tag=English,scores={DialogueTrigger=188,TalkTime=20}] {"text":"<Tuscany> Wouldn't you agree that it is most adorable? It strengthens Psychic-type moves."}
tellraw @s[tag=English,scores={DialogueTrigger=188,TalkTime=30}] {"text":"<Tuscany> I am certain it will be of use."}
tellraw @s[tag=English,scores={DialogueTrigger=188,TalkTime=37}] {"text":"<Tuscany> Have you met Monica, my older sister?"}
tellraw @s[tag=English,scores={DialogueTrigger=188,TalkTime=44}] {"text":"<Tuscany> Or my younger brother, Wesley? I am the second of seven children."}
...
#tp in
#execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,score_WeekdayTrack_min=3,score_WeekdayTrack=3] run execute @a[x=-56,y=63,z=722,distance=..50] run tp @e[x=-815,y=64,z=-224,dy=3,type=pixelmon:npc_chatting] -56 64 722

#tp out
#execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,score_WeekdayTrack_min=1,score_WeekdayTrack=2] run tp @e[x=-56,y=63,z=722,dy=3,type=pixelmon:npc_chatting] -815 65 -224
#execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,score_WeekdayTrack_min=4,score_WeekdayTrack=7] run tp @e[x=-56,y=63,z=722,dy=3,type=pixelmon:npc_chatting] -815 65 -224

tellraw @s[tag=English,scores={DialogueTrigger=189,TalkTime=1}] {"text":"<Wesley> I'm Wesley of Wednesday. Pleased to meet you."}
tellraw @s[tag=English,scores={DialogueTrigger=189,TalkTime=10}] {"text":"<Wesley> Please take a souvenir."}
...
tellraw @s[tag=English,scores={DialogueTrigger=189,TalkTime=17}] {"text":"<Wesley> Black Belt beefs up the power of Fighting moves."}
tellraw @s[tag=English,scores={DialogueTrigger=189,TalkTime=25}] {"text":"<Wesley> Since you found me, you must have met my brothers and sisters."}
tellraw @s[tag=English,scores={DialogueTrigger=189,TalkTime=34}] {"text":"<Wesley> Or did you just get lucky?"}
...
#tp in
#execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,score_WeekdayTrack_min=4,score_WeekdayTrack=4] run execute @a[x=236,y=64,z=-6,distance=..50] run tp @e[x=-815,y=64,z=-222,dy=3,type=pixelmon:npc_chatting] 236 64 -6

#tp out
#execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,score_WeekdayTrack_min=1,score_WeekdayTrack=3] run tp @e[x=236,y=63,z=-6,dy=3,type=pixelmon:npc_chatting] -815 65 -222
#execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,score_WeekdayTrack_min=5,score_WeekdayTrack=7] run tp @e[x=236,y=63,z=-6,dy=3,type=pixelmon:npc_chatting] -815 65 -222

tellraw @s[tag=English,scores={DialogueTrigger=190,TalkTime=1}] {"text":"<Arthur> Who are you? I'm Arthur of Thursday."}
tellraw @s[tag=English,scores={DialogueTrigger=190,TalkTime=10}] {"text":"<Arthur> Here. You can have this."}
...
tellraw @s[tag=English,scores={DialogueTrigger=190,TalkTime=17}] {"text":"<Arthur> A Pokémon that uses Rock-type moves should hold on to that. It pumps up Rock-type attacks."}
...
#tp in
#execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,score_WeekdayTrack_min=5,score_WeekdayTrack=5] run execute @a[x=127,y=63,z=-545,distance=..50] run tp @e[x=-815,y=64,z=-220,dy=3,type=pixelmon:npc_chatting] 127 64 -545

#tp out
#execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,score_WeekdayTrack_min=1,score_WeekdayTrack=4] run tp @e[x=127,y=63,z=-545,dy=3,type=pixelmon:npc_chatting] -815 65 -220
#execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,score_WeekdayTrack_min=6,score_WeekdayTrack=7] run tp @e[x=127,y=63,z=-545,dy=3,type=pixelmon:npc_chatting] -815 65 -220

tellraw @s[tag=English,scores={DialogueTrigger=191,TalkTime=1}] {"text":"<Frieda> Yahoo! It's Friday! I'm Frieda of Friday!"}
tellraw @s[tag=English,scores={DialogueTrigger=191,TalkTime=10}] {"text":"<Frieda> Nice to meet you! Here's a Poison Barb for you!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=191,TalkTime=20}] {"text":"<Frieda> Give it to a Pokémon that has Poison-type moves."}
tellraw @s[tag=English,scores={DialogueTrigger=191,TalkTime=28}] {"text":"<Frieda> Oh! It's wicked! You'll be shocked how good it makes Poison moves!"}
tellraw @s[tag=English,scores={DialogueTrigger=191,TalkTime=37}] {"text":"<Frieda> I love Friday. No doubt about it! Don't you think it's great too?"}
...
#tp in
#execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,score_WeekdayTrack_min=6,score_WeekdayTrack=6] run execute @a[x=-663,y=63,z=225,distance=..50] run tp @e[x=-815,y=64,z=-218,dy=3,type=pixelmon:npc_chatting] -663 64 225

#tp out
#execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,score_WeekdayTrack_min=1,score_WeekdayTrack=5] run tp @e[x=-663,y=63,z=225,dy=3,type=pixelmon:npc_chatting] -815 65 -218
#execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,score_WeekdayTrack_min=7,score_WeekdayTrack=7] run tp @e[x=-663,y=63,z=225,dy=3,type=pixelmon:npc_chatting] -815 65 -218

tellraw @s[tag=English,scores={DialogueTrigger=192,TalkTime=1}] {"text":"<Santos> ...It's Saturday... I'm Santos of Saturday..."}
tellraw @s[tag=English,scores={DialogueTrigger=192,TalkTime=10}] {"text":"<Santos> Take this... ... Soft Sand..."}
...
tellraw @s[tag=English,scores={DialogueTrigger=192,TalkTime=20}] {"text":"<Santos> Ground-type moves get stronger... It will startle you..."}
tellraw @s[tag=English,scores={DialogueTrigger=192,TalkTime=30}] {"text":"<Santos> ... See you again on another Saturday..."}
...
#tp in
#execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,score_WeekdayTrack_min=7,score_WeekdayTrack=7] run execute @a[x=335,y=64,z=113,distance=..50] run tp @e[x=-815,y=64,z=-216,dy=3,type=pixelmon:npc_chatting] 335 64 113

#tp out
#execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,score_WeekdayTrack_min=1,score_WeekdayTrack=6] run tp @e[x=335,y=64,z=113,dy=3,type=pixelmon:npc_chatting] -815 65 -216

tellraw @s[tag=English,scores={DialogueTrigger=193,TalkTime=1}] {"text":"<Sunny> Hi! I'm Sunny of Sunday, meaning it's Sunday today!"}
tellraw @s[tag=English,scores={DialogueTrigger=193,TalkTime=10}] {"text":"<Sunny> I was told to give you this if I saw you!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=193,TalkTime=18}] {"text":"<Sunny> That thing... Um... ...What was it now..."}
tellraw @s[tag=English,scores={DialogueTrigger=193,TalkTime=27}] {"text":"<Sunny> ... Oh! I remember now!"}
tellraw @s[tag=English,scores={DialogueTrigger=193,TalkTime=34}] {"text":"<Sunny> A Pokémon that knows Electric moves should hold it."}
tellraw @s[tag=English,scores={DialogueTrigger=193,TalkTime=42}] {"text":"<Sunny> My sis Monica said it powers up Electric-type moves!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=194,TalkTime=1}] {"text":"<Ace Trainer Kevin> As promised, you win a prize! Would you like to battle one more time with me?"}
...
tellraw @s[tag=English,scores={DialogueTrigger=195,TalkTime=1}] {"text":"<Bill's Grandfather> Hm? You know Bill? He's my grandson."}
tellraw @s[tag=English,scores={DialogueTrigger=195,TalkTime=10}] {"text":"<Bill's Grandfather> He's in Johto. He does something with PCs, so I'm house-sitting."}
...
tellraw @s[tag=English,scores={DialogueTrigger=196,TalkTime=1,BillGP=1}] {"text":"<Bill's Grandfather> Ah, so that is Lickitung? Isn't it cute!"}
tellraw @s[tag=English,scores={DialogueTrigger=196,TalkTime=1,BillGP=2}] {"text":"<Bill's Grandfather> Ah, so that is Oddish? Isn't it cute!"}
tellraw @s[tag=English,scores={DialogueTrigger=196,TalkTime=1,BillGP=3}] {"text":"<Bill's Grandfather> Ah, so that is Staryu? Isn't it cute!"}
tellraw @s[tag=English,scores={DialogueTrigger=196,TalkTime=1,BillGP=4}] {"text":"<Bill's Grandfather> Ah, so that is Growlithe? Isn't it cute!"}
tellraw @s[tag=English,scores={DialogueTrigger=196,TalkTime=1,BillGP=5}] {"text":"<Bill's Grandfather> Ah, so that is Pichu? Isn't it cute!"}


tellraw @s[tag=English,scores={DialogueTrigger=196,TalkTime=9}] {"text":"<Bill's Grandfather> Thanks! This is a token of my appreciation."}
...
tellraw @s[tag=English,scores={DialogueTrigger=198,TalkTime=1}] {"text":"<Park Worker> Remember, only Bug Pokemon caught in the Sport Ball are allowed to be judged!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=198,TalkTime=10}] {"text":"<Park Worker> You can check your IVs as you catch the Pokemon. Submit the highest total stats at the end!"}
tellraw @s[tag=English,scores={DialogueTrigger=198,TalkTime=20}] {"text":"<Park Worker> You have 20 minutes from now until judging, or just come back and talk to me to start it early! Good luck!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=198,TalkTime=1705}] {"text":"<Park Worker> Time is up! Let's begin judging!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=198,TalkTime=1714}] {"text":"<Park Worker> Please send out which Pokemon you wish to be judged!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=199,TalkTime=1}] {"text":"<Park Worker> Scoring your Pokemon..."}
...
tellraw @s[tag=English,scores={DialogueTrigger=199,TalkTime=8}] {"text":"<Park Worker> Adding up points..."}

execute as @s[scores={DialogueTrigger=199,TalkTime=8}] run function johto:world/bugcontest/bugcontesttotal

tellraw @s[tag=English,scores={DialogueTrigger=199,TalkTime=15}] {"text":"<Park Worker> And today's winners are..."}
...
#First
execute as @s[scores={DialogueTrigger=199,TalkTime=22}] run tellraw @s[tag=English,tag=First] ["",{"text":"1st Place: "},{"selector":"@s[tag=First]"},{"text":"!\n2nd Place: Bug Catcher Ed\n3rd Place: Bug Catcher Don\n "}]

#Second
execute as @s[scores={DialogueTrigger=199,TalkTime=22}] run tellraw @s[tag=English,tag=Second] ["",{"text":"1st Place: Bug Catcher Don\n2nd Place: "},{"selector":"@s[tag=Second]"},{"text":"!\n3rd Place: Bug Catcher Ed"}]

#3rd
execute as @s[scores={DialogueTrigger=199,TalkTime=22}] run tellraw @s[tag=English,tag=Third] ["",{"text":"1st Place: Bug Catcher Ed\n2nd Place: Bug Catcher Don\n3rd Place: "},{"selector":"@s[tag=Third]"},{"text":"!\n "}]


tellraw @s[tag=English,scores={DialogueTrigger=199,TalkTime=30}] ["",{"text":"<Park Worker> "},{"text":"Here is your prize! Congratulations to our contestants! We hope you'll visit again soon!","color":"white"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=200,TalkTime=2}] ["",{"text":"You recieved an ","italic":true},{"text":"Odd Egg","italic":true,"color":"aqua","hoverEvent":{"action":"show_text","value":"A gift Egg. The Pokémon it hatches into has a higher-than-usual chance of being Shiny."}},{"text":"!","italic":true}]
...
tellraw @s[tag=English,scores={DialogueTrigger=201,TalkTime=3}] {"text":"Now generating biome #1...","italic":true,"color":"gray"}
tellraw @s[tag=English,scores={DialogueTrigger=201,TalkTime=20}] {"text":"Now generating biome #2...","italic":true,"color":"gray"}
tellraw @s[tag=English,scores={DialogueTrigger=201,TalkTime=40}] {"text":"Now generating biome #3...","italic":true,"color":"gray"}
tellraw @s[tag=English,scores={DialogueTrigger=201,TalkTime=60}] {"text":"Now generating biome #4...","italic":true,"color":"gray"}
tellraw @s[tag=English,scores={DialogueTrigger=201,TalkTime=80}] {"text":"Now generating biome #5...","italic":true,"color":"gray"}
tellraw @s[tag=English,scores={DialogueTrigger=201,TalkTime=100}] {"text":"Now generating biome #6...","italic":true,"color":"gray"}
...
tellraw @s[tag=English,scores={DialogueTrigger=201,TalkTime=121}] ["",{"text":"Enjoy your stay in the Safari Zone! Come back to the start when you are ready to leave."}]
...
tellraw @s[tag=English,scores={DialogueTrigger=202,TalkTime=2}] {"text":"Now removing biome #1...","italic":true,"color":"gray"}
tellraw @s[tag=English,scores={DialogueTrigger=202,TalkTime=13}] {"text":"Now removing biome #2...","italic":true,"color":"gray"}
tellraw @s[tag=English,scores={DialogueTrigger=202,TalkTime=23}] {"text":"Now removing biome #3...","italic":true,"color":"gray"}
tellraw @s[tag=English,scores={DialogueTrigger=202,TalkTime=33}] {"text":"Now removing biome #4...","italic":true,"color":"gray"}
tellraw @s[tag=English,scores={DialogueTrigger=202,TalkTime=43}] {"text":"Now removing biome #5...","italic":true,"color":"gray"}
tellraw @s[tag=English,scores={DialogueTrigger=202,TalkTime=53}] {"text":"Now removing biome #6...","italic":true,"color":"gray"}
...
tellraw @s[tag=English,scores={DialogueTrigger=202,TalkTime=65}] ["",{"text":"Thank you for visiting! Come again soon!"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=203,TalkTime=2}] {"text":"<PokéManiac Kirk> I, I'm in shock!"}
tellraw @s[tag=English,scores={DialogueTrigger=203,TalkTime=9}] {"text":"<PokéManiac Kirk> A guy about your age with piercing eyes and long hair came in."}
tellraw @s[tag=English,scores={DialogueTrigger=203,TalkTime=18}] {"text":"<PokéManiac Kirk> He scared me into giving him my prized Pokemon!"}
tellraw @s[tag=English,scores={DialogueTrigger=203,TalkTime=26}] {"text":"<PokéManiac Kirk> I still have one left, but what if he comes back?"}
tellraw @s[tag=English,scores={DialogueTrigger=203,TalkTime=34}] {"text":"<PokéManiac Kirk> You look strong. Could you look after my Pokemon for a while?"}
...
execute as @s[scores={DialogueTrigger=204,TalkTime=1}] run tp @e[x=-815,y=69,z=-235,dy=3,type=pixelmon:npc_chatting] 337 64 191

tellraw @s[tag=English,scores={DialogueTrigger=204,TalkTime=4}] {"text":"<Bill> Hi, I'm Bill. And who are you?"}
tellraw @s[tag=English,scores={DialogueTrigger=204,TalkTime=11}] ["",{"text":"<Bill> Hmm, "},{"selector":"@s"},{"text":", huh?"}]
tellraw @s[tag=English,scores={DialogueTrigger=204,TalkTime=18}] {"text":"<Bill> You know what? I'm the one who developed the system to transfer Pokémon."}
tellraw @s[tag=English,scores={DialogueTrigger=204,TalkTime=27}] {"text":"<Bill> But it couldn't have been done by me alone. For example, do you know the Hoenn region?"}
tellraw @s[tag=English,scores={DialogueTrigger=204,TalkTime=36}] {"text":"<Bill> This girl Lanette from Hoenn made the Pokémon Storage System easier to use."}
tellraw @s[tag=English,scores={DialogueTrigger=204,TalkTime=45}] {"text":"<Bill> My friends all over the world are working together to improve the Pokémon trade and storage systems."}
tellraw @s[tag=English,scores={DialogueTrigger=204,TalkTime=55}] {"text":"<Bill> I have to hurry on back to Goldenrod and see my folks. Buh-bye!"}
...
#execute as @p[x=541,y=63,z=-416,distance=..15,tag=Dialogue204] run execute @s[tag=!Dialogue205] run tp @e[x=-815,y=69,z=-233,dy=3,type=pixelmon:npc_chatting] 549 64 -409

#Return
#execute as @p[x=541,y=63,z=-416,distance=..15,tag=!Dialogue204] run execute @s[tag=!Dialogue205] run tp @e[x=549,y=63,z=-409,dy=3,type=pixelmon:npc_chatting] -815 70 -233

tellraw @s[tag=English,scores={DialogueTrigger=205,TalkTime=1}] ["",{"text":"<Bill> Hi, "},{"selector":"@s"},{"text":"! Would you do something for me and take this Eevee?"}]
tellraw @s[tag=English,scores={DialogueTrigger=205,TalkTime=11}] {"text":"<Bill> It came over when I was adjusting Nintendo Wi-Fi Connection."}
tellraw @s[tag=English,scores={DialogueTrigger=205,TalkTime=20}] {"text":"<Bill> Someone has to take care of it, but I don't like being outside."}
tellraw @s[tag=English,scores={DialogueTrigger=205,TalkTime=28}] {"text":"<Bill> I knew you'd come through! You're the real deal!"}
tellraw @s[tag=English,scores={DialogueTrigger=205,TalkTime=36}] {"text":"<Bill> Way to go! OK, I'm counting on you. Take good care of it!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=205,TalkTime=45}] ["",{"selector":"@s","italic":true,"color":"gray"},{"text":" received the Eevee!","italic":true,"color":"gray"}]
tellraw @s[tag=English,scores={DialogueTrigger=205,TalkTime=53}] {"text":"<Bill> Professor Elm said Eevee can evolve into seven different kinds of Pokémon!"}
tellraw @s[tag=English,scores={DialogueTrigger=205,TalkTime=62}] {"text":"<Bill> I used to do experiments on transferring things."}
tellraw @s[tag=English,scores={DialogueTrigger=205,TalkTime=70}] {"text":"<Bill> Both the GTS and Nintendo Wi-Fi Connection were inspired by my machine that transfers things!"}
...
#execute as @e[x=-270,y=63,z=-505,dy=3,type=pixelmon:npc_chatting] run execute @a[r=5,tag=!GuideTour] run scoreboard players set @s[score_TalkTime=0,tag=!Dialogue209] DialogueTrigger 209

tellraw @s[tag=English,scores={DialogueTrigger=209,TalkTime=1}] {"text":"<Guide Gent> You're a trainer, aren't you? I can tell!"}
tellraw @s[tag=English,scores={DialogueTrigger=209,TalkTime=9}] {"text":"<Guide Gent> That's OK! Everyone is a rookie at some point!"}
tellraw @s[tag=English,scores={DialogueTrigger=209,TalkTime=17}] {"text":"<Guide Gent> If you'd like, I can teach you a few things."}
tellraw @s[tag=English,scores={DialogueTrigger=209,TalkTime=17}] ["",{"text":"["},{"text":"Yes","color":"green","clickEvent":{"action":"run_command","value":"/trigger TriggerCommand set 10"}},{"text":"] \u0020 \u0020 ["},{"text":"No","color":"red","clickEvent":{"action":"run_command","value":"/trigger TriggerCommand set 11"}},{"text":"]"}]
...
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#Guide Gent Tour
#execute as @e[x=-256,y=63,z=-495,dy=3,type=pixelmon:npc_chatting] run scoreboard players set @a[r=5,score_TalkTime=0,tag=!Dialogue210] DialogueTrigger 210

execute as @s[scores={DialogueTrigger=210,TalkTime=1}] run scoreboard players set @s click 1
tellraw @s[tag=English,scores={DialogueTrigger=210,TalkTime=1}] {"text":"<Guide Gent> This is the Pokémon Center. They heal your Pokémon in no time at all!"}
tellraw @s[tag=English,scores={DialogueTrigger=210,TalkTime=11}] {"text":"<Guide Gent> You'll be relying on them a lot, so you better learn about them."}
...
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#Guide Gent Tour
#execute as @e[x=-217,y=64,z=-495,dy=3,type=pixelmon:npc_chatting] run scoreboard players set @a[r=5,score_TalkTime=0,tag=!Dialogue211] DialogueTrigger 211

tellraw @s[tag=English,scores={DialogueTrigger=211,TalkTime=1}] {"text":"<Guide Gent> This is a Pokemon Mart."}
tellraw @s[tag=English,scores={DialogueTrigger=211,TalkTime=8}] {"text":"<Guide Gent> They sell Poke Balls for catching wild Pokemon and other useful items."}
...
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#Guide Gent Tour
#execute as @e[x=-184,y=64,z=-495,dy=3,type=pixelmon:npc_chatting] run scoreboard players set @a[r=5,score_TalkTime=0,tag=!Dialogue212] DialogueTrigger 212

tellraw @s[tag=English,scores={DialogueTrigger=212,TalkTime=1}] {"text":"<Guide Gent> Route 30 is out this way. Trainers will be battling their Pokemon there."}
tellraw @s[tag=English,scores={DialogueTrigger=212,TalkTime=11}] {"text":"<Guide Gent> If you go a little further, you'll see Mr. Pokemon's House."}
...
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#Guide Gent Tour
#execute as @e[x=-146,y=64,z=-517,dy=3,type=pixelmon:npc_chatting] run scoreboard players set @a[r=5,score_TalkTime=0,tag=!Dialogue197] DialogueTrigger 197

tellraw @s[tag=English,scores={DialogueTrigger=197,TalkTime=1}] {"text":"<Guide Gent> This is the sea, as you can see."}
tellraw @s[tag=English,scores={DialogueTrigger=197,TalkTime=9}] {"text":"<Guide Gent> Some Pokemon are only found in water."}
...
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#Guide Gent Tour
#execute as @e[x=-230,y=64,z=-529,dy=3,type=pixelmon:npc_chatting] run scoreboard players set @a[r=5,score_TalkTime=0,tag=!Dialogue213] DialogueTrigger 213

tellraw @s[tag=English,scores={DialogueTrigger=213,TalkTime=1}] {"text":"<Guide Gent> Here... It's my house!"}
tellraw @s[tag=English,scores={DialogueTrigger=213,TalkTime=8}] {"text":"<Guide Gent> For your effort keeping up with me, I'll give you a Town Map!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=213,TalkTime=18}] {"text":"<Guide Gent> It will show you where you are any time you look at it!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=214,TalkTime=1,SSState=1}] {"text":"Now boarding the S.S. Aqua voyage for Vermilion City!"}
tellraw @s[tag=English,scores={DialogueTrigger=214,TalkTime=1,SSState=2}] {"text":"Now boarding the S.S. Aqua voyage for Olivine City!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=214,TalkTime=80}] {"text":"<Intercom> 9 minutes remain in this voyage."}
tellraw @s[tag=English,scores={DialogueTrigger=214,TalkTime=160}] {"text":"<Intercom> 8 minutes remain in this voyage."}
tellraw @s[tag=English,scores={DialogueTrigger=214,TalkTime=240}] {"text":"<Intercom> 7 minutes remain in this voyage."}
tellraw @s[tag=English,scores={DialogueTrigger=214,TalkTime=320}] {"text":"<Intercom> 6 minutes remain in this voyage."}
tellraw @s[tag=English,scores={DialogueTrigger=214,TalkTime=400}] {"text":"<Intercom> 5 minutes remain in this voyage."}
tellraw @s[tag=English,scores={DialogueTrigger=214,TalkTime=480}] {"text":"<Intercom> 4 minutes remain in this voyage."}
tellraw @s[tag=English,scores={DialogueTrigger=214,TalkTime=560}] {"text":"<Intercom> 3 minutes remain in this voyage."}
tellraw @s[tag=English,scores={DialogueTrigger=214,TalkTime=640}] {"text":"<Intercom> 2 minutes remain in this voyage."}
tellraw @s[tag=English,scores={DialogueTrigger=214,TalkTime=720}] {"text":"<Intercom> 1 minute remains in this voyage."}
tellraw @s[tag=English,scores={DialogueTrigger=214,TalkTime=760}] {"text":"<Intercom> SS Aqua now docking. Please stand by."}

tellraw @s[tag=English,scores={DialogueTrigger=214,TalkTime=790,SSState=1}] {"text":"The S.S. Aqua has docked in Vermilion City. Thank you for sailing with us!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=214,TalkTime=790,SSState=2}] {"text":"The S.S. Aqua has docked in Olivine City. Thank you for sailing with us!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=215,TalkTime=1}] {"text":"<Power Plant Manager> I-I-I'm ready to blast something!"}
tellraw @s[tag=English,scores={DialogueTrigger=215,TalkTime=9}] {"text":"<Power Plant Manager> Who would dare steal a part from the generator? I spent so much time fixing it!"}
tellraw @s[tag=English,scores={DialogueTrigger=215,TalkTime=19}] {"text":"<Power Plant Manager> If I catch him, he's going to see what I can do with my Charge Beam!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=216,TalkTime=1}] ["",{"text":"<"},{"text":"Policeman","color":"aqua"},{"text":"> I just got word from Cerulean."}]
tellraw @s[tag=English,scores={DialogueTrigger=216,TalkTime=8}] ["",{"text":"<"},{"text":"Policeman","color":"aqua"},{"text":"> It appears that a shady character has been loitering around."}]
tellraw @s[tag=English,scores={DialogueTrigger=216,TalkTime=17}] ["",{"text":"<"},{"text":"Policeman","color":"aqua"},{"text":"> Could I ask for your cooperation? The shady character was hanging around the Cerulean Gym..."}]
...
execute as @s[scores={DialogueTrigger=217,TalkTime=1}] run tp @e[x=-815,y=74,z=-235,dy=3,type=pixelmon:npc_chatting] -1185 65 743

tellraw @s[tag=English,scores={DialogueTrigger=217,TalkTime=3}] {"text":"<Rocket Grunt> I very busy. No time for talking with you. Not good for me if seen by somebody."}
...
tellraw @s[tag=English,scores={DialogueTrigger=217,TalkTime=12}] {"text":"<Rocket Grunt> Oh no! You seen me already! I make big mistake!"}
tellraw @s[tag=English,scores={DialogueTrigger=217,TalkTime=20}] {"text":"<Rocket Grunt> Hey, you! Forget you see me, OK?"}
tellraw @s[tag=English,scores={DialogueTrigger=217,TalkTime=27}] {"text":"<Rocket Grunt> You seen, heard, known nothing, OK? Bye! Bye-bye a go-go!"}
...
#execute as @s[x=-2748,y=66,z=870,distance=..20,tag=Dialogue217,score_TalkTime=0] run execute @s[tag=!Dialogue219] run tp @e[x=-815,y=74,z=-233,dy=3,type=pixelmon:npc_trainer] -2743 66 870

tellraw @s[tag=English,scores={DialogueTrigger=218,TalkTime=1}] {"text":"<Rocket Grunt> Oh no! Hiding I was, but you did me found in no time!"}
tellraw @s[tag=English,scores={DialogueTrigger=218,TalkTime=10}] {"text":"<Rocket Grunt> ... Me only one from another country. Yet! No big business, OK?"}
tellraw @s[tag=English,scores={DialogueTrigger=218,TalkTime=20}] {"text":"<Rocket Grunt> Think I did, if stop the energy, be big panic and unlucky for here people!"}
tellraw @s[tag=English,scores={DialogueTrigger=218,TalkTime=31}] {"text":"<Rocket Grunt> Secret it is my mission, so tell you I not!"}
tellraw @s[tag=English,scores={DialogueTrigger=218,TalkTime=40}] {"text":"<Rocket Grunt> But! If win you do versus me, a man I be and mine secret to you tell."}
tellraw @s[tag=English,scores={DialogueTrigger=218,TalkTime=50}] {"text":"<Rocket Grunt> You understand? Battle begin we do!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=219,TalkTime=1}] {"text":"<Rocket Grunt> OK. Tell you mine secret will I. Machine Part steal by me."}
tellraw @s[tag=English,scores={DialogueTrigger=219,TalkTime=10}] {"text":"<Rocket Grunt> Hide it I did in Gym of the Cerulean."}
tellraw @s[tag=English,scores={DialogueTrigger=219,TalkTime=17}] {"text":"<Rocket Grunt> At bottom of pool put it I did. Look for Gym at."}
tellraw @s[tag=English,scores={DialogueTrigger=219,TalkTime=26}] {"text":"<Rocket Grunt> But you forget me not! Beat you for sure will Team Rocket."}
tellraw @s[tag=English,scores={DialogueTrigger=219,TalkTime=35}] {"text":"<Rocket Grunt> Come from Johto will they, mine allies, yes. Will revenge they are."}
tellraw @s[tag=English,scores={DialogueTrigger=219,TalkTime=47}] {"text":"<Rocket Grunt> ... You say what? Team Rocket bye-bye a go-go?"}
tellraw @s[tag=English,scores={DialogueTrigger=219,TalkTime=56}] {"text":"<Rocket Grunt> Broken up it is says you? Oh, no!"}
tellraw @s[tag=English,scores={DialogueTrigger=219,TalkTime=64}] {"text":"<Rocket Grunt> Should I do what now on from, me?"}
tellraw @s[tag=English,scores={DialogueTrigger=219,TalkTime=72}] {"text":"<Rocket Grunt> ...OK. I my country go home. Make Team Rocket I will. Good-bye! So long!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=221,TalkTime=1}] {"text":"<Power Plant Manager> Ah! Yeah! The thing you have..."}
tellraw @s[tag=English,scores={DialogueTrigger=221,TalkTime=8}] {"text":"<Power Plant Manager> Is that the part that was stolen from my beloved generator?"}
tellraw @s[tag=English,scores={DialogueTrigger=221,TalkTime=16}] {"text":"<Power Plant Manager> You found it? Thank you so much! Now, all I have to do is..."}
tellraw @s[tag=English,scores={DialogueTrigger=221,TalkTime=25}] {"text":"<Power Plant Manager> attach this part here..."}
tellraw @s[tag=English,scores={DialogueTrigger=221,TalkTime=30}] {"text":"<Power Plant Manager> Whirrrrrr! Yes, it's running! Whirrr, whirrr!"}
tellraw @s[tag=English,scores={DialogueTrigger=221,TalkTime=40}] {"text":"<Power Plant Manager> Wahah! Thanks! Here! Go ahead and take this TM as a reward!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=221,TalkTime=50}] {"text":"<Power Plant Manager> TM57 is my Charge Beam! It will shoot beams, and it can also sometimes raise Special Attack!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=222,TalkTime=1}] {"text":"<Professor Oak> Those Badges are... Wow!"}
tellraw @s[tag=English,scores={DialogueTrigger=222,TalkTime=8}] {"text":"<Professor Oak> You have not only become the Johto Champion, but you've collected all the Kanto Badges!"}
tellraw @s[tag=English,scores={DialogueTrigger=222,TalkTime=18}] {"text":"<Professor Oak> Well done! Hmm... No wonder I sensed something in you when we met."}
tellraw @s[tag=English,scores={DialogueTrigger=222,TalkTime=27}] ["",{"text":"<Professor Oak> Tell you what, "},{"selector":"@s"},{"text":"."}]
tellraw @s[tag=English,scores={DialogueTrigger=222,TalkTime=34}] {"text":"<Professor Oak> I'll make arrangements so that you can go to Mt. Silver."}
tellraw @s[tag=English,scores={DialogueTrigger=222,TalkTime=42}] {"text":"<Professor Oak> Mt. Silver is a big mountain that is home to many wild Pokémon."}
tellraw @s[tag=English,scores={DialogueTrigger=222,TalkTime=50}] {"text":"<Professor Oak> It's too dangerous for your average Trainer, so it's off limits."}
tellraw @s[tag=English,scores={DialogueTrigger=222,TalkTime=58}] ["",{"text":"<Professor Oak> But we can make an exception in your case, "},{"selector":"@s"},{"text":"."}]
tellraw @s[tag=English,scores={DialogueTrigger=222,TalkTime=67}] {"text":"<Professor Oak> Go to the Pokémon League Reception Gate. You can reach Mt. Silver from there."}
...
tellraw @s[tag=English,scores={DialogueTrigger=223,TalkTime=1}] ["",{"text":"<Radio Director> Ah! So you're the "},{"selector":"@s"},{"text":" who solved the Power Plant's problem?"}]
tellraw @s[tag=English,scores={DialogueTrigger=223,TalkTime=11}] {"text":"<Radio Director> Thanks to you, I never lost my job."}
tellraw @s[tag=English,scores={DialogueTrigger=223,TalkTime=18}] {"text":"<Radio Director> I tell you, you're a real lifesaver! Please take this as my thanks."}
tellraw @s[tag=English,scores={DialogueTrigger=223,TalkTime=27}] ["",{"text":"The Director loaded the EXPN Card on ","italic":true,"color":"gray"},{"selector":"@s","italic":true,"color":"gray"},{"text":"'s Radio!","italic":true,"color":"gray"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=223,TalkTime=36}] {"text":"<Radio Director> With that thing, you can tune in to even more radio programs here in Kanto. Gahahahaha!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=224,TalkTime=1}] ["",{"text":"\u266a\u266b\u266c "},{"text":"[Radio] ","color":"aqua"},{"text":"<Team Rocket> ...This is the Radio Tower. This is the Radio Tower.","italic":true},{"text":"\u266a\u266b\u266c"}]
tellraw @s[tag=English,scores={DialogueTrigger=224,TalkTime=10}] ["",{"text":"\u266a\u266b\u266c "},{"text":"[Radio] ","color":"aqua"},{"text":"<Team Rocket> We are pleased to declare Team Rocket's revival.","italic":true},{"text":"\u266a\u266b\u266c"}]
tellraw @s[tag=English,scores={DialogueTrigger=224,TalkTime=20}] ["",{"text":"\u266a\u266b\u266c "},{"text":"[Radio] ","color":"aqua"},{"text":"<Team Rocket> ...Giovanni? ...Can you hear us? We have finally made it!...","italic":true},{"text":"\u266a\u266b\u266c"}]
...
tellraw @s[tag=English,scores={DialogueTrigger=225,TalkTime=1}] {"text":"<DJ Buena> YIPPEE! That's the password!"}
tellraw @s[tag=English,scores={DialogueTrigger=225,TalkTime=7}] {"text":"<DJ Buena> You did tune in! I'm so happy!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=225,TalkTime=13}] {"text":"<DJ Buena> Here's a prize! Congrats!"}
...
tellraw @s[tag=English,scores={DialogueTrigger=225,TalkTime=20}] {"text":"<DJ Buena> My drawings are daily! Tune in and come back tomorrow for another prize!"}
...
#tps Eusine in
#execute as @s[x=445,y=64,z=304,distance=..10,score_DogEncounter_min=1,tag=!Dialogue226] run tp @e[x=-815,y=74,z=-228,dy=3,type=pixelmon:npc_chatting] 445 64 304

tellraw @s[tag=English,scores={DialogueTrigger=226,TalkTime=1}] {"text":"<...> Did you see it? Suicune raced by like a blur, right in front of my eyes!"}
tellraw @s[tag=English,scores={DialogueTrigger=226,TalkTime=10}] {"text":"<..> I have been chasing Suicune for almost ten years, but I have never been this close! I'm all choked up!"}
tellraw @s[tag=English,scores={DialogueTrigger=226,TalkTime=20}] {"text":"<Eusine> Oh? My name is Eusine. I'm on the trail of a Pokémon named Suicune. And you are...?"}
tellraw @s[tag=English,scores={DialogueTrigger=226,TalkTime=29}] ["",{"text":"<Eusine> "},{"selector":"@s"},{"text":"? Glad to meet you. I heard rumors that Suicune is here, so I came to look."}]
tellraw @s[tag=English,scores={DialogueTrigger=226,TalkTime=39}] {"text":"<Eusine> By the way... It was clear to me that Suicune took notice of your presence."}
tellraw @s[tag=English,scores={DialogueTrigger=226,TalkTime=48}] {"text":"<Eusine> Ecruteak's legendary Pokémon are said to come to people only when they recognize their talents."}
tellraw @s[tag=English,scores={DialogueTrigger=226,TalkTime=58}] {"text":"<Eusine> Perhaps I should be more aggressive toward Suicune..."}
tellraw @s[tag=English,scores={DialogueTrigger=226,TalkTime=66}] ["",{"text":"<Eusine> Anyway, "},{"selector":"@s"},{"text":", we will meet again!"}]
...
#execute as @s[x=1256,y=64,z=-296,distance=..50,score_DogEncounter_min=1,score_TalkTime=0,tag=Dialogue226] run execute @s[tag=!Dialogue227] run tp @e[x=-817,y=80,z=-171,dy=3,type=pixelmon:statue] 1256 64 -296
...
execute as @s[scores={DialogueTrigger=227,TalkTime=10}] run tp @e[x=-815,y=74,z=-226,dy=3,type=pixelmon:npc_trainer] 1251 64 -307
execute as @s[scores={DialogueTrigger=227,TalkTime=10}] run particle cloud 1251 64 -307 1 1 1 1 100

tellraw @s[tag=English,scores={DialogueTrigger=227,TalkTime=14}] ["",{"text":"<Eusine> Yo, "},{"selector":"@s"},{"text":". Wasn't that Suicune just now?"}]
tellraw @s[tag=English,scores={DialogueTrigger=227,TalkTime=22}] {"text":"<Eusine> I only caught a quick glimpse, but I thought I saw Suicune running on the waves."}
tellraw @s[tag=English,scores={DialogueTrigger=227,TalkTime=32}] {"text":"<Eusine> Suicune is beautiful and grand. And it races through towns and roads at simply awesome speeds."}
tellraw @s[tag=English,scores={DialogueTrigger=227,TalkTime=42}] {"text":"<Eusine> It's wonderful... I want to see Suicune up close..."}
tellraw @s[tag=English,scores={DialogueTrigger=227,TalkTime=50}] {"text":"<Eusine> I've decided. I'll battle you as a Trainer to earn Suicune's respect!"}
tellraw @s[tag=English,scores={DialogueTrigger=227,TalkTime=59}] ["",{"text":"<Eusine> Come on, "},{"selector":"@s"},{"text":". Let's battle now!"}]
...
#Tp in if needed
#execute as @s[x=1251,y=64,z=-307,distance=..20,score_TalkTime=0,tag=Dialogue227] run execute @s[tag=!Dialogue228] run tp @e[x=-815,y=74,z=-226,dy=3,type=pixelmon:npc_trainer] 1251 64 -307

execute as @s[scores={DialogueTrigger=228,TalkTime=1}] run clear @s minecraft:nether_brick

tellraw @s[tag=English,scores={DialogueTrigger=228,TalkTime=1}] ["",{"text":"<Eusine> You're amazing, "},{"selector":"@s"},{"text":"! I'm starting to understand why Suicune was keeping an eye on you."}]
tellraw @s[tag=English,scores={DialogueTrigger=228,TalkTime=11}] {"text":"<Eusine> I'm going to keep searching for Suicune."}
tellraw @s[tag=English,scores={DialogueTrigger=228,TalkTime=19}] {"text":"<Eusine> I have a feeling we'll see each other again. See you around!"}
...
#tp in Suicune to find:
#execute as @s[x=80,y=64,z=152,distance=..50,score_TalkTime=0,tag=Dialogue228] run execute @s[tag=!Dialogue229] run tp @e[x=-817,y=80,z=-165,dy=3,type=pixelmon:statue] 80 64 152
...
execute as @s[scores={DialogueTrigger=229,TalkTime=10}] run tp @e[x=-815,y=74,z=-224,dy=3,type=pixelmon:npc_chatting] 94 64 153
execute as @s[scores={DialogueTrigger=229,TalkTime=10}] run particle cloud 94 64 153 1 1 1 1 100

tellraw @s[tag=English,scores={DialogueTrigger=229,TalkTime=14}] {"text":"<Eusine> Suicune... How brave it is!"}
tellraw @s[tag=English,scores={DialogueTrigger=229,TalkTime=21}] {"text":"<Eusine> How refreshing it is! How beautiful it is!"}
tellraw @s[tag=English,scores={DialogueTrigger=229,TalkTime=30}] {"text":"<Eusine> And how quickly it moves!"}
tellraw @s[tag=English,scores={DialogueTrigger=229,TalkTime=37}] ["",{"text":"<Eusine> "},{"selector":"@s"},{"text":"! You seem to be around where Suicune would appear."}]
tellraw @s[tag=English,scores={DialogueTrigger=229,TalkTime=47}] {"text":"<Eusine> Well, that's OK. My desire to search for Suicune is far beyond yours.."}
tellraw @s[tag=English,scores={DialogueTrigger=229,TalkTime=56}] {"text":"<Eusine> My grandpa was...quite into myths. I've heard so many stories about Suicune from him."}
tellraw @s[tag=English,scores={DialogueTrigger=229,TalkTime=66}] {"text":"<Eusine> Suicune... I won't stop following you until I've found out what you're after... You hear me!"}
...
#tp in Suicune to find:
#execute as @s[x=-2823,y=64,z=-96,distance=..50,score_TalkTime=0,tag=Dialogue229] run execute @s[tag=!Dialogue230] run tp @e[x=-817,y=80,z=-159,dy=3,type=pixelmon:statue] -2823 64 -96

execute as @s[scores={DialogueTrigger=230,TalkTime=1}] run tp @e[x=-815,y=74,z=-222,dy=3,type=pixelmon:npc_chatting] -2816 65 -89
...
tellraw @s[tag=English,scores={DialogueTrigger=230,TalkTime=13}] {"text":"<Eusine> That was so close! I thought I could corner it by ambushing it here..."}
tellraw @s[tag=English,scores={DialogueTrigger=230,TalkTime=23}] {"text":"<Eusine> But running on the water... is beyond me."}
tellraw @s[tag=English,scores={DialogueTrigger=230,TalkTime=30}] {"text":"<Eusine> Still, I am starting to see a pattern. Suicune prefers water! That means..."}
tellraw @s[tag=English,scores={DialogueTrigger=230,TalkTime=40}] ["",{"text":"<Eusine> Sorry, "},{"selector":"@s"},{"text":"! I've got to go!"}]
...
#tp in Suicune to find:
#execute as @s[x=-2981,y=64,z=-470,distance=..50,score_TalkTime=0,tag=Dialogue230] run execute @s[tag=!Dialogue231] run tp @e[x=-817,y=80,z=-153,dy=3,type=pixelmon:statue] -2981 64 -470
...
execute as @s[scores={DialogueTrigger=231,TalkTime=10}] run tp @e[x=-815,y=74,z=-220,dy=3,type=pixelmon:npc_chatting] -2963 64 -463
execute as @s[scores={DialogueTrigger=231,TalkTime=10}] run particle cloud -2963 64 -463 1 1 1 1 100

tellraw @s[tag=English,scores={DialogueTrigger=231,TalkTime=14}] ["",{"text":"<Eusine> "},{"selector":"@s"},{"text":"! Not again! I'll be there first next time!"}]
tellraw @s[tag=English,scores={DialogueTrigger=231,TalkTime=24}] {"text":"<Eusine> Having followed it here, I'm starting to understand what Suicune is after."}
tellraw @s[tag=English,scores={DialogueTrigger=231,TalkTime=34}] {"text":"<Eusine> To be honest, I would like to keep this information to myself."}
tellraw @s[tag=English,scores={DialogueTrigger=231,TalkTime=43}] {"text":"<Eusine> But I want to be an honest Trainer in front of Suicune! That's why I am sharing a clue with you."}
tellraw @s[tag=English,scores={DialogueTrigger=231,TalkTime=53}] {"text":"<Eusine> It seems that... ...Suicune prefers a hilly place near water... ...Somewhere north."}
tellraw @s[tag=English,scores={DialogueTrigger=231,TalkTime=63}] {"text":"<Eusine> I don't know exactly where, yet. It will be just you and me!"}
tellraw @s[tag=English,scores={DialogueTrigger=231,TalkTime=70}] {"text":"<Eusine> Who'll find it first? I challenge you!"}
...
#tp in Suicune to find:
#execute as @s[x=-3094,y=64,z=989,distance=..50,score_TalkTime=0,tag=Dialogue231] run execute @s[tag=!Dialogue233] run tp @e[x=-817,y=80,z=-147,dy=3,type=pixelmon:statue] -3111 64 989

#Tp Eusine in
execute as @s[scores={DialogueTrigger=232,TalkTime=1}] run tp @e[x=-815,y=74,z=-218,dy=3,type=pixelmon:npc_chatting] -3094 64 989
execute as @s[scores={DialogueTrigger=232,TalkTime=1}] run particle cloud -3094 64 989 1 1 1 1 100

tellraw @s[tag=English,scores={DialogueTrigger=232,TalkTime=3}] {"text":"<Eusine> Puff, puff... I am...no match for you. ...As I predicted."}
tellraw @s[tag=English,scores={DialogueTrigger=232,TalkTime=11}] {"text":"<Eusine> .................. ...Go ahead."}
tellraw @s[tag=English,scores={DialogueTrigger=232,TalkTime=19}] {"text":"<Eusine> Since I met you in the Burned Tower at Ecruteak City, I've sort of known that Suicune would choose you."}
tellraw @s[tag=English,scores={DialogueTrigger=232,TalkTime=29}] {"text":"<Eusine> Take a look at it! Suicune is waiting for you!"}
tellraw @s[tag=English,scores={DialogueTrigger=232,TalkTime=37}] {"text":"<Eusine> It has been waiting for a battle with a worthy Trainer to whom it can entrust itself!"}
...
execute as @s[scores={DialogueTrigger=234,TalkTime=1}] run tp @e[x=-815,y=74,z=-218,dy=3,type=pixelmon:npc_chatting] -3094 64 989
execute as @s[scores={DialogueTrigger=234,TalkTime=1}] run scoreboard players set @s click 1

tellraw @s[tag=English,scores={DialogueTrigger=234,TalkTime=3}] ["",{"text":"<Eusine> "},{"selector":"@s"},{"text":"... You two are truly amazing..."}]
tellraw @s[tag=English,scores={DialogueTrigger=233,TalkTime=10}] {"text":"<Eusine> I have never seen a battle this intense!"}
tellraw @s[tag=English,scores={DialogueTrigger=233,TalkTime=17}] {"text":"<Eusine> I have no regrets... Farewell, Suicune!"}
tellraw @s[tag=English,scores={DialogueTrigger=233,TalkTime=25}] ["",{"text":"<Eusine> Farewell..."},{"selector":"@s"},{"text":"!"}]
