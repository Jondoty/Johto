...
#execute @s[x=-1059,y=50,z=-103,dx=30,dy=4,dz=30,type=pixelmon:pixelmon,name=Arceus] run execute @a[x=-1038,y=50,z=-98,distance=..2,tag=Dialogue172] run testfor @s[tag=!SinnohLegend]
...
#execute @s[x=-1059,y=50,z=-103,dx=30,dy=4,dz=30,type=pixelmon:pixelmon,name=Arceus] run execute @a[x=-1050,y=50,z=-98,distance=..2,tag=Dialogue172] run testfor @s[tag=!SinnohLegend]
...
#execute @s[x=-1059,y=50,z=-103,dx=30,dy=4,dz=30,type=pixelmon:pixelmon,name=Arceus] run execute @a[x=-1044,y=50,z=-85,distance=..2,tag=Dialogue172] run testfor @s[tag=!SinnohLegend]
