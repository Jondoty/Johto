...
scoreboard players tag @s add Red
...
scoreboard players tag @s add EXPNCard
...
scoreboard players tag @s add Pryce
give @s pixelmon:glacier_badge 1
scoreboard players tag @s add Clair
give @s pixelmon:rising_badge 1
scoreboard players tag @s add Brock
give @s pixelmon:boulder_badge 1
scoreboard players tag @s add Misty
give @s pixelmon:cascade_badge 1
scoreboard players tag @s add Surge
give @s pixelmon:thunder_badge 1
scoreboard players tag @s add Erika
give @s pixelmon:rainbow_badge 1
scoreboard players tag @s add Janine
give @s pixelmon:soul_badge 1
scoreboard players tag @s add Sabrina
give @s pixelmon:marsh_badge 1
scoreboard players tag @s add Blaine
give @s pixelmon:volcano_badge 1
scoreboard players tag @s add Blue
...
give @s pixelmon:hm9
give @s pixelmon:tm_gen4 1 0 {tm:7}
give @s minecraft:record_far 1 0 {display:{Name:"Basement Key",Lore:["A key that opens a door in","the Goldenrod Tunnel"]},HideFlags:36}
give @s minecraft:prismarine_crystals 1 0 {display:{Name:"Rainbow Wing",Lore:["A strange, rainbow feather","that sparkles."]},ench:[{id:"2",lvl:"1"}],HideFlags:1}
give @s pixelmon:tm_gen4 1 0 {tm:59}
give @s pixelmon:master_ball
give @s minecraft:record_chirp 1 0 {display:{Name:"S.S. Ticket",Lore:["The ticket required for sailing on","the ferry S.S. Aqua in Olivine and","Vermilion City. It has a drawing","of a ship in it."]},HideFlags:36}
give @s pixelmon:tm_gen4 1 0 {tm:3}
give @s pixelmon:tm_gen4 1 0 {tm:34}
give @s pixelmon:tm_gen2 1 0 {tm:19}
give @s pixelmon:tm_gen4 1 0 {tm:84}
give @s pixelmon:tm_gen4 1 0 {tm:48}
give @s pixelmon:tm_gen4 1 0 {tm:50}
give @s pixelmon:tm_gen4 1 0 {tm:92}
give @s pixelmon:tm_gen4 1 0 {tm:57}
