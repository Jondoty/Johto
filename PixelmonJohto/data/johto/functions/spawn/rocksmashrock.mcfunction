...
data merge entity @e[dy=3,type=minecraft:armor_stand,limit=1] {ArmorItems:[{},{},{},{id:iron_hoe,tag:{Damage:2,HideFlags:6,Unbreakable:1},Count:1}],DisabledSlots:4144959}
execute unless entity @e[dy=3,type=minecraft:armor_stand] run summon minecraft:armor_stand ~ ~ ~ {ShowArms:1b,Invisible:1b,ArmorItems:[{},{},{},{id:iron_hoe,tag:{Damage:2,HideFlags:6,Unbreakable:1},Count:1}],ArmorDropChances:[0f,0f,0f,0f],DisabledSlots:4144959}
