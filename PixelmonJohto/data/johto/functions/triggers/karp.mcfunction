...
tellraw @p[x=-197,y=63,z=568,dx=18,dy=5,dz=8] ["",{"text":"You retrieved "},{"selector":"@e[x=-197,y=63,z=568,dx=18,dy=5,dz=8,type=pixelmon:pixelmon,nbt={ndex:129}]"},{"text":"!"}]
tp @e[x=-197,y=63,z=568,dx=18,dy=5,dz=8,type=pixelmon:pixelmon,nbt={ndex:129}] ~ ~-1000 ~
