...
execute at @p[x=513,y=54,z=-368,distance=..100,scores={Arceus=0}] run execute as @e[x=513,y=55,z=-368,distance=..1,type=pixelmon:npc_shopkeeper] run particle cloud ~ ~ ~ 1 1 1 1 100
execute at @p[x=513,y=54,z=-368,distance=..100,scores={Arceus=0}] run tp @e[x=513,y=55,z=-368,distance=..1,type=pixelmon:npc_shopkeeper] -815 70 -228
...
execute at @p[x=513,y=54,z=-368,distance=..100,scores={Arceus=1..}] run tp @e[x=-815,y=69,z=-228,dy=3,type=pixelmon:npc_shopkeeper] 513 55 -368
execute at @p[x=513,y=54,z=-368,distance=..100,scores={Arceus=1..}] run execute as @e[x=-815,y=69,z=-228,dy=3,type=pixelmon:npc_shopkeeper] run particle cloud 513 54 -368 1 1 1 1 100
...
execute as @e[x=-792,y=65,z=-284,dy=3,type=armor_stand,tag=!Skip] run tp @e[x=-79,y=53,z=214,dy=3,type=pixelmon:npc_trainer] -815 93 -240
execute as @e[x=-792,y=65,z=-284,dy=3,type=armor_stand,tag=!Skip] run tp @e[x=-157,y=53,z=198,dy=3,type=pixelmon:npc_trainer] -815 93 -238
execute as @e[x=-792,y=65,z=-284,dy=3,type=armor_stand,tag=!Skip] run tp @e[x=-149,y=53,z=161,dy=3,type=pixelmon:npc_trainer] -815 93 -236
execute as @e[x=-792,y=65,z=-284,dy=3,type=armor_stand,tag=!Skip] run tp @e[x=-95,y=53,z=161,dy=3,type=pixelmon:npc_trainer] -815 93 -234
execute as @e[x=-792,y=65,z=-284,dy=3,type=armor_stand,tag=!Skip] run tp @e[x=-132,y=53,z=215,dy=3,type=pixelmon:npc_trainer] -815 94 -242
...
#Monica
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=2..7}] run execute as @e[x=913,y=63,z=-54,dy=3,type=pixelmon:npc_chatting] run particle cloud ~ ~ ~ 1 1 1 1 100
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=2..7}] run tp @e[x=913,y=63,z=-54,dy=3,type=pixelmon:npc_chatting] -815 65 -228

#Tuscany
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=1}] run execute as @e[x=-482,y=63,z=-535,dy=3,type=pixelmon:npc_chatting] run particle cloud ~ ~ ~ 1 1 1 1 100
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=3..7}] run execute as @e[x=-482,y=63,z=-535,dy=3,type=pixelmon:npc_chatting] run particle cloud ~ ~ ~ 1 1 1 1 100

execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=1}] run tp @e[x=-482,y=63,z=-535,dy=3,type=pixelmon:npc_chatting] -815 65 -226
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=3..7}] run tp @e[x=-482,y=63,z=-535,dy=3,type=pixelmon:npc_chatting] -815 65 -226

#Wesley
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=1..2}] run execute as @e[x=-56,y=63,z=722,dy=3,type=pixelmon:npc_chatting] run particle cloud ~ ~ ~ 1 1 1 1 100
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=4..7}] run execute as @e[x=-56,y=63,z=722,dy=3,type=pixelmon:npc_chatting] run particle cloud ~ ~ ~ 1 1 1 1 100

execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=1..2}] run tp @e[x=-56,y=63,z=722,dy=3,type=pixelmon:npc_chatting] -815 65 -224
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=4..7}] run tp @e[x=-56,y=63,z=722,dy=3,type=pixelmon:npc_chatting] -815 65 -224

#Arthur
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=1..3}] run execute as @e[x=236,y=63,z=-6,dy=3,type=pixelmon:npc_chatting] run particle cloud ~ ~ ~ 1 1 1 1 100
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=5..7}] run execute as @e[x=236,y=63,z=-6,dy=3,type=pixelmon:npc_chatting] run particle cloud ~ ~ ~ 1 1 1 1 100

execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=1..3}] run tp @e[x=236,y=63,z=-6,dy=3,type=pixelmon:npc_chatting] -815 65 -222
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=5..7}] run tp @e[x=236,y=63,z=-6,dy=3,type=pixelmon:npc_chatting] -815 65 -222

#Frieda
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=1..4}] run execute as @e[x=127,y=63,z=-545,dy=3,type=pixelmon:npc_chatting] run particle cloud ~ ~ ~ 1 1 1 1 100
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=6..7}] run execute as @e[x=127,y=63,z=-545,dy=3,type=pixelmon:npc_chatting] run particle cloud ~ ~ ~ 1 1 1 1 100

execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=1..4}] run tp @e[x=127,y=63,z=-545,dy=3,type=pixelmon:npc_chatting] -815 65 -220
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=6..7}] run tp @e[x=127,y=63,z=-545,dy=3,type=pixelmon:npc_chatting] -815 65 -220

#Santos
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=1..5}] run execute as @e[x=-663,y=63,z=225,dy=3,type=pixelmon:npc_chatting] run particle cloud ~ ~ ~ 1 1 1 1 100
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=7}] run execute as @e[x=-663,y=63,z=225,dy=3,type=pixelmon:npc_chatting] run particle cloud ~ ~ ~ 1 1 1 1 100

execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=1..5}] run tp @e[x=-663,y=63,z=225,dy=3,type=pixelmon:npc_chatting] -815 65 -218
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=7}] run tp @e[x=-663,y=63,z=225,dy=3,type=pixelmon:npc_chatting] -815 65 -218

#Sunny
execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=1..6}] run execute as @e[x=335,y=64,z=113,dy=3,type=pixelmon:npc_chatting] run particle cloud ~ ~ ~ 1 1 1 1 100

execute as @e[x=-799,y=64,z=-284,dy=3,type=armor_stand,scores={WeekdayTrack=1..6}] run tp @e[x=335,y=64,z=113,dy=3,type=pixelmon:npc_chatting] -815 65 -216
...
execute as @a[x=-223,y=64,z=-512,distance=..100,tag=!GuideTour,scores={TalkTime=0}] run tp @e[x=-230,y=64,z=-519,distance=..1,type=pixelmon:npc_chatting] -270 64 -505
...
execute as @p[x=147,y=64,z=-562,distance=..50,tag=Dialogue16] run tp @e[x=147,y=63,z=-562,dy=3,type=pixelmon:npc_shopkeeper] -815 70 -223
execute as @p[x=147,y=64,z=-562,distance=..50,tag=!Dialogue16] run tp @e[x=-815,y=69,z=-223,dy=3,type=pixelmon:npc_shopkeeper] 147 64 -562
