...
tag @e[type=pixelmon:npc_trainer,tag=!GymLeader,name=Jasmine] add GymLeader
tag @e[type=pixelmon:npc_trainer,tag=!GymLeader,name=Pryce] add GymLeader
tag @e[type=pixelmon:npc_trainer,tag=!GymLeader,name=Clair] add GymLeader
tag @e[type=pixelmon:npc_trainer,tag=!GymLeader,name=Chuck] add GymLeader
tag @e[type=pixelmon:npc_trainer,tag=!GymLeader,name=Falkner] add GymLeader
tag @e[type=pixelmon:npc_trainer,tag=!GymLeader,name=Morty] add GymLeader

tag @e[type=pixelmon:npc_trainer,tag=!GymLeader,name=Brock] add GymLeader
tag @e[type=pixelmon:npc_trainer,tag=!GymLeader,name=Misty] add GymLeader
tag @e[type=pixelmon:npc_trainer,tag=!GymLeader,name=Surge] add GymLeader
tag @e[type=pixelmon:npc_trainer,tag=!GymLeader,name=Erika] add GymLeader
tag @e[type=pixelmon:npc_trainer,tag=!GymLeader,name=Sabrina] add GymLeader
tag @e[type=pixelmon:npc_trainer,tag=!GymLeader,name=Janine] add GymLeader
tag @e[type=pixelmon:npc_trainer,tag=!GymLeader,name=Blaine] add GymLeader
...
#Gym Leader radius
execute at @e[tag=GymLeader,type=pixelmon:npc_trainer] run playsound gymbattle record @a[tag=Temp,distance=..15,scores={MusicCooldown=0}] ~ ~ ~ 1 1 1
execute at @e[tag=GymLeader,type=pixelmon:npc_trainer] run scoreboard players set @a[tag=Temp,distance=..15,scores={MusicCooldown=0}] MusicCooldown 195
...
execute at @e[name=Silver,type=pixelmon:npc_chatting] run scoreboard players set @a[tag=Temp,distance=..15,scores={MusicCooldown=0}] MusicCooldown 70



#Arceus legendary battle
execute at @e[tag=ArceusBattle,type=pixelmon:pixelmon] run playsound arceusbattle record @a[tag=Temp,distance=..15,scores={MusicCooldown=0}] ~ ~ ~ 1 1 1
execute at @e[tag=ArceusBattle,type=pixelmon:pixelmon] run scoreboard players set @a[tag=Temp,distance=..15,scores={MusicCooldown=0}] MusicCooldown 113


#General legendary battle
execute at @e[tag=Legendary,type=pixelmon:pixelmon,limit=1] run playsound legendarybattle record @a[tag=Temp,distance=..15,scores={MusicCooldown=0}] ~ ~ ~ 1 1 1
execute at @e[tag=Legendary,type=pixelmon:pixelmon,limit=1] run scoreboard players set @a[tag=Temp,distance=..15,scores={MusicCooldown=0}] MusicCooldown 286
